            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="primary"
                        :percentage="$performanceMetrics['collection_completion_rate'] ?? 0"
                        description="Koleksi dengan data lengkap"
                    />
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="success"
                        :percentage="$performanceMetrics['news_publish_rate'] ?? 0"
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="warning"
                        :percentage="$performanceMetrics['event_completion_rate'] ?? 0"
                        description="Agenda yang masih aktif"
                    />
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="info"
                        :percentage="$performanceMetrics['user_activity_rate'] ?? 0"
                        description="Pengguna aktif (30 hari)"
                    />
                </div>
                @else
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="info"
                        :percentage="$performanceMetrics['category_usage_rate'] ?? 0"
                        description="Kategori yang digunakan"
                    />
                </div>
                @endif
            </div>
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        color="dark"
                        percentage="100"
                        description="Testimoni tersedia"
                    />
                </div>
