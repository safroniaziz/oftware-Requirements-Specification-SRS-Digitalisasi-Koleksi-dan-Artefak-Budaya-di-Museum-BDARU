    ...
    <!-- Aggressive CSS to ensure dashboard visibility -->
    <style>
        /* Completely hide Vue/Inertia elements */
        #app, [v-cloak], [v-app], [data-page], [inertia] {
        ...
        .app-root, .app-page, .app-wrapper, .app-main, .app-content, .app-header, .app-sidebar {
        ...
        /* Force dashboard container visibility */
        .app-container {
            display: block !important;
            visibility: visible !important;
        }
