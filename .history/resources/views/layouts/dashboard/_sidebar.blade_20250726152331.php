        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-3 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('admin.collections.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.collections.*') ? 'active' : '' }}" href="{{ route('admin.collections.index') }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item {{ Route::is('admin.news.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.news.*') ? 'active' : '' }}" href="{{ route('admin.news.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('admin.events.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.events.*') ? 'active' : '' }}" href="{{ route('admin.events.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('admin.testimonials.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.testimonials.*') ? 'active' : '' }}" href="{{ route('admin.testimonials.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('admin.team-members.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.team-members.*') ? 'active' : '' }}" href="{{ route('admin.team-members.index') }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item {{ Route::is('categories.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('categories.*') ? 'active' : '' }}" href="#">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('news-categories.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('news-categories.*') ? 'active' : '' }}" href="#">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item {{ Route::is('settings.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('settings.*') ? 'active' : '' }}" href="#">
                            <span class="menu-icon">
