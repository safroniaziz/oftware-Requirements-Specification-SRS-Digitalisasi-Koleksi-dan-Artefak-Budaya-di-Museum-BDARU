...
<html lang="en">
	...
	<head>
		...
		@stack('styles')
		<script>
			// Force fresh loading with timestamp
			window.dashboardTimestamp = {{ $timestamp ?? time() }};

			// Completely disable Vue.js and Inertia
			(function() {
				// Disable Vue globally
				if (window.Vue) {
					window.Vue = null;
				}
				...
				// Prevent Vue from being loaded
				Object.defineProperty(window, 'Vue', {
					set: function() {},
					get: function() { return null; }
				});

				// Prevent Inertia from being loaded
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center d-lg-none ms-n3 me-1 me-md-2" title="Show sidebar menu">
							<div class="btn btn-icon btn-active-color-primary w-35px h-35px" id="kt_app_sidebar_mobile_toggle">
								<i class="fas fa-bars fs-2 fs-md-1"></i>
							</div>
						</div>
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="{{ route('dashboard') }}" class="d-lg-none">
								<i class="fas fa-museum text-primary fs-2"></i>
							</a>
						</div>
						<!--end::Mobile logo-->
