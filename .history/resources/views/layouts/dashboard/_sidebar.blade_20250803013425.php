        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-3 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Route::is('collections-management.*') || Route::is('categories-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <i class="fa fa-users fs-4"></i>
                            </span>
                            <span class="menu-title">Manajemen Koleksi</span>
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link {{ Route::is('collections-management.*') ? 'active' : '' }}" href="{{ route('collections-management.index') }}">
                                    ...
                                    <span class="menu-title">Data Koleksi</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ Route::is('categories-management.*') ? 'active' : '' }}" href="{{ route('categories-management.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Kategori Koleksi</span>
                                </a>
                            </div>
                        </div>
                    </div>

                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Route::is('news-management.*') || Route::is('news-categories-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ Route::is('news-categories-management.*') ? 'active' : '' }}" href="{{ route('news-categories-management.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('hero-images-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('hero-images-management.*') ? 'active' : '' }}" href="{{ route('hero-images-management.index') }}">
                            <span class="menu-icon">
                                <i class="fas fa-images fs-4"></i>
                            </span>
                            <span class="menu-title">Hero Images</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('settings-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('settings-management.*') ? 'active' : '' }}" href="{{ route('settings-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('users-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('users-management.*') ? 'active' : '' }}" href="{{ route('users-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('roles-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('roles-management.*') ? 'active' : '' }}" href="{{ route('roles-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('permissions-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('permissions-management.*') ? 'active' : '' }}" href="{{ route('permissions-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('analytics-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('analytics-management.*') ? 'active' : '' }}" href="{{ route('analytics-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('backup-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('backup-management.*') ? 'active' : '' }}" href="{{ route('backup-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('logs-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('logs-management.*') ? 'active' : '' }}" href="{{ route('logs-management.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('reports-management.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('reports-management.*') ? 'active' : '' }}" href="{{ route('reports-management.index') }}">
                            <span class="menu-icon">
