...
<html lang="en">
	...
	<head>
		...
		<!-- Prevent Vue.js interference -->
		<meta name="csrf-token" content="{{ csrf_token() }}">
		<meta name="dashboard-page" content="true">
		@include('layouts.dashboard.css')
		@stack('styles')
		<style>
			/* Ensure dashboard is not affected by Vue.js */
			#app {
			...
			/* Prevent Vue components from showing */
			[v-cloak] {
				display: none !important;
			}

			/* Ensure proper z-index for dashboard */
			.app-header {
			...
			/* Prevent Inertia.js interference */
			[data-page] {
				display: none !important;
			}
			...
			/* Override any Vue/Inertia styles */
			body {
