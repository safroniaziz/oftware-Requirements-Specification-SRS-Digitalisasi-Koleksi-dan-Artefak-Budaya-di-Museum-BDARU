        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-3 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('collections.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('collections.*') ? 'active' : '' }}" href="{{ route('collections.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('news.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('events.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('events.*') ? 'active' : '' }}" href="{{ route('events.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('testimonials.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('testimonials.*') ? 'active' : '' }}" href="{{ route('testimonials.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('team-members.*') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('team-members.*') ? 'active' : '' }}" href="{{ route('team-members.index') }}">
                            <span class="menu-icon">
