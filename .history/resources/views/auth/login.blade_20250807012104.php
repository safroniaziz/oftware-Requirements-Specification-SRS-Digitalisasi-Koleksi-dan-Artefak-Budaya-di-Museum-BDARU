...
<head>
    ...
    <title>Login - BDARU Museum Digital</title>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 relative overflow-hidden">
        ...
        <div class="relative z-10 min-h-screen flex items-center justify-center p-6">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-12 animate-fade-in-up">
                    ...
                    <div class="flex items-center justify-center mb-8">
                        <div class="relative group">
                            <div class="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-all duration-300 p-2">
                                <!-- BDARU Logo -->
                                <img src="{{ asset('assets/src/images/bdaru.jpeg') }}" alt="BDARU Museum" class="w-full h-full object-cover rounded-xl">
                            </div>
                        </div>
                    </div>
                ...
                <!-- Status Message -->
                @if (session('status'))
                    <div class="mb-8 p-4 bg-emerald-50 border border-emerald-200 rounded-xl text-sm text-emerald-800 text-center shadow-sm">
                        {{ session('status') }}
                    </div>
                @endif
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}" class="text-sm text-emerald-600 hover:text-emerald-700 font-medium transition-colors duration-200">
                                    Lupa password?
                                </a>
                            @endif
                        </div>
                        ...
                        <div class="pt-4">
                            <button
                                type="submit"
                                class="w-full py-4 btn-gradient text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-lg relative overflow-hidden group"
                                id="loginBtn"
                            >
                                ...
                                <span id="loginText" class="flex items-center justify-center relative z-10">
                                ...
                                <span id="loadingText" class="hidden flex items-center justify-center relative z-10">
                        ...
                        <div class="text-center pt-4">
                            <p class="text-gray-600 text-sm">
                                Belum punya akun?
                                <a href="{{ route('register') }}" class="text-emerald-600 hover:text-emerald-700 font-medium transition-colors duration-200">
                                    Daftar sekarang
                                </a>
                            </p>
                        </div>
