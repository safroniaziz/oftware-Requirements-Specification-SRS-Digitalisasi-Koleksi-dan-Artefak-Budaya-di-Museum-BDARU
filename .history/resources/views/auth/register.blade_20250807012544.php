                    ...
                    <div class="flex items-center justify-center mb-8">
                        <div class="relative group">
                            <div class="w-24 h-24 bg-white rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-all duration-300 p-1">
                                <!-- BDARU Logo -->
                                <img
                                    src="{{ asset('assets/src/images/bdaru.jpeg') }}?v={{ time() }}"
                                    alt="BDARU Museum"
                                    class="w-full h-full object-cover rounded-xl"
                                    style="max-width: 100%; height: auto; border: 2px solid red;"
                                    onload="console.log('BDARU logo loaded successfully');"
                                    onerror="console.log('BDARU logo failed to load'); this.style.display='none'; this.nextElementSibling.style.display='block';"
                                >
