                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-6">
                                ...
                                <small class="text-muted">Berita yang dipublikasikan akan ditampilkan di frontend</small>
                            </div>

                            <div class="mb-6">
                                <label for="category_id" class="form-label fw-bold">Kategori Berita <span class="text-danger">*</span></label>
