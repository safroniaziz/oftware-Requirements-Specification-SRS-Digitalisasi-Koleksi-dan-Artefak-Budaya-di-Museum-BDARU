                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <textarea class="form-control @error('summary') is-invalid @enderror"
                                                          ...
                                                          name="summary"
                                                          rows="3"
                                                          placeholder="Ringkasan singkat berita (opsional)">{{ old('summary', $news->summary) }}</textarea>
                                                @error('summary')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <div class="upload-zone border-2 border-dashed border-gray-300 rounded-lg p-6 text-center"
                                                     ...
                                                     style="{{ $news->image_path ? 'display: none;' : '' }}">
                                            ...
                                            <!--begin::Image Preview-->
                                            <div id="imagePreview" class="mb-6" style="{{ $news->image_path ? 'display: block;' : 'display: none;' }}">
                                                <div class="position-relative">
                                                    <img id="previewImg"
                                                         class="w-100 rounded-lg"
                                                         alt="Preview"
                                                         src="{{ $news->image_path ? asset('storage/' . $news->image_path) : '' }}">
                                                    <button type="button"
