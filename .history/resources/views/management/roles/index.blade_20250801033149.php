                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="confirmSuspend({{ $role->id }}, '{{ $role->name }}')"
                                                data-bs-toggle="tooltip"
                                                title="Suspend Role">
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="confirmRestore({{ $role->id }}, '{{ $role->name }}')"
                                                data-bs-toggle="tooltip"
                                                title="Restore Role">
...
function confirmSuspend(id, name) {
    Swal.fire({
        ...
        text: `Apakah Anda yakin ingin suspend role "${name}"?`,
        icon: 'warning',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/roles-management/${id}/suspend`;
...
function confirmRestore(id, name) {
    Swal.fire({
        ...
        text: `Apakah Anda yakin ingin restore role "${name}"?`,
        icon: 'question',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/roles-management/${id}/restore`;
