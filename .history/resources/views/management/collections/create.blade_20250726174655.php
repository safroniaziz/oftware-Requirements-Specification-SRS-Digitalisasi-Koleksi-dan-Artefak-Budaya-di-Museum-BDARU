                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="history_content" class="form-control form-control-solid" rows="4" placeholder="Masukkan konten untuk tab sejarah koleksi">{{ old('history_content') }}</textarea>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="technical_specifications" class="form-control form-control-solid" rows="4" placeholder="Masukkan spesifikasi teknis koleksi">{{ old('technical_specifications') }}</textarea>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="conservation_info" class="form-control form-control-solid" rows="4" placeholder="Masukkan informasi konservasi koleksi">{{ old('conservation_info') }}</textarea>
