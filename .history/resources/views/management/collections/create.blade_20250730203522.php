                                ...
                                <div class="col-lg-4">
                                    <div class="form-section">
                                        ...
                                        <div id="image-preview-area" class="mt-3" style="display: none;">
                                            <div class="image-preview-container mx-auto rounded-lg overflow-hidden border border-gray-200" style="width: 120px; height: 40px;">
...
function changeImage() {
    ...
    if (imageInput) {
        imageInput.click();
        // Tampilkan kembali dropzone dan sembunyikan preview
