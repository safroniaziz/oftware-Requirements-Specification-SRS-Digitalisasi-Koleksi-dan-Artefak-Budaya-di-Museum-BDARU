            ...
            <div class="card-header border-0 pt-6 bg-transparent">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-info me-3" onclick="testToast()">
...
function testToast() {
    ...
    setTimeout(() => {
        showToast('warning', 'Test Warning', 'Ini adalah test toast notification warning!');
    }, 1000);
    setTimeout(() => {
        showToast('success', 'Test Success', 'Ini adalah test toast notification success!');
    }, 2000);
}
</script>
@endsection
