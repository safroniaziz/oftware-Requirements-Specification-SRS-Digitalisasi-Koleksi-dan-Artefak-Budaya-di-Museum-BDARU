                    ...
                    <div class="wizard-step" data-step="2">
                        <div class="step-content">
                            <div class="form-section">
                                ...
                                <div class="upload-zone-large" id="gallery-upload-zone" style="{{ $collection->galleryImages && count($collection->galleryImages) > 0 ? 'display: none;' : '' }}">
                                    <div class="upload-content">
                                        <i class="fas fa-cloud-upload-alt"></i>
    ...
    const uploadBtn = document.getElementById('upload-btn');
     ...
     if (galleryPreview && galleryUploadZone) {
         ...
         if (existingGalleryImages.length > 0) {
             galleryUploadZone.style.display = 'none';
         }
     }
 ...
 function removeGalleryImage(galleryId, button) {
     Swal.fire({
         ...
         if (result.isConfirmed) {
             ...
             // Show upload zone if no more images
             const galleryPreview = document.getElementById('gallery-preview');
             const galleryUploadZone = document.getElementById('gallery-upload-zone');

             if (galleryPreview.children.length === 0 && galleryUploadZone) {
