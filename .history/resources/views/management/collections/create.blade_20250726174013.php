    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <form action="{{ route('collections-management.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <!--begin::Form group-->
                            <div class="fv-row mb-7">
                                <label class="fw-semibold fs-6 mb-2">Video Koleksi (URL)</label>
                                <input type="url" name="video_path" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="https://www.youtube.com/watch?v=..." value="{{ old('video_path') }}" />
                                <div class="form-text">Masukkan URL video YouTube atau platform video lainnya</div>
                                @error('video_path')
                                    <div class="text-danger fs-7 mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <!--begin::Form group-->
                            <div class="fv-row mb-7">
                                <label class="fw-semibold fs-6 mb-2">Dokumen PDF</label>
                                <input type="file" name="pdf_file" class="form-control form-control-solid mb-3 mb-lg-0" accept=".pdf" />
                                <div class="form-text">Upload dokumen PDF terkait koleksi (opsional)</div>
                                @error('pdf_file')
                                    <div class="text-danger fs-7 mt-1">{{ $message }}</div>
                                @enderror
                            </div>
