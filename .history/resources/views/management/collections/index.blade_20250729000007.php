                                ...
                                <div class="d-flex align-items-center">
                                    @if($collection->image_path)
                                        <div class="symbol symbol-35px me-3">
                                            <img src="{{ asset('storage/' . $collection->image_path) }}" alt="{{ $collection->name }}" class="object-cover rounded" style="width: 100%; height: 100%;" />
                                        </div>
                                    @else
                                        <div class="symbol symbol-35px me-3 bg-light-primary rounded">
                                            <i class="ki-duotone ki-boxes fs-1 text-primary">
