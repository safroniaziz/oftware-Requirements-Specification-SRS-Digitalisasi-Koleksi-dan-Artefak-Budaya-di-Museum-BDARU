        ...
        if (file) {
            ...
            reader.onload = function(e) {
                uploadZone.innerHTML = `
                    <div class="upload-content">
                        <div class="image-preview-container max-w-xs mx-auto rounded-lg overflow-hidden mb-4 border-2 border-gray-200">
                            <img src="${e.target.result}" class="w-full h-auto max-h-48 object-contain" alt="Preview">
                        </div>
        ...
        files.forEach((file, index) => {
            ...
            reader.onload = function(e) {
                ...
                previewItem.innerHTML = `
                    <div class="gallery-item-container max-w-32 mx-auto rounded-lg overflow-hidden border border-gray-200">
                        <img src="${e.target.result}" class="w-full h-auto max-h-24 object-contain" alt="Gallery Preview">
                    </div>
