                                ...
                                <div class="col-lg-4">
                                    <div class="form-section">
                                        ...
                                        <div class="upload-info">
                                            <small>Format: PNG, JPG, JPEG, GIF. Maksimal 2MB. Gambar akan otomatis di-crop dan di-resize ke ukuran optimal (800x600px).</small>
                                        </div>
                                        @error('image')
                                            <div class="error-text">{{ $message }}</div>
                                        @enderror
                    ...
                    <div class="wizard-step" data-step="2">
                        <div class="step-content">
                            <div class="form-section">
                                ...
                                <div class="upload-info">
                                    <small>Upload multiple gambar untuk galeri (opsional). Format: PNG, JPG, JPEG, GIF. Maksimal 2MB per gambar. Gambar akan otomatis di-crop dan di-resize ke ukuran optimal (300x200px).</small>
                                </div>
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                uploadZone.innerHTML = `
                    <div class="upload-content">
                        <div class="image-preview-container h-48 sm:h-56 lg:h-64 rounded-lg overflow-hidden mb-4">
        ...
        files.forEach((file, index) => {
            ...
            reader.onload = function(e) {
                ...
                previewItem.innerHTML = `
                    <div class="gallery-item-container h-24 sm:h-28 lg:h-32 rounded-lg overflow-hidden">
                        <img src="${e.target.result}" class="w-full h-full object-cover" alt="Gallery Preview">
                    </div>
                    <div class="gallery-item-info mt-2">
