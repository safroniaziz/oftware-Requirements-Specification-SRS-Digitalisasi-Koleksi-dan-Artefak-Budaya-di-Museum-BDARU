...
function previewQrCode(collectionId) {
    Swal.fire({
        ...
        html: `
            <div class="text-center">
                <img src="/admin/collections/${collectionId}/qr-code-preview" alt="QR Code Preview" class="img-fluid border rounded mb-2" style="max-width: 300px;">
                <p class="text-muted">Klik tombol "Tutup" untuk menutup preview.</p>
            </div>
        `,
        width: '400px',
