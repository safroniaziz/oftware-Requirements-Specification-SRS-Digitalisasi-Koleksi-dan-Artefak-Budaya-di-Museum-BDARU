                                ...
                                <div class="col-lg-4">
                                    <div class="form-section">
                                        ...
                                        <div id="image-preview-area" class="mt-3" style="display: none;">
                                            <div class="image-preview-container w-32 h-16 mx-auto rounded-lg overflow-hidden border border-gray-200">
                                            ...
                                            <div class="text-center mt-2">
                                                ...
                                                <div class="text-xs text-gray-500 mb-2">
                                                    ...
                                                    <span class="inline-block bg-yellow-100 text-yellow-800 px-1 py-0.5 rounded text-xs ml-1">Auto crop</span>
                                                </div>
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                uploadZone.innerHTML = `
                    <div class="upload-content">
                        <div class="image-preview-container w-32 h-16 mx-auto rounded-lg overflow-hidden mb-3 border border-gray-200">
                            <img src="${e.target.result}" class="w-full h-full object-cover" alt="Preview">
                        </div>
                        <h6 class="text-sm font-semibold text-gray-800 mb-1">Gambar Terpilih</h6>
                        <p class="text-xs text-gray-600 mb-2">${file.name}</p>
                        <div class="text-xs text-gray-500 mb-2">
                            <span class="inline-block bg-blue-100 text-blue-800 px-1 py-0.5 rounded text-xs">${(file.size / 1024 / 1024).toFixed(2)} MB</span>
                            <span class="inline-block bg-yellow-100 text-yellow-800 px-1 py-0.5 rounded text-xs ml-1">Auto crop</span>
                        </div>
                        <button type="button" class="upload-btn btn btn-sm btn-outline-primary" onclick="changeImage()">
                            Ganti
                        </button>
                    </div>
                `;
        ...
        files.forEach((file, index) => {
            ...
            reader.onload = function(e) {
                ...
                previewItem.innerHTML = `
                    <div class="gallery-item-container w-16 h-10 mx-auto rounded overflow-hidden border border-gray-200">
                        <img src="${e.target.result}" class="w-full h-full object-cover" alt="Gallery Preview">
                    </div>
                    <div class="gallery-item-info mt-1 text-center">
