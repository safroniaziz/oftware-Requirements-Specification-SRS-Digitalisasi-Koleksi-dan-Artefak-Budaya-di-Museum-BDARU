                    ...
                    <div class="wizard-step" data-step="4">
                        <div class="step-content">
                            <div class="form-section">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Ringkasan Konservasi</label>
                                    <textarea name="conservation_overview" class="form-input" rows="4" placeholder="Masukkan ringkasan proses konservasi koleksi">{{ old('conservation_overview') }}</textarea>
                                    <div class="form-hint">Informasi tentang proses konservasi yang telah dilakukan</div>
