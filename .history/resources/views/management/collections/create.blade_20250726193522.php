...
function showStepError(message) {
    ...
    const existingStepError = document.querySelector('.step-error');
    if (existingStepError) {
        existingStepError.remove();
    }

    // Add step error message
    const currentStepElement = document.querySelector(`.wizard-step[data-step="${currentStep}"]`);
    const errorDiv = document.createElement('div');
    errorDiv.className = 'step-error alert alert-danger';
...
function showStepWarning(message) {
    // Remove existing step warning
    const existingStepWarning = document.querySelector('.step-warning');
    if (existingStepWarning) {
        existingStepWarning.remove();
    }

    // Add step warning message
    const currentStepElement = document.querySelector(`.wizard-step[data-step="${currentStep}"]`);
    const warningDiv = document.createElement('div');
    warningDiv.className = 'step-warning alert alert-warning';
    ...
    // Insert at the beginning of step content
    const stepContent = currentStepElement.querySelector('.step-content');
    stepContent.insertBefore(warningDiv, stepContent.firstChild);
