                                ...
                                <div class="col-lg-4">
                                    <div class="form-section">
                                        ...
                                        <div class="upload-zone" id="upload-zone">
                                            ...
                                            <input type="file" name="image" id="image-input" accept=".png, .jpg, .jpeg, .gif" style="position: absolute; opacity: 0; pointer-events: none;" />
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const uploadBtn = document.getElementById('upload-btn'); // Get the button
