                ...
                <form action="{{ route('collections-management.update', $collection->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <!--begin::Form group-->
                            <div class="fv-row mb-7">
                                <label class="fw-semibold fs-6 mb-2">Ringkasan Konservasi</label>
                                <textarea name="conservation_overview" class="form-control form-control-solid" rows="4" placeholder="Masukkan ringkasan proses konservasi koleksi">{{ old('conservation_overview', $collection->conservation_overview) }}</textarea>
                                <div class="form-text">Informasi tentang proses konservasi yang telah dilakukan</div>
