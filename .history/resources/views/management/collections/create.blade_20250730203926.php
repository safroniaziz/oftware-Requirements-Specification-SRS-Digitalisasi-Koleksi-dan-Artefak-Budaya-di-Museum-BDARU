                                ...
                                <div class="col-lg-4">
                                    <div class="form-section">
                                        ...
                                        <div id="image-preview-area" class="mt-3" style="display: none;">
                                            <div class="image-preview-container w-full rounded-lg overflow-hidden border border-gray-200" style="height: 192px;">
                                            ...
                                            <div class="text-center mt-2">
                                                ...
                                                <div class="text-xs text-gray-500 mb-2">
                                                    <span class="inline-block bg-yellow-100 text-yellow-800 px-1 py-0.5 rounded text-xs">Akan di-crop ke 800×600px</span>
                                                </div>
                                        ...
                                        <div class="upload-info">
                                            <small>
                                                ...
                                                <strong>Catatan:</strong> Gambar akan di-crop ke ukuran 800×600px untuk tampilan optimal di website.
                                            </small>
                                        </div>
                                        @error('image')
                                            <div class="error-text">{{ $message }}</div>
