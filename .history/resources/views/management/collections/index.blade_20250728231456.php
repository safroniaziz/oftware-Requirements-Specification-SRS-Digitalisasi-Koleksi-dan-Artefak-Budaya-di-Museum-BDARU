                                ...
                                <div class="d-flex align-items-center">
                                    @if($collection->image_path)
                                        <div class="symbol symbol-45px me-5">
                                            <img src="{{ asset('storage/' . $collection->image_path) }}" alt="{{ $collection->name }}" class="object-cover" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
                                        </div>
                                    @endif
                                    @if(!$collection->image_path || $collection->image_path == '')
                                        <div class="symbol symbol-45px me-5 bg-light-primary">
                                            <i class="ki-duotone ki-boxes fs-2x text-primary">
