                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="conservation_status" class="form-input">
                                            ...
                                            <option value="Sangat Baik" {{ old('conservation_status') == 'Sangat Baik' ? 'selected' : '' }}>Sangat Baik</option>
                                            <option value="Baik" {{ old('conservation_status') == 'Baik' ? 'selected' : '' }}>Baik</option>
                                            <option value="Cukup" {{ old('conservation_status') == 'Cukup' ? 'selected' : '' }}>Cukup</option>
                                            <option value="Perlu Perawatan" {{ old('conservation_status') == 'Perlu Perawatan' ? 'selected' : '' }}>Perlu Perawatan</option>
                                            <option value="Rusak" {{ old('conservation_status') == 'Rusak' ? 'selected' : '' }}>Rusak</option>
                                        </select>
