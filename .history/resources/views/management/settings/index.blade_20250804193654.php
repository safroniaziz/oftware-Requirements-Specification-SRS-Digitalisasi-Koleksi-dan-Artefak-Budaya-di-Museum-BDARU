                                ...
                                <div class="d-flex align-items-center mb-3">
                                    @if(isset($settings['favicon_path']) && $settings['favicon_path'])
                                        <img src="{{ asset('storage/' . $settings['favicon_path']) }}"
                                             alt="Favicon" class="me-3" style="width: 48px; height: 48px; object-fit: cover; border-radius: 4px;">
                                    @else
                                        <div class="bg-light-primary rounded-3 d-flex align-items-center justify-content-center me-3"
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Format: ICO, PNG. Maksimal 1MB. Akan di-crop otomatis ke 64x64px (kotak)</small>
                                    </div>
                                </div>
                            </div>
