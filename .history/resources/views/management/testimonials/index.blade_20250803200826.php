                ...
                <div class="table-responsive">
                    <table class="table table-hover table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom" data-id="{{ $testimonial->id }}">
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            ...
                                            <span class="text-muted fw-semibold d-block fs-7 line-clamp-2 message">
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        <span class="fw-bold text-dark fs-7 visitor-name">
                                            {{ $testimonial->name ?? 'Anonim' }}
                                        </span>
                                        @if($testimonial->profession)
                                        <span class="text-muted fs-8 profession">
                                            {{ $testimonial->profession }}
                                        </span>
                                        @endif
                                        @if($testimonial->email)
                                        <span class="text-muted fs-8 email">
                                            {{ $testimonial->email }}
                                        </span>
                                        @endif
                                    </div>
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <span class="text-muted fs-8 rating">
...
function viewTestimonial(id) {
    // Get testimonial data from the table row
    const row = document.querySelector(`tr[data-id="${id}"]`);
    const visitorName = row.querySelector('.visitor-name')?.textContent?.trim() || 'Anonim';
    const profession = row.querySelector('.profession')?.textContent?.trim() || '-';
    const email = row.querySelector('.email')?.textContent?.trim() || '-';
    const rating = row.querySelector('.rating')?.textContent?.trim() || '0/5';
    const message = row.querySelector('.message')?.textContent?.trim() || 'Tidak ada pesan';
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-start">
                <div class="mb-3">
                    <strong>ID Testimoni:</strong> ${id}
                </div>
                <div class="mb-3">
                    <strong>Nama Pengunjung:</strong> ${visitorName}
                </div>
                <div class="mb-3">
                    <strong>Profesi:</strong> ${profession}
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <strong>Pesan Testimoni:</strong><br>
