                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <div class="alert alert-info d-flex align-items-center p-3 mb-0">
                            ...
                            <span class="fs-7">Testimoni diisi oleh pengunjung, admin hanya dapat melihat dan mengelola status</span>
                        </div>
                        <!--end::Info-->
                    </div>
                    <!--end::Toolbar-->
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="unapproveTestimonial({{ $testimonial->id }})"
                                                data-bs-toggle="tooltip"
...
function approveTestimonial(id) {
    Swal.fire({
        ...
        text: 'Apakah Anda yakin ingin menyetujui testimoni ini?',
        icon: 'question',
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/testimonials-management/${id}/approve`;
...
function unapproveTestimonial(id) {
    Swal.fire({
        ...
        text: 'Apakah Anda yakin ingin membatalkan persetujuan testimoni ini?',
        icon: 'warning',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/testimonials-management/${id}/unapprove`;
