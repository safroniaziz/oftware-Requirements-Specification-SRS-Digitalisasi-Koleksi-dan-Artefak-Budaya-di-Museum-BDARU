                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        @enderror
                                        <div class="form-text">Nama permission yang akan digunakan di sistem</div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="form-text">Deskripsi singkat tentang permission ini</div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @error('guard_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="form-text">Guard yang digunakan untuk permission ini</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-4">
                                        ...
                                        <div class="form-text">Permission aktif dapat digunakan</div>
                                    </div>
                                    ...
                                    <div class="alert alert-warning">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Perhatian:</strong> Mengubah permission dapat mempengaruhi akses user
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
document.getElementById('permissionForm').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        ...
        text: 'Apakah Anda yakin ingin mengupdate permission ini?',
        icon: 'question',
