...
@section('title', 'Manajemen Permissions - BDARU Museum')
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h2 class="fw-bold">Manajemen Permissions</h2>
                </div>
                <!--begin::Card title-->
                <!--begin::Card toolbar-->
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="{{ route('permissions-management.create') }}" class="btn btn-primary">
                            ...
                            <tr class="fw-bold text-muted bg-light-primary">
                                <th class="ps-4 min-w-300px rounded-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="text-dark fw-bold">Permission</span>
                                    </div>
                                </th>
                                <th class="min-w-125px text-center">
                                    <i class="fas fa-shield-alt me-2 text-primary"></i>
                                    <span class="text-dark fw-bold">Guard</span>
                                </th>
                                <th class="min-w-125px text-center">
                                    <i class="fas fa-users me-2 text-primary"></i>
                                    <span class="text-dark fw-bold">Jumlah Role</span>
                                </th>
                                <th class="min-w-125px text-center">
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <span class="text-muted fs-8">roles</span>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('permissions-management.edit', $permission->id) }}"
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="confirmSuspend({{ $permission->id }}, '{{ $permission->name }}')"
                                                data-bs-toggle="tooltip"
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="confirmRestore({{ $permission->id }}, '{{ $permission->name }}')"
                                                data-bs-toggle="tooltip"
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="symbol symbol-100px symbol-lg-150px symbol-fixed position-relative mx-auto mb-6">
                                            <div class="symbol-label bg-light-primary rounded-3">
                                                <i class="fas fa-key fs-2x text-primary"></i>
                                            </div>
                                        </div>
                                        <h3 class="text-muted mb-3">Belum ada permissions</h3>
                                        <p class="text-muted mb-6">Mulai dengan menambahkan permission pertama</p>
                                        <a href="{{ route('permissions-management.create') }}" class="btn btn-primary btn-lg">
                    ...
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item previous">
                                <a href="{{ $permissions->previousPageUrl() }}" class="page-link"><i class="previous"></i></a>
                            </li>
                        @endif
                        ...
                        @if ($permissions->hasMorePages())
                            <li class="page-item next">
                                <a href="{{ $permissions->nextPageUrl() }}" class="page-link"><i class="next"></i></a>
                            </li>
                        @else
...
function confirmDelete(id, name) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/permissions-management/${id}`;
...
function confirmSuspend(id, name) {
    Swal.fire({
        ...
        text: `Apakah Anda yakin ingin suspend permission "${name}"?`,
        icon: 'warning',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/permissions-management/${id}/suspend`;
...
function confirmRestore(id, name) {
    Swal.fire({
        ...
        text: `Apakah Anda yakin ingin restore permission "${name}"?`,
        icon: 'question',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/permissions-management/${id}/restore`;
