...
@section('title', 'Manajemen Hero Images - BDARU Museum')
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h2 class="fw-bold">Manajemen Hero Images</h2>
                </div>
                <!--begin::Card title-->
                <!--begin::Card toolbar-->
            ...
            <div class="card-body py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            ...
                                            <span class="text-muted fw-semibold d-block fs-7 line-clamp-2">
                                                {{ Str::limit($heroImage->description, 80) }}
                                            </span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        <span class="fw-bold text-dark fs-7">
                                            {{ $heroImage->created_at->format('d M Y') }}
                                        </span>
                                        <span class="text-muted fs-8">
                                            {{ $heroImage->created_at->format('H:i') }}
                                        </span>
                                    </div>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-10">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <h3 class="text-muted mb-3">Belum ada hero images</h3>
                                        <p class="text-muted mb-6">Mulai dengan menambahkan hero image pertama Anda</p>
                                        <a href="{{ route('hero-images-management.create') }}" class="btn btn-primary btn-lg">
                                            <i class="fas fa-plus me-2"></i>
                                            Tambah Hero Image Pertama
                                        </a>
                                    </div>
                                </td>
                            </tr>
                ...
                <!--begin::Pagination-->
                @if($heroImages->hasPages())
                <div class="d-flex flex-stack flex-wrap pt-10">
                    <div class="fs-6 fw-semibold text-gray-700">
                        Showing {{ $heroImages->firstItem() }} to {{ $heroImages->lastItem() }} of {{ $heroImages->total() }} entries
                    </div>
                    <ul class="pagination">
                        @if ($heroImages->onFirstPage())
                            <li class="page-item previous disabled">
                                <a href="#" class="page-link"><i class="previous"></i></a>
                            </li>
                        @else
                            <li class="page-item previous">
                                <a href="{{ $heroImages->previousPageUrl() }}" class="page-link"><i class="previous"></i></a>
                            </li>
                        @endif

                        @foreach ($heroImages->getUrlRange(1, $heroImages->lastPage()) as $page => $url)
                            @if ($page == $heroImages->currentPage())
                        ...
                        @if ($heroImages->hasMorePages())
                            <li class="page-item next">
                                <a href="{{ $heroImages->nextPageUrl() }}" class="page-link"><i class="next"></i></a>
                            </li>
                        @else
...
function confirmDelete(id, title) {
    Swal.fire({
        ...
        text: `Apakah Anda yakin ingin menghapus hero image "${title}"?`,
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/admin/hero-images/${id}`;
