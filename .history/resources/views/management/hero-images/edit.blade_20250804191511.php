                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="form-text">Upload gambar untuk hero image (opsional, akan crop otomatis ke 1200x800)</div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted d-block">Ukuran yang direkomendasikan: 1200x800px (3:2 ratio) - gambar akan di-crop otomatis</small>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
