                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-header">
                                <h3 class="card-title fw-bold text-dark">Edit Hero Image</h3>
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="text"
                                                       ...
                                                       id="subtitle"
                                                       name="subtitle"
                                                       value="{{ old('subtitle', $heroImage->subtitle) }}"
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror"
                                                          ...
                                                          required>{{ old('description', $heroImage->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                                ...
                                                <div class="image-upload-container">
                                                    ...
                                                    <div class="mt-3 p-3 bg-light-primary rounded">
                                                        ...
                                                        <ul class="text-muted small mb-0">
                                                            ...
                                                            <li>Rasio aspek: 16:9 (1920x1080)</li>
