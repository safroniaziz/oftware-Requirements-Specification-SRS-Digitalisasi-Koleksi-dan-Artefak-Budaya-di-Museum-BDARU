...
@section('title', 'Edit Kategori Berita - BDARU Museum')
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h2 class="fw-bold">Edit Kategori Berita: {{ $newsCategory->name }}</h2>
                </div>
                <!--end::Card title-->
                <!--begin::Card toolbar-->
            ...
            <div class="card-body py-4">
                <form action="{{ route('news-categories-management.update', $newsCategory->id) }}" method="POST" id="newsCategoryForm">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                                  ...
                                                  placeholder="Masukkan deskripsi kategori berita">{{ old('description', $newsCategory->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                                   value="1" {{ old('is_active', !$newsCategory->deleted_at) ? 'checked' : '' }}>
                                    ...
                                    <div class="alert alert-info">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Info:</strong> Kategori berita dibuat pada
                                                <strong>{{ $newsCategory->created_at->format('d M Y H:i') }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="alert alert-warning">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Perhatian:</strong> Mengubah kategori dapat mempengaruhi berita yang terkait
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
document.getElementById('newsCategoryForm').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        ...
        text: 'Apakah Anda yakin ingin mengupdate kategori berita ini?',
        icon: 'question',
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                title: 'Mengupdate...',
                text: 'Mohon tunggu, kategori berita sedang diupdate',
...
function resetForm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            document.getElementById('is_active').checked = {{ !$newsCategory->deleted_at ? 'true' : 'false' }};
        }
    });
}
