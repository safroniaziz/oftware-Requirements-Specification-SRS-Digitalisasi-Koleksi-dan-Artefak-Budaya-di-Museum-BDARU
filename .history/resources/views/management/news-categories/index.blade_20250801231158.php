...
@section('title', 'Manajemen Kategori Berita - BDARU Museum')
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h2 class="fw-bold">Manajemen Kategori Berita</h2>
                </div>
                <!--begin::Card title-->
                <!--begin::Card toolbar-->
            ...
            <div class="card-body py-4">
                            ...
                            <tr class="fw-bold text-muted bg-light-primary">
                                <th class="ps-4 min-w-300px rounded-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="text-dark fw-bold">Kategori Berita</span>
                                    </div>
                                </th>
                                <th class="min-w-125px text-center">
                                    <i class="fas fa-hashtag me-2 text-primary"></i>
                                    <span class="text-dark fw-bold">Jumlah Berita</span>
                                </th>
                                <th class="min-w-125px text-center">
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <span class="text-muted fs-8">berita</span>
                                    </div>
                                </td>
                                <td class="text-center">
                                    @if($category->is_active)
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-10">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <h3 class="text-muted mb-3">Belum ada kategori berita</h3>
                                        <p class="text-muted mb-6">Mulai dengan menambahkan kategori berita pertama</p>
                                        <a href="{{ route('news-categories-management.create') }}" class="btn btn-primary btn-lg">
                                            <i class="fas fa-plus me-2"></i>
                                            Tambah Kategori Berita Pertama
                                        </a>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="d-flex flex-stack flex-wrap pt-10">
                    <div class="fs-6 fw-semibold text-gray-700">
                        Showing {{ $newsCategories->firstItem() }} to {{ $newsCategories->lastItem() }} of {{ $newsCategories->total() }} entries
                    </div>
                    <ul class="pagination">
                        @if ($newsCategories->onFirstPage())
                            <li class="page-item previous disabled">
                                <a href="#" class="page-link"><i class="previous"></i></a>
                            </li>
                        @else
                            <li class="page-item previous">
                                <a href="{{ $newsCategories->previousPageUrl() }}" class="page-link"><i class="previous"></i></a>
                            </li>
                        @endif

                        @foreach ($newsCategories->getUrlRange(1, $newsCategories->lastPage()) as $page => $url)
                            @if ($page == $newsCategories->currentPage())
                        ...
                        @if ($newsCategories->hasMorePages())
                            <li class="page-item next">
                                <a href="{{ $newsCategories->nextPageUrl() }}" class="page-link"><i class="next"></i></a>
                            </li>
                        @else
