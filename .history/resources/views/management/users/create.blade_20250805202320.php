                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="email_verified_at" name="email_verified_at"
                                                   value="1" {{ old('email_verified_at', true) ? 'checked' : '' }}>
                                    ...
                                    <div class="alert alert-info">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Info:</strong> User akan dibuat dengan email terverifikasi secara default
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
function resetForm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            document.getElementById('email_verified_at').checked = true;
        }
    });
}
