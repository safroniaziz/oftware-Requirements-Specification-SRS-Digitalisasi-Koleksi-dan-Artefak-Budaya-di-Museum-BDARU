                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="form-text">Alamat lengkap user</div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="email_verified_at" name="email_verified_at"
                                                   value="1" {{ old('email_verified_at', $user->email_verified_at) ? 'checked' : '' }}>
                                    ...
                                    <div class="alert alert-info">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Info:</strong> User dibuat pada
                                    ...
                                    <div class="alert alert-warning">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong>Perhatian:</strong> Mengubah user dapat mempengaruhi akses sistem
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
function resetForm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            document.getElementById('email_verified_at').checked = {{ $user->email_verified_at ? 'true' : 'false' }};

            // Reset roles
            const rolesSelect = document.getElementById('roles');
            for (let i = 0; i < rolesSelect.options.length; i++) {
                rolesSelect.options[i].selected = {{ $user->roles->pluck('id')->toArray() }}.includes(parseInt(rolesSelect.options[i].value));
            }
        }
    });
}
