                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="email_verified_at" name="email_verified_at"
                                                   value="1" {{ old('email_verified_at', $user->email_verified_at ? true : false) ? 'checked' : '' }}>
...
function resetForm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            const userRoleIds = [{{ $user->roles->pluck('id')->implode(',') }}];
            for (let i = 0; i < rolesSelect.options.length; i++) {
                rolesSelect.options[i].selected = userRoleIds.includes(parseInt(rolesSelect.options[i].value));
            }
        }
    });
}
