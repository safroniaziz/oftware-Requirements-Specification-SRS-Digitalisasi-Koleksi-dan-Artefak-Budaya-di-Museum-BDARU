                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-6">
                                ...
                                @enderror
                                <small class="text-muted">Nama kategori yang akan ditampilkan</small>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                @error('slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">URL-friendly version dari nama kategori (opsional)</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-6">
                                ...
                                @error('sort_order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Urutan tampilan kategori (0 = paling atas)</small>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Warna untuk kategori (opsional)</small>
                            </div>
                            ...
                            <div class="mb-6">
                                <div class="alert alert-info">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <strong>Info:</strong> Kategori ini memiliki
                                            <strong>{{ $category->collections_count ?? 0 }} koleksi</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function resetForm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            document.getElementById('is_active').checked = {{ $category->is_active ? 'true' : 'false' }};
        }
    });
}
