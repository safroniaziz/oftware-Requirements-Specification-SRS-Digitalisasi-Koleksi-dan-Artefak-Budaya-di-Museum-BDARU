                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Masukkan deskripsi singkat">{{ old('description', $teamMember->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-6">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                       id="sort_order" name="sort_order" value="{{ old('sort_order', $teamMember->sort_order ?? 0) }}"
...
function resetForm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            document.getElementById('sort_order').value = '{{ $teamMember->sort_order ?? 0 }}';
