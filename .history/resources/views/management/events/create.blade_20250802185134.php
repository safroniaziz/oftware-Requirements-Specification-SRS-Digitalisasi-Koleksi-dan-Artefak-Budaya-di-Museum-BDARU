    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <form action="{{ route('events-management.store') }}" method="POST" id="eventForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="mb-6">
                                ...
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Status event saat ini</small>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <select class="form-select @error('event_type') is-invalid @enderror" id="event_type" name="event_type">
                                    ...
                                    <option value="exhibition" {{ old('event_type') == 'exhibition' ? 'selected' : '' }}>Pameran</option>
                                    ...
                                    <option value="conference" {{ old('event_type') == 'conference' ? 'selected' : '' }}>Konferensi</option>
                                    <option value="performance" {{ old('event_type') == 'performance' ? 'selected' : '' }}>Pertunjukan</option>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea class="form-control @error('contact_info') is-invalid @enderror"
                                          ...
                                          placeholder="Email, telepon, atau informasi kontak lainnya">{{ old('contact_info') }}</textarea>
                                @error('contact_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-6">
                                <div class="alert alert-info">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <strong>Info:</strong> Agenda akan dibuat dengan pengaturan default
                                        </div>
                                    </div>
                                </div>
                            </div>
...
document.getElementById('eventForm').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
                title: 'Menyimpan...',
                text: 'Mohon tunggu, agenda sedang disimpan',
