                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if($event->image)
                                            <div class="mt-3" id="currentImageContainer">
                                                ...
                                                <div class="relative h-48 overflow-hidden rounded-lg border border-gray-200">
                                        ...
                                        <div id="imagePreview" class="mt-3" style="display: none;">
                                            ...
                                            <div class="mt-2 text-center">
                                                <small class="text-muted">Preview gambar baru dengan ukuran yang lebih kecil untuk kemudahan melihat</small>
                                            </div>
                                        </div>
                                    </div>
