            ...
            <div class="min-h-[400px]">
                ...
                <div v-if="activeTab === 'overview'" class="space-y-8" data-aos="fade-up">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    ...
                                    <span class="text-gray-900 font-semibold">{{ collection.material || '-' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    <span class="text-gray-600 font-medium">Dimensi</span>
                                    <span class="text-gray-900 font-semibold">{{ collection.dimensions || '-' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                ...
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    ...
                                    <span class="text-gray-900 font-semibold">{{ collection.conservation_status || 'Baik' }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            ...
                            <div class="space-y-4">
                                <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-200">
                                    ...
                                    <p class="text-emerald-700 text-sm">{{ collection.conservation_overview || 'Koleksi ini telah melalui proses konservasi dan digitalisasi yang ketat untuk memastikan kelestariannya.' }}</p>
                                </div>
                    ...
                    <div v-if="collection.technical_overview" class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        ...
                        <div class="prose prose-lg max-w-none">
                            <p class="text-gray-700 leading-relaxed">{{ collection.technical_overview }}</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
                            ...
                            <h4 class="font-semibold text-gray-900 mb-1">Nilai Budaya</h4>
                            <p class="text-sm text-gray-600">{{ collection.nilai_budaya || 'Mewakili warisan budaya dan tradisi yang berharga' }}</p>
                        </div>
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                            ...
                            <p class="text-sm text-gray-600">{{ collection.nilai_historis || 'Menggambarkan sejarah dan perkembangan budaya' }}</p>
                        </div>
                        <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                            ...
                            <p class="text-sm text-gray-600">{{ collection.nilai_edukatif || 'Memberikan pembelajaran tentang teknik dan filosofi budaya tradisional' }}</p>
                        </div>
                    </div>
                </div>
