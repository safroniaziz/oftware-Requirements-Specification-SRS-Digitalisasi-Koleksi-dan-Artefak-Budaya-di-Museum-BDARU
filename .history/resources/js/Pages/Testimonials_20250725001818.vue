    ...
    class Particle {
        constructor() {
            ...
            this.color = [
                ...
                'rgba(20, 184, 166, ' + this.opacity + ')', // teal
...
<template>
    ...
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 overflow-hidden">
        ...
        <div class="absolute inset-0 pointer-events-none">
            ...
            <div class="absolute top-1/3 right-1/3 w-1.5 h-1.5 bg-yellow-300 rounded-full animate-ping" style="animation-delay: 0.5s;"></div>
            <div class="absolute bottom-1/3 left-1/3 w-1 h-1 bg-yellow-500 rounded-full animate-ping" style="animation-delay: 1s;"></div>
            <div class="absolute bottom-1/4 right-1/4 w-2.5 h-2.5 bg-yellow-400 rounded-full animate-ping" style="animation-delay: 1.5s;"></div>
            <div class="absolute top-1/2 left-1/2 w-1.5 h-1.5 bg-yellow-300 rounded-full animate-ping" style="animation-delay: 2s;"></div>

            <!-- Additional sparkles -->
            <div class="absolute top-1/6 right-1/6 w-1 h-1 bg-yellow-400 rounded-full animate-sparkle"></div>
            <div class="absolute bottom-1/6 left-1/6 w-1.5 h-1.5 bg-yellow-300 rounded-full animate-sparkle" style="animation-delay: 1s;"></div>
            <div class="absolute top-3/4 right-1/4 w-1 h-1 bg-yellow-500 rounded-full animate-sparkle" style="animation-delay: 2s;"></div>
        </div>

        <!-- Glowing Orbs -->
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute top-20 left-20 w-4 h-4 bg-emerald-400 rounded-full shadow-lg shadow-emerald-400/50 animate-pulse"></div>
            <div class="absolute top-40 right-40 w-3 h-3 bg-teal-400 rounded-full shadow-lg shadow-teal-400/50 animate-pulse" style="animation-delay: 0.5s;"></div>
            <div class="absolute bottom-40 left-40 w-5 h-5 bg-cyan-400 rounded-full shadow-lg shadow-cyan-400/50 animate-pulse" style="animation-delay: 1s;"></div>
            <div class="absolute bottom-20 right-20 w-2 h-2 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/50 animate-pulse" style="animation-delay: 1.5s;"></div>

            <!-- Glowing particles with new animation -->
            <div class="absolute top-1/3 left-1/3 w-3 h-3 bg-emerald-400 rounded-full animate-glow"></div>
            <div class="absolute bottom-1/3 right-1/3 w-2 h-2 bg-teal-400 rounded-full animate-glow" style="animation-delay: 1s;"></div>
            <div class="absolute top-2/3 left-2/3 w-4 h-4 bg-cyan-400 rounded-full animate-glow" style="animation-delay: 2s;"></div>
        </div>

        <!-- Floating Particles -->
        <div class="absolute inset-0 pointer-events-none">
            <!-- Large floating circles -->
            <div class="absolute top-20 left-10 w-32 h-32 bg-emerald-200/30 rounded-full animate-float-slow"></div>
            <div class="absolute top-40 right-20 w-24 h-24 bg-teal-200/40 rounded-full animate-float-medium"></div>
            <div class="absolute bottom-40 left-20 w-20 h-20 bg-cyan-200/35 rounded-full animate-float-fast"></div>
            <div class="absolute bottom-20 right-10 w-28 h-28 bg-emerald-300/25 rounded-full animate-float-slow"></div>

            <!-- Medium floating elements -->
            <div class="absolute top-1/3 left-1/4 w-16 h-16 bg-gradient-to-r from-emerald-400/20 to-teal-400/20 rounded-full animate-float-medium"></div>
            <div class="absolute top-2/3 right-1/3 w-12 h-12 bg-gradient-to-r from-teal-400/25 to-cyan-400/25 rounded-full animate-float-fast"></div>
            <div class="absolute bottom-1/3 left-1/2 w-14 h-14 bg-gradient-to-r from-cyan-400/20 to-emerald-400/20 rounded-full animate-float-slow"></div>

            <!-- Small floating dots -->
            <div class="absolute top-1/4 right-1/4 w-3 h-3 bg-emerald-400/40 rounded-full animate-float-fast"></div>
            <div class="absolute top-3/4 left-1/3 w-2 h-2 bg-teal-400/50 rounded-full animate-float-medium"></div>
            <div class="absolute bottom-1/4 right-1/2 w-4 h-4 bg-cyan-400/35 rounded-full animate-float-slow"></div>
            <div class="absolute top-1/2 left-1/6 w-2.5 h-2.5 bg-emerald-500/30 rounded-full animate-float-fast"></div>
            <div class="absolute bottom-1/2 right-1/6 w-3.5 h-3.5 bg-teal-500/25 rounded-full animate-float-medium"></div>

            <!-- Geometric shapes -->
            <div class="absolute top-1/6 right-1/6 w-8 h-8 bg-emerald-300/20 rotate-45 animate-float-slow"></div>
            <div class="absolute bottom-1/6 left-1/6 w-6 h-6 bg-teal-300/30 rotate-12 animate-float-medium"></div>
            <div class="absolute top-5/6 right-1/2 w-10 h-10 bg-cyan-300/25 rotate-30 animate-float-fast"></div>

            <!-- Additional decorative elements -->
            <div class="absolute top-1/5 left-1/5 w-6 h-6 border-2 border-emerald-300/30 rounded-full animate-float-medium"></div>
            <div class="absolute bottom-1/5 right-1/5 w-4 h-4 border-2 border-teal-300/40 rounded-full animate-float-fast"></div>
            <div class="absolute top-4/5 left-1/2 w-8 h-8 border-2 border-cyan-300/25 rounded-full animate-float-slow"></div>

            <!-- Bouncing particles -->
            <div class="absolute top-1/8 left-1/8 w-2 h-2 bg-emerald-400/60 rounded-full animate-bounce-gentle"></div>
            <div class="absolute bottom-1/8 right-1/8 w-3 h-3 bg-teal-400/50 rounded-full animate-bounce-gentle" style="animation-delay: 1s;"></div>
            <div class="absolute top-7/8 left-1/8 w-2.5 h-2.5 bg-cyan-400/40 rounded-full animate-bounce-gentle" style="animation-delay: 2s;"></div>
        </div>
        ...
        <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl md:text-2xl text-emerald-100 mb-12 max-w-4xl mx-auto leading-relaxed">
                    Dengarkan pengalaman dan kesan pengunjung tentang BDARU Museum Digital Balai Adat Rajo Penghulu.
                    <br>
                ...
                <div class="max-w-2xl mx-auto mb-12">
                    <button
                        @click="document.getElementById('testimonial-form').scrollIntoView({ behavior: 'smooth' })"
                        class="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-2xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
                    >
        ...
        <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-black text-gray-900 mb-6">
                    Apa Kata <span class="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Mereka</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                    Pengalaman langsung dari pengunjung yang telah menjelajahi kekayaan budaya Indonesia melalui platform digital kami
                </p>
            </div>
    ...
    <section id="testimonial-form" class="py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
        <div class="absolute inset-0">
            <!-- Background Elements -->
