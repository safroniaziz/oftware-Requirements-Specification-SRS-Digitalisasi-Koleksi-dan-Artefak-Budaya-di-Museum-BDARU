                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="600">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-1">
                                        <p class="text-gray-600">Senin - Jumat: <span class="font-semibold text-blue-600">08:00 - 17:00</span></p>
                                        <p class="text-gray-600">Sabtu: <span class="font-semibold text-blue-600">09:00 - 15:00</span></p>
                                        <p class="text-gray-600">Minggu: <span class="font-semibold text-red-500">Tutup</span></p>
                                    </div>
                                    <div class="mt-3">
