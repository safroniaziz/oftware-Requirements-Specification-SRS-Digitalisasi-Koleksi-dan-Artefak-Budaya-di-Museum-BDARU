            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight">
                        Museum <span class="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">Events</span>
                    </h1>

                    <!-- Subtitle -->
                    <p class="text-xl md:text-2xl text-emerald-100 mb-12 max-w-4xl mx-auto leading-relaxed">
                        Discover exciting exhibitions, workshops, seminars, and performances at BDARU Museum.
                        <br>
                        <span class="text-lg text-emerald-200">From art exhibitions to cultural workshops, all events are here.</span>
                    </p>
