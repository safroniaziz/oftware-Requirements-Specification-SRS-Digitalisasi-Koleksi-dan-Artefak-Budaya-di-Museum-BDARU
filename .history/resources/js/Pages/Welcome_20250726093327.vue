    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="py-12 lg:py-24 bg-white">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-12 lg:mb-16">
                    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4" data-aos="fade-up">
                        Koleksi Unggulan
                    </h2>
                    <p class="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto px-4" data-aos="fade-up" data-aos-delay="200">
                        Jelajahi koleksi budaya terbaik yang telah dipilih khusus untuk Anda
                    </p>
                </div>
        ...
        <section class="py-12 lg:py-24 bg-gray-50">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    <div
                        v-for="news in props.recentNews.slice(0, 6)"
                        :key="news.id"
                        class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100"
                        data-aos="fade-up"
                    >
