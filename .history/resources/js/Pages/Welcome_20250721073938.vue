...
const heroImages = [
    {
        id: 1,
        src: 'data:image/svg+xml;base64,',
        alt: 'Museum Interior',
    ...
    {
        id: 2,
        src: 'data:image/svg+xml;base64,',
    ...
    {
        id: 3,
        src: 'data:image/svg+xml;base64,',
    ...
    {
        id: 4,
        src: 'data:image/svg+xml;base64,',
    ...
    {
        id: 5,
        src: 'data:image/svg+xml;base64,',
        alt: 'Digital Museum',
                    ...
                    <div class="w-full lg:w-1/2 pl-0 lg:pl-12 mt-12 lg:mt-0">
                        <div class="relative h-96 lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-gray-200">
                            ...
                            >
                                ...
                                >
                                    <div class="relative w-full h-full flex items-center justify-center">
                                        ...
                                        <div class="absolute bottom-6 left-6 right-6 z-10">
                                            <div class="bg-white/20 backdrop-blur-md rounded-2xl p-4 border border-white/30 transform transition-all duration-1000">
                                                <h3 class="text-white font-bold text-xl mb-2">{{ image.title }}</h3>
                                                <p class="text-white/90 text-sm">{{ image.subtitle }}</p>
                                                <p class="text-white/80 text-xs mt-2">{{ image.description }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                ...
                                <div v-if="heroImages.length === 0" class="w-full h-full flex items-center justify-center bg-gray-200">
