        ...
        <nav class="bg-white/95 backdrop-blur-md shadow-xl border-b border-gray-100 sticky top-0 z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center group">
                        <div class="flex-shrink-0 relative">
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-all duration-300">
                ...
                <div class="flex justify-center py-3">
                    <div class="flex items-center space-x-1 bg-gray-50/80 backdrop-blur-sm rounded-2xl p-2 border border-gray-100">
                        <Link
                            href="/"
                            class="relative px-6 py-3 text-gray-700 font-medium rounded-xl hover:text-blue-600 transition-all duration-300 group"
                        >
                            <span class="relative z-10 flex items-center space-x-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute inset-0 bg-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-sm"></div>
                        </Link>
                        <Link
                            href="/collections"
                            class="relative px-6 py-3 text-gray-700 font-medium rounded-xl hover:text-blue-600 transition-all duration-300 group"
