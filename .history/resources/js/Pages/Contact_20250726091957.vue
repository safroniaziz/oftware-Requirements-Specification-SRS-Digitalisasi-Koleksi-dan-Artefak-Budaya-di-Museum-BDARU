                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600 mb-3">{{ props.museumSettings?.phone_1 || '+62 21 1234 5678' }}</p>
                                    <p class="text-gray-600 text-sm">{{ props.museumSettings?.phone_2 || '+62 21 1234 5679' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="400">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600 mb-3">{{ props.museumSettings?.email_info || 'info@bdaru-museum.com' }}</p>
                                    <p class="text-gray-600 text-sm">{{ props.museumSettings?.email_support || 'support@bdaru-museum.com' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="500">
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600 mb-3">{{ props.museumSettings?.address || 'Jl. Museum Nasional No. 1' }}</p>
                                    <p class="text-gray-600 text-sm">{{ props.museumSettings?.city || 'Jakarta Pusat' }}, {{ props.museumSettings?.country || 'Indonesia' }}</p>
                                </div>
                            </div>
                        </div>
