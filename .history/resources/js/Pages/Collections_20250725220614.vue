...
<template>
    ...
    <div class="fixed top-0 left-0 right-0 bg-white/98 backdrop-blur-xl border-b border-gray-200/50 shadow-lg z-50">
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4 min-w-0">
                    ...
                    <div class="flex-shrink-0 relative">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex flex-col min-w-0">
                                <h1 class="text-2xl font-black bg-gradient-to-r from-emerald-700 via-teal-700 to-cyan-700 bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300 truncate">
                                    BDARU
                                </h1>
                                <p class="text-xs text-gray-700 font-semibold tracking-wider uppercase opacity-90 group-hover:opacity-100 transition-opacity duration-300 truncate">
                ...
                <div class="lg:hidden relative z-50 flex-shrink-0">
                    <button
    ...
    <!-- Hero Section -->
    <section class="relative py-20 lg:py-32 bg-gradient-to-br from-emerald-900 via-teal-800 to-cyan-900 overflow-hidden" :class="{ 'mt-20': !mobileMenuOpen, 'mt-0': mobileMenuOpen }">
