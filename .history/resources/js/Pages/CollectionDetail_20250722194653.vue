...
<template>
    <Head :title="`${collection.name} - BDARU Museum Digital Indonesia`" />
        ...
        <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-200">
                        ...
                        <div class="absolute bottom-4 left-4">
                            <div class="flex items-center space-x-2 bg-black/50 backdrop-blur-sm rounded-full px-3 py-1">
                                ...
                                <span class="text-white text-sm font-medium">{{ formatNumber(collection.views) }} views</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left">
                    ...
                    <!-- Subtitle -->
                    <p class="text-xl text-emerald-100 mb-6">{{ collection.subtitle }}</p>

                    <!-- Rating -->
                    <div class="flex items-center justify-center lg:justify-start space-x-2 mb-6">
                        <div class="flex items-center space-x-1">
                            <svg v-for="i in 5" :key="i" class="w-5 h-5" :class="i <= Math.floor(collection.rating) ? 'text-yellow-400' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                            </svg>
                        </div>
                        <span class="text-white font-semibold">{{ collection.rating }}/5</span>
                        <span class="text-emerald-200">({{ formatNumber(collection.views) }} views)</span>
                    </div>

                    <!-- Quick Info -->
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <div class="text-emerald-300 text-sm font-medium">Tahun</div>
                            <div class="text-white font-bold">{{ collection.year }}</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <div class="text-emerald-300 text-sm font-medium">Seniman</div>
                            <div class="text-white font-bold">{{ collection.artist }}</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <div class="text-emerald-300 text-sm font-medium">Lokasi</div>
                            <div class="text-white font-bold">{{ collection.location }}</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                            <div class="text-emerald-300 text-sm font-medium">Status</div>
                            <div class="text-white font-bold">{{ collection.status }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap justify-center lg:justify-start gap-2 mb-8">
                        <span
                            ...
                            :key="tag"
                            class="inline-flex items-center px-3 py-1 bg-emerald-600/20 text-emerald-200 text-sm font-medium rounded-full border border-emerald-400/30"
                        >
                            {{ tag }}
                        </span>
                    </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    ...
                                    <span class="text-gray-900 font-semibold">{{ collection.year }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                    <span class="text-gray-600 font-medium">Status Konservasi</span>
                                    <span class="text-gray-900 font-semibold">{{ collection.status }}</span>
                                </div>
                                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                                ...
                                <div class="flex justify-between items-center py-3">
                                    ...
                                    <span class="text-gray-900 font-semibold">{{ collection.rating }}/5</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        ...
                        <div class="space-y-6">
                            <div class="relative pl-8 border-l-4 border-emerald-500">
                                ...
                                <h4 class="font-semibold text-gray-900 mb-2">{{ collection.year }}</h4>
                            ...
                            <div class="relative pl-8 border-l-4 border-teal-500">
                                ...
                                <h4 class="font-semibold text-gray-900 mb-2">Era {{ collection.artist }}</h4>
                                <p class="text-gray-700">Dibuat oleh {{ collection.artist }}, menandakan periode keahlian dan tradisi yang berkembang pada masa itu.</p>
                            </div>
                            <div class="relative pl-8 border-l-4 border-cyan-500">
                                ...
                                <p class="text-gray-700">Berasal dari {{ collection.location }}, menunjukkan pengaruh budaya dan tradisi lokal yang khas.</p>
                            </div>
