...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white/98 backdrop-blur-xl border-b border-gray-200/50 shadow-lg">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-center space-x-12 py-6">
                    <Link
                        href="/"
                        class="nav-link text-gray-700 font-bold text-lg hover:text-emerald-600 transition-all duration-300 relative group"
                    >
                        <span class="relative z-10">Beranda</span>
                        <div class="absolute inset-0 bg-emerald-100 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </Link>
                    <Link
                        href="/collections"
                        class="nav-link text-gray-700 font-bold text-lg hover:text-emerald-600 transition-all duration-300 relative group"
                    >
                        <span class="relative z-10">Koleksi</span>
                        <div class="absolute inset-0 bg-emerald-100 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </Link>
                    <Link
                        href="/exhibitions"
                        class="nav-link text-gray-700 font-bold text-lg hover:text-emerald-600 transition-all duration-300 relative group"
                    >
                        <span class="relative z-10">Pameran</span>
                        <div class="absolute inset-0 bg-emerald-100 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </Link>
                    <Link
                        href="/about"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-emerald-200/50 hover:bg-white hover:border-emerald-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-xl hover:shadow-2xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-teal-200/50 hover:bg-white hover:border-teal-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-xl hover:shadow-2xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-cyan-200/50 hover:bg-white hover:border-cyan-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-xl hover:shadow-2xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-20">
                    <div class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full border-2 border-emerald-200 mb-8 group hover:bg-gradient-to-r hover:from-emerald-200 hover:to-teal-200 transition-all duration-300 shadow-lg">
                        ...
                        <span class="text-base font-bold">💬 Testimoni Pengunjung</span>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-3xl p-10 border-2 border-emerald-200/50 hover:bg-white hover:border-emerald-300 transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 shadow-xl hover:shadow-2xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full flex items-center justify-center mr-4">
                                    <span class="text-white font-bold text-xl">S</span>
                                </div>
                                <div>
                                    <h4 class="text-gray-800 font-bold text-lg">Sarah Wijaya</h4>
                                    <p class="text-gray-600 text-sm">Mahasiswa Seni Rupa</p>
                                </div>
                            </div>
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-3xl p-10 border-2 border-teal-200/50 hover:bg-white hover:border-teal-300 transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 shadow-xl hover:shadow-2xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-full flex items-center justify-center mr-4">
                                    <span class="text-white font-bold text-xl">A</span>
                                </div>
                                <div>
                                    <h4 class="text-gray-800 font-bold text-lg">Ahmad Rahman</h4>
                                    <p class="text-gray-600 text-sm">Peneliti Arkeologi</p>
                                </div>
                            </div>
                            <p class="text-gray-700 text-base leading-relaxed italic">
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-3xl p-10 border-2 border-cyan-200/50 hover:bg-white hover:border-cyan-300 transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 shadow-xl hover:shadow-2xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full flex items-center justify-center mr-4">
                                    <span class="text-white font-bold text-xl">M</span>
                                </div>
                                <div>
                                    <h4 class="text-gray-800 font-bold text-lg">Maria Sari</h4>
                                    <p class="text-gray-600 text-sm">Guru Seni Budaya</p>
                                </div>
                            </div>
                            <p class="text-gray-700 text-base leading-relaxed italic">
                ...
                <div class="text-center">
                    <div class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full border-2 border-emerald-200 mb-8 group hover:bg-gradient-to-r hover:from-emerald-200 hover:to-teal-200 transition-all duration-300 shadow-lg">
                        <div class="w-3 h-3 bg-emerald-500 rounded-full mr-3 animate-pulse"></div>
                        <span class="text-base font-bold">🚀 Mulai Jelajahi Sekarang</span>
                    </div>
                    ...
                    <p class="text-xl md:text-2xl text-gray-700 font-medium max-w-4xl mx-auto leading-relaxed mb-12">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 justify-center">
                        <Link
                            href="/register"
                            class="group relative px-12 py-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-2xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 overflow-hidden animate-bounce-subtle"
                        >
                        ...
                        <Link
                            href="/collections"
                            class="group relative px-12 py-6 border-3 border-emerald-300 text-emerald-700 font-bold rounded-2xl backdrop-blur-md hover:bg-emerald-50 hover:border-emerald-400 transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 shadow-lg"
                        >
                            <span class="relative z-10 flex items-center justify-center gap-4 text-xl">
