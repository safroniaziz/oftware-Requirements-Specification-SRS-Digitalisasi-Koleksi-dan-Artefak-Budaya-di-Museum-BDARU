                    ...
                    >
                        <div class="px-4 py-6">
                            ...
                            <div class="space-y-2 mb-6">
                                ...
                                <Link
                                    href="/"
                                    class="flex items-center px-4 py-3 text-emerald-600 font-semibold rounded-lg bg-emerald-50 transition-colors duration-200"
                                ...
                                <Link
                                    href="/collections"
                                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-50 hover:text-emerald-600 transition-colors duration-200"
                                    @click="mobileMenuOpen = false"
                                >
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
