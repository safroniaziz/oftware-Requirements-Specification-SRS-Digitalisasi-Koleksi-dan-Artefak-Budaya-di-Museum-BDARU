<template>
    <Head :title="`${props.event?.title || 'Event'} - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Indonesia'}`" />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                            ...
                            <p class="text-gray-600 text-sm mb-4">Jelajahi kegiatan lainnya dari museum digital Indonesia.</p>
                            <Link
                                href="/events"
