...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-sm z-50">
                    ...
                    <div class="flex items-center group">
                        <div class="flex-shrink-0 relative">
                            <div class="flex items-center space-x-4">
                                <!-- Modern Logo Icon -->
                                <div class="relative">
                                    <div class="w-14 h-14 bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-500 relative overflow-hidden">
                                        ...
                                        <div class="w-10 h-8 bg-white/95 rounded-lg relative">
                                            ...
                                            <!-- Windows -->
                                            <div class="absolute top-1 left-1 w-1 h-1 bg-emerald-400 rounded-sm"></div>
                                            <div class="absolute top-1 right-1 w-1 h-1 bg-emerald-400 rounded-sm"></div>
                                            <div class="absolute top-3 left-1 w-1 h-1 bg-teal-400 rounded-sm"></div>
                                            <div class="absolute top-3 right-1 w-1 h-1 bg-teal-400 rounded-sm"></div>
                                            <!-- Door -->
                                            <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-gray-700 rounded-t-sm"></div>
                                        </div>
                                        <!-- Glow Effect -->
                                        <div class="absolute inset-0 bg-gradient-to-br from-emerald-400/20 to-teal-500/20 rounded-2xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                                    </div>
                                    <!-- Floating Particles -->
                                    <div class="absolute -top-1 -right-1 w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                                    <div class="absolute -bottom-1 -left-1 w-1 h-1 bg-teal-400 rounded-full animate-ping delay-1000"></div>
                                </div>

                                <!-- Modern Typography -->
                                <div class="flex flex-col">
                                    <h1 class="text-3xl font-black bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300">
                                        BDARU
                                    </h1>
                                    <p class="text-xs text-gray-600 font-medium tracking-wider uppercase opacity-80 group-hover:opacity-100 transition-opacity duration-300">
        ...
        <div class="w-full mt-24 bg-white/95 backdrop-blur-lg border-b border-gray-200/50 shadow-sm">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Hero Section -->
        <section class="relative py-20 lg:py-32 bg-gradient-to-br from-white via-gray-50 to-emerald-50 overflow-hidden">
            ...
            <div class="absolute inset-0">
                <!-- Floating Orbs -->
                <div class="absolute top-0 left-0 w-72 h-72 bg-emerald-200/30 rounded-full blur-3xl animate-float-slow"></div>
                <div class="absolute bottom-0 right-0 w-96 h-96 bg-teal-200/30 rounded-full blur-3xl animate-float-medium"></div>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-cyan-200/30 rounded-full blur-3xl animate-float-fast"></div>

                <!-- Particle Effects -->
                <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-emerald-400 rounded-full animate-ping"></div>
                <div class="absolute top-3/4 right-1/4 w-1 h-1 bg-teal-400 rounded-full animate-ping delay-1000"></div>
                <div class="absolute bottom-1/4 left-3/4 w-1.5 h-1.5 bg-cyan-400 rounded-full animate-ping delay-2000"></div>

                <!-- Geometric Shapes -->
                <div class="absolute top-1/3 right-1/3 w-8 h-8 border border-emerald-300/30 rotate-45 animate-spin-slow"></div>
                <div class="absolute bottom-1/3 left-1/3 w-6 h-6 border border-teal-300/30 rotate-45 animate-spin-medium"></div>
            </div>
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        <!-- Badge -->
                        <div class="inline-flex items-center px-4 py-2 bg-emerald-100 text-emerald-800 rounded-full border border-emerald-200 mb-8 group hover:bg-emerald-200 transition-all duration-300 animate-fade-in-up">
                            <div class="w-2 h-2 bg-emerald-500 rounded-full mr-3 animate-pulse"></div>
                            <span class="text-sm font-medium">Museum Digital Balai Adat Rajo Penghulu</span>
                        </div>

                        <!-- Main Heading -->
                        <h1 class="text-4xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight animate-fade-in-up delay-200">
                            <span class="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent animate-gradient">
                                BDARU
                            </span>
                        </h1>

                        <!-- Subtitle -->
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-600 font-light max-w-2xl mx-auto lg:mx-0 animate-fade-in-up delay-400">
                            Jelajahi kekayaan budaya Indonesia melalui
                            <span class="font-semibold text-emerald-600">teknologi digital</span> yang inovatif.
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up delay-600">
                            <Link
                                href="/collections"
                                class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden animate-bounce-subtle"
                            >
                            ...
                            <Link
                                href="/about"
                                class="group relative px-8 py-4 border-2 border-emerald-200 text-emerald-700 font-bold rounded-xl backdrop-blur-md hover:bg-emerald-50 hover:border-emerald-300 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
                            >
                                <span class="relative z-10 flex items-center justify-center gap-3">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        ...
                        <div class="flex justify-center lg:justify-start gap-8 mt-12 animate-fade-in-up delay-800">
                            <div class="text-center group hover:scale-110 transition-transform duration-300">
                                <div class="text-2xl font-bold text-emerald-600 animate-count-up" data-target="150">0</div>
                                <div class="text-sm text-gray-600">Koleksi Digital</div>
                            </div>
                            <div class="text-center group hover:scale-110 transition-transform duration-300">
                                <div class="text-2xl font-bold text-teal-600 animate-count-up" data-target="25">0</div>
                                <div class="text-sm text-gray-600">Kategori</div>
                            </div>
                            <div class="text-center group hover:scale-110 transition-transform duration-300">
                                <div class="text-2xl font-bold text-cyan-600 animate-count-up" data-target="10">0</div>
                                <div class="text-sm text-gray-600">K Pengunjung</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-1/2 animate-fade-in-up delay-1000">
                        <div class="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl bg-gray-200 group animate-float-subtle">
                            <!-- Glow Effect -->
                            <div class="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
                                ...
                                >
                                    <div class="relative w-full h-full flex items-center justify-center">
                                        ...
                                        <div class="absolute bottom-6 left-6 right-6 z-10">
                                            <div class="bg-white/95 backdrop-blur-md rounded-xl p-4 border border-emerald-200 transform transition-all duration-500 hover:bg-white">
                                                <h3 class="text-gray-900 font-bold text-lg mb-1">{{ image.title }}</h3>
                                                <p class="text-gray-700 text-sm">{{ image.subtitle }}</p>
                                                <p class="text-gray-600 text-xs mt-2">{{ image.description }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
        ...
        <!-- Stats Section -->
        <section class="py-24 bg-gradient-to-br from-white via-gray-50 to-emerald-50 relative overflow-hidden">
            <!-- Professional Animated Background -->
            <div class="absolute inset-0">
                <!-- Geometric Patterns -->
                <div class="absolute top-10 left-10 w-32 h-32 border border-emerald-300/30 rotate-45 animate-spin-slow"></div>
                <div class="absolute top-20 right-20 w-24 h-24 border border-teal-300/30 rounded-full animate-pulse"></div>
                <div class="absolute bottom-20 left-1/4 w-16 h-16 bg-gradient-to-r from-emerald-200/20 to-teal-200/20 rounded-lg rotate-12 animate-float-subtle"></div>
                <div class="absolute bottom-10 right-1/3 w-20 h-20 border border-cyan-300/30 rotate-12 animate-spin-medium"></div>
                    ...
                    <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <defs>
                            <linearGradient id="flowGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                ...
                                <stop offset="50%" style="stop-color:#14b8a6;stop-opacity:0.2" />
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-20">
                    <div class="inline-flex items-center px-6 py-3 bg-emerald-100 text-emerald-800 rounded-full border border-emerald-200 mb-8 group hover:bg-emerald-200 transition-all duration-300">
                        <div class="w-2 h-2 bg-emerald-500 rounded-full mr-3 animate-pulse"></div>
                        <span class="text-sm font-medium">Pencapaian Museum Digital</span>
                    </div>
                    ...
                    <p class="text-xl md:text-2xl text-gray-600 font-light max-w-4xl mx-auto leading-relaxed">
                        ...
                        <span class="font-semibold text-emerald-600">melalui teknologi modern</span>
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    <!-- Koleksi Digital -->
                    <div class="group relative bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-emerald-200/50 hover:bg-white hover:border-emerald-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-black mb-2 text-emerald-600 animate-count-up" data-target="150">0</div>
                                <div class="text-gray-800 font-bold text-lg mb-2">Koleksi Digital</div>
                    ...
                    <!-- Kategori Budaya -->
                    <div class="group relative bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-teal-200/50 hover:bg-white hover:border-teal-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-black mb-2 text-teal-600 animate-count-up" data-target="25">0</div>
                                <div class="text-gray-800 font-bold text-lg mb-2">Kategori Budaya</div>
                    ...
                    <!-- Kunjungan -->
                    <div class="group relative bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-cyan-200/50 hover:bg-white hover:border-cyan-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
                                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-black mb-2 text-cyan-600 animate-count-up" data-target="10">0</div>
                                <div class="text-gray-800 font-bold text-lg mb-2">K Kunjungan</div>
                    ...
                    <div class="group relative bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-emerald-200/50 hover:bg-white hover:border-emerald-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-black mb-2 text-emerald-600 animate-count-up" data-target="50">0</div>
                                <div class="text-gray-800 font-bold text-lg mb-2">Koleksi Unggulan</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Progress Bar -->
                    <div class="data-card stats-card bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-emerald-200/50 shadow-lg">
                    ...
                    <div class="data-card stats-card bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-emerald-200/50 shadow-lg">
                        ...
                        <div class="space-y-4">
                            <div v-for="activity in recentActivities" :key="activity.type" class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-600 text-sm">{{ activity.message }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="data-card stats-card bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-emerald-200/50 shadow-lg">
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 text-sm">Rata-rata Kunjungan</span>
                                <span class="text-gray-800 font-bold">{{ quickStats.avgVisits }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 text-sm">Koleksi Terpopuler</span>
                                <span class="text-gray-800 font-bold">{{ quickStats.popularCollection }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-600 text-sm">Rating Pengguna</span>
                                <span class="text-gray-800 font-bold">{{ quickStats.userRating }}</span>
                            </div>
                        </div>
                    </div>
                </div>
