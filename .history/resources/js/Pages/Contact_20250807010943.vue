                            ...
                            <div class="bg-white rounded-2xl p-4 lg:p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
                                <div class="flex items-start space-x-3 lg:space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-3">
                                            <a :href="`https://maps.google.com/?q=${props.museumSettings?.latitude || -3.7956},${props.museumSettings?.longitude || 102.2592}`" target="_blank" class="inline-flex items-center text-emerald-600 hover:text-emerald-700 font-semibold text-sm transition-colors">
