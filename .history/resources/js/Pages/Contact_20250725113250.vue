...
const initMap = () => {
    ...
    nextTick(() => {
        ...
        const museumIcon = L.divIcon({
            ...
            html: `
                <div class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
        ...
        marker.bindPopup(`
            <div class="text-center">
                <h3 class="font-bold text-gray-900 mb-1">${props.museumSettings?.museum_name || 'Museum Digital Balai Adat Rajo Penghulu BDARU'}</h3>
                <p class="text-sm text-gray-600 mb-2">${props.museumSettings?.address || 'Jl. Museum Nasional No. 1'}</p>
                <p class="text-xs text-gray-500">${props.museumSettings?.city || 'Jakarta Pusat'}, ${props.museumSettings?.country || 'Indonesia'}</p>
            </div>
        `);
