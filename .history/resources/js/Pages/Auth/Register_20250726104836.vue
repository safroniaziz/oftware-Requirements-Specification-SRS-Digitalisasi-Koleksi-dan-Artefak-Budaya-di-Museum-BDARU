        ...
        <div class="relative z-10 min-h-screen flex items-center justify-center p-6">
            <div class="w-full max-w-sm">
                ...
                <div class="text-center mb-12" :class="{ 'animate-fade-in-up': isLoaded }">
                    ...
                    <p class="text-gray-600 text-sm">Bergabung dengan BDARU Museum Digital</p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8" :class="{ 'animate-fade-in-up': isLoaded }">
                    <form @submit.prevent="submit" class="space-y-6">
                        <!-- Name Field -->
                        <div>
                            <InputLabel for="name" value="Nama Lengkap" class="text-gray-700 font-medium mb-2 block text-sm" />
                            <div class="relative">
                                <TextInput
                                    id="name"
                                    type="text"
                        ...
                        <div>
                            <InputLabel for="password_confirmation" value="Konfirmasi Password" class="text-gray-700 font-medium mb-2 block text-sm" />
                            <div class="relative">
                                <TextInput
