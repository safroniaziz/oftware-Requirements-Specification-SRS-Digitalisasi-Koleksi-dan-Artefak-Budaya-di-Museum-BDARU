            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-200">
                        ...
                        <img
                            :src="event.image || 'https://via.placeholder.com/800x600/4F46E5/FFFFFF?text=BDARU+Event'"
                            :alt="event.title"
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left">
                    ...
                    <nav class="flex items-center justify-center lg:justify-start space-x-2 mb-6">
                        <Link href="/" class="text-emerald-300 hover:text-white transition-colors">Home</Link>
                        <span class="text-emerald-300">/</span>
                                                    <Link href="/events" class="text-emerald-300 hover:text-white transition-colors">Agenda Kegiatan</Link>
                        <span class="text-emerald-300">/</span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm font-semibold text-gray-900">info@bdaru-museum.id</div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm font-semibold text-gray-900">+62 21 1234 5678</div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm font-semibold text-gray-900">Jl. Museum No. 123, Jakarta</div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            >
                                <Link :href="`/events/${event.id}`">
                                    <div class="relative h-48 overflow-hidden">
                                        <img
                                            :src="event.image || 'https://via.placeholder.com/400/300/4F46E5/FFFFFF?text=Event'"
                                            :alt="event.title"
                                ...
                                <Link :href="`/events/${event.id}`" class="block">
                                    <div class="flex items-start space-x-3">
                                        <div class="relative w-16 h-12 rounded-lg flex-shrink-0 bg-gray-200 overflow-hidden">
                                            ...
                                            <img
                                                :src="event.image || 'https://via.placeholder.com/80/60/4F46E5/FFFFFF?text=Event'"
                                                :alt="event.title"
...
function handleImageError(event) {
    event.target.src = 'https://via.placeholder.com/1200/600/4F46E5/FFFFFF?text=BDARU+Event';
}
