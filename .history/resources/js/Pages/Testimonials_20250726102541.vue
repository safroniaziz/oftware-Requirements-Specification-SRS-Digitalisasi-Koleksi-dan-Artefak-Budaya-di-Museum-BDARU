...
const testimonialsData = computed(() => {
    console.log('Props testimonials:', props.testimonials);
    console.log('Testimonials data:', props.testimonials?.data);
    console.log('Next page URL:', props.testimonials?.next_page_url);
    console.log('Prev page URL:', props.testimonials?.prev_page_url);
    console.log('Current page:', props.testimonials?.current_page);
    console.log('Last page:', props.testimonials?.last_page);
    console.log('Total:', props.testimonials?.total);
        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div v-if="props.testimonials && props.testimonials.data && props.testimonials.data.length > 0" class="mt-8">
                ...
                <div class="mb-4 p-4 bg-gray-100 rounded-lg text-xs">
                    <p>Debug: next_page_url = {{ props.testimonials.next_page_url }}</p>
                    <p>Debug: prev_page_url = {{ props.testimonials.prev_page_url }}</p>
                    <p>Debug: current_page = {{ props.testimonials.current_page }}</p>
                    <p>Debug: last_page = {{ props.testimonials.last_page }}</p>
                    <p>Debug: total = {{ props.testimonials.total }}</p>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <Link
                            v-if="props.testimonials.prev_page_url"
                            :href="props.testimonials.prev_page_url"
                        ...
                        <Link
                            v-if="props.testimonials.next_page_url"
