<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="py-16 bg-gray-50">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div class="text-gray-600">
                        Menampilkan <span class="font-semibold text-emerald-600">{{ filteredNews.length }}</span> dari <span class="font-semibold">{{ activeTab === 'featured' ? (props.featuredNews || []).length : (props.news?.total || 0) }}</span> {{ activeTab === 'featured' ? 'berita unggulan' : 'berita' }}
                    </div>
            ...
            <div class="flex items-center justify-center mb-8">
                <div class="flex items-center bg-gray-100 rounded-2xl p-2 shadow-inner">
                    <button
                        ...
                        :class="[
                            'px-8 py-4 rounded-xl font-bold text-sm transition-all duration-300 flex items-center space-x-2',
                            activeTab === 'featured'
            ...
            <!-- Berita Unggulan Tab -->
            <div v-if="activeTab === 'featured' && viewMode === 'grid'" class="space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <!-- Featured Badge -->
                            <div v-if="article.is_featured" class="absolute top-4 left-4 z-20">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center space-x-1">
                                    ...
                                    <span class="text-xs text-gray-600 font-medium">{{ formatNumber(article.view_count || 0) }} kali dilihat</span>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 p-6">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <div class="flex items-center space-x-1">
                                        ...
                                        <span class="text-lg font-semibold text-gray-700">{{ formatNumber(article.view_count || 0) }} kali dilihat</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-xs text-gray-500">{{ formatNumber(article.view_count || 0) }} kali dilihat</span>
                                    </div>
                                    <Link
                                        :href="`/news/${article.id}`"
                                        class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white text-sm font-semibold rounded-lg hover:bg-emerald-700 transition-colors duration-200 group-hover:shadow-lg"
