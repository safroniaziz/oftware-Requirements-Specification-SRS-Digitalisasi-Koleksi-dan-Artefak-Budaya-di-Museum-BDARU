                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <div v-if="event.image_url && imageLoadingStates[event.id] !== false" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse rounded-t-2xl">
...
console.log('Events data received:', props.events);
if (props.events.data && props.events.data.length > 0) {
    console.log('First event:', props.events.data[0]);
    console.log('First event image_url:', props.events.data[0].image_url);
}
