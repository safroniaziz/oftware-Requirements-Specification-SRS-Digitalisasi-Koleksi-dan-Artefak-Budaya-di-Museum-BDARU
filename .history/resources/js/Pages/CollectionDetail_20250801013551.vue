        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="min-h-[400px]">
                ...
                <div v-if="activeTab === 'gallery'" class="space-y-8">
                    <!-- Test Box to confirm tab is working -->
                    <div class="bg-red-500 text-white p-8 rounded-lg">
                        <h3 class="text-2xl font-bold mb-4">GALERI TAB BERFUNGSI!</h3>
                        <p>Active Tab: {{ activeTab }}</p>
                        <p>Gallery Images Count: {{ collection.gallery_images ? collection.gallery_images.length : 'NULL' }}</p>
