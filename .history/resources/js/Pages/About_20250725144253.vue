            ...
            <div class="text-center mb-12">
                ...
                >
                    <div class="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 shadow-lg">
                        <img
                            :src="`https://api.dicebear.com/7.x/avataaars/svg?seed=${member.name.replace(/\s+/g, '')}&backgroundColor=10b981&mouth=smile&style=circle&top=shortHairShortFlat&accessories=round&clothing=shirtCrewNeck&clothingColor=blue`"
                            :alt="member.name"
