<template>
    <Head :title="`Berita - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Balai Adat Rajo Penghulu'}`" />
    ...
    <div class="min-h-screen bg-gray-50">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0">
                            Dapatkan informasi terbaru seputar Museum Digital Balai Adat Rajo Penghulu BDARU. Dari pameran, koleksi baru, hingga kegiatan menarik yang memperkaya pengetahuan budaya Anda.
                        </p>

                        <!-- Enhanced CTA Buttons -->
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#news" class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
                                ...
                                <div class="absolute inset-4 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <div class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white p-4 rounded-t-2xl">
                                        <div class="text-center">
                                            <h3 class="text-xl font-bold">BDARU News</h3>
                                    ...
                                    <div class="p-4 space-y-3">
                                        <div class="border-b border-gray-200 pb-2">
                                            <h4 class="text-sm font-bold text-gray-800">Pameran Seni Digital Terbaru</h4>
                                            <p class="text-xs text-gray-600">15 Agustus 2024</p>
                                        </div>
                                        <div class="border-b border-gray-200 pb-2">
                                            <h4 class="text-sm font-bold text-gray-800">Koleksi Baru: Artefak Kuno</h4>
                                            <p class="text-xs text-gray-600">22 Agustus 2024</p>
                                        </div>
                                        <div>
                                            <h4 class="text-sm font-bold text-gray-800">Workshop Budaya Tradisional</h4>
                                            <p class="text-xs text-gray-600">29 Agustus 2024</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="py-8 lg:py-12 bg-white border-b border-gray-200">
            <div class="w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Search Bar -->
                <div class="mb-6 lg:mb-8">
                    <div class="relative max-w-2xl mx-auto">
                        ...
                        <input
                            ...
                            class="w-full pl-12 pr-4 py-3 lg:py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 text-sm lg:text-base"
                            @keyup.enter="handleFilter"
                        >
                        <button
                            @click="handleFilter"
                            class="absolute inset-y-0 right-0 px-4 flex items-center bg-emerald-600 text-white rounded-r-xl hover:bg-emerald-700 transition-colors duration-300"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                            </svg>
                    ...
                    <div class="flex justify-center">
                        <div class="flex bg-gray-100 rounded-2xl p-1 shadow-inner">
                            <button
                                ...
                                :class="[
                                    'flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm lg:text-base transition-all duration-300',
                                    activeTab === 'recent'
                            ...
                            >
                                ...
                                <span class="bg-emerald-100 text-emerald-600 px-2 py-0.5 rounded-full text-xs font-semibold">{{ props.news?.data?.length || 0 }}</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span class="bg-emerald-100 text-emerald-600 px-2 py-0.5 rounded-full text-xs font-semibold">{{ props.featuredNews?.length || 0 }}</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-6">
                    ...
                    <div class="w-full lg:flex-1 lg:min-w-0">
                        <div class="flex items-center gap-2 overflow-x-auto pb-2 lg:pb-0 scrollbar-hide max-w-full">
                            <button
                                v-for="category in categoriesWithCounts"
                                :key="category.id"
                                @click="selectedCategory = category.id; handleFilter()"
                                :class="[
                                    'flex items-center gap-2 px-3 py-2 rounded-xl font-semibold text-sm whitespace-nowrap transition-all duration-300 flex-shrink-0',
                            ...
                            >
                                ...
                                <span class="sm:hidden">{{ category.label.split(' ')[0] }}</span>
                    ...
                    <!-- Controls -->
                    <div class="flex items-center gap-2 lg:gap-4 flex-shrink-0 lg:ml-4">
                        <!-- Sort Dropdown -->
                        <div class="relative">
                            <select
                                v-model="sortBy"
                                @change="handleFilter"
                                class="appearance-none px-3 py-2 bg-gray-100 text-gray-700 rounded-xl font-semibold text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all duration-300"
                            >
                        ...
                        <button
                            @click="clearFilters"
                            class="px-3 py-2 text-gray-600 hover:text-emerald-600 font-semibold text-sm transition-colors duration-300"
                        >
                            Reset
                        </button>
                    </div>
        ...
        <section class="py-8 lg:py-16 bg-gray-50">
            <div class="w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Results Info -->
                <div class="flex flex-col sm:flex-row items-center justify-between mb-6 lg:mb-8 gap-2">
                    <div class="text-gray-600 text-sm lg:text-base">
                        Menampilkan <span class="font-semibold text-emerald-600">{{ filteredNews.length }}</span> dari <span class="font-semibold">{{ activeTab === 'featured' ? (props.featuredNews || []).length : (props.news?.data || []).length }}</span> berita
                    </div>
                ...
                <!-- Grid View -->
                <div v-if="viewMode === 'grid'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    <div
                    ...
                    >
                        ...
                        <div class="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                            <!-- Loading State - Only show when image exists and is loading -->
                            <div v-if="news.image_url && imageLoadingStates[news.id] !== false" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse rounded-t-2xl">
                            ...
                            <img
                                ...
                                :class="{ 'opacity-0': imageLoadingStates[news.id] !== false, 'opacity-100': imageLoadingStates[news.id] === false }"
                    ...
                    >
                        <div class="flex flex-col lg:flex-row">
                            ...
                            <div class="relative lg:w-80 h-64 lg:h-auto overflow-hidden">
                                <!-- Loading State -->
                                <div v-if="imageLoadingStates[news.id] !== false" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse">
                                    <div class="w-full h-full flex items-center justify-center">
                                        <div class="text-center">
                                            <div class="w-8 h-8 bg-gray-400 rounded-full animate-spin mx-auto mb-2"></div>
                                ...
                                >
                                    <div class="text-center">
                                        ...
                                        <p class="text-emerald-600 text-xs font-medium">Gambar belum tersedia</p>
                                    </div>
                                </div>
                            ...
                            <div class="flex-1 p-6">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        ...
                                        <p class="text-lg text-gray-600 mb-3">{{ news.excerpt?.substring(0, 100) }}...</p>
                                    </div>
                                    <div class="flex items-center space-x-1">
                                        ...
                                        <span class="text-lg font-semibold text-gray-700">{{ (news.view_count || 0).toLocaleString() }} kali dilihat</span>
                                    </div>
                                </div>

                                <p class="text-gray-600 leading-relaxed mb-4">{{ news.excerpt?.substring(0, 200) }}...</p>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-sm text-gray-600">{{ new Date(news.created_at).toLocaleDateString('id-ID', { year: 'numeric', month: 'long', day: 'numeric' }) }}</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <svg class="w-4 h-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                                        </svg>
                                        <span class="text-sm text-gray-600">{{ news.news_category?.name || 'Berita' }}</span>
                                    </div>
                                </div>
                ...
                <!-- Pagination -->
                <div v-if="news.data.length > 0" class="mt-8">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-500">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <Link
                                ...
                                class="px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors duration-200"
                            >
                                Selanjutnya
                            </Link>
                        </div>
                ...
                <div v-if="filteredNews.length === 0" class="text-center py-16">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">
                        {{ activeTab === 'featured' ? 'Tidak ada berita unggulan' : 'Tidak ada berita ditemukan' }}
                    </h3>
                    <p class="text-gray-600 mb-6">
                        {{ activeTab === 'featured' ? 'Belum ada berita yang diunggulkan saat ini.' : 'Coba ubah filter atau kata kunci pencarian Anda.' }}
                    </p>
                    <button
                        @click="clearFilters"
    ...
    <footer class="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
        <div class="w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
...
const activeTab = ref('recent'); // Default to recent news
const imageLoadingStates = ref({});
const loading = ref(false);

// Simple placeholder image using data URI
const placeholderImage = 'data:image/svg+xml;base64,';

function handleSearch() {
    // For client-side filtering, we don't need to navigate
    // The computed properties will handle the filtering automatically
    // Only navigate if we're not using client-side filtering
    if (activeTab.value === 'recent') {
        handleFilter();
    }
    // For featured tab, filtering is done client-side
}
...
function clearFilters() {
    ...
    // Only navigate if we're on recent tab
    if (activeTab.value === 'recent') {
        router.get('/news', {}, {
            preserveState: true,
            preserveScroll: true,
...
// Alternative placeholder images for better reliability
const fallbackImages = [
    '/storage/news/category-museum.jpg',
    '/storage/news/category-cultural.jpg',
    '/storage/news/category-heritage.jpg',
    '/storage/news/category-art.jpg',
    '/storage/news/category-workshop.jpg',
    '/storage/news/category-education.jpg',
    '/storage/news/category-digital.jpg',
    '/storage/news/category-festival.jpg'
];

// Computed properties
const categoriesWithCounts = computed(() => {
    // Get the appropriate data based on active tab
    const currentData = activeTab.value === 'featured'
        ? (props.featuredNews || [])
        : (props.news?.data || []);
    ...
    const allCategory = {
        id: 'all',
        icon: '📰',
        label: activeTab.value === 'featured' ? 'Semua Featured' : 'Semua Berita',
        count: currentData?.length || 0
    };

    // Ensure newsCategories is an array
    const newsCategories = Array.isArray(props.newsCategories) ? props.newsCategories : [];

    const categoryList = newsCategories.map(category => {
        // Count news in current tab data for this category
        const categoryCount = currentData.filter(article =>
            article.news_category?.slug === (category.slug || category.id)
        ).length;
...
const filteredNews = computed(() => {
    // Get the appropriate data based on active tab
    let filtered = activeTab.value === 'featured'
        ? (props.featuredNews || [])
        : (props.news?.data || []);

    // Filter by category
    if (selectedCategory.value !== 'all') {
        filtered = filtered.filter(article => article.news_category?.slug === selectedCategory.value);
    }
...
function handleImageError(event) {
    ...
    placeholder.className = 'w-full h-full bg-gradient-to-br from-emerald-100 to-teal-100 flex items-center justify-center';
...
function handleImageLoad(event) {
    imageLoadingStates.value[event.target.dataset.articleId] = false;
}

function startImageLoading(articleId) {
    imageLoadingStates.value[articleId] = true;
}
...
// Watch for tab changes and reset filters
watch(activeTab, () => {
    ...
    // If switching to featured tab, we don't need to navigate
    // The computed properties will handle the filtering automatically
});
