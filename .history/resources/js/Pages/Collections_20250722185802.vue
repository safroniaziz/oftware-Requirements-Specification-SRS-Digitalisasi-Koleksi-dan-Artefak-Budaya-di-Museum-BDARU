...
const collections = ref([
    {
        id: 1,
        title: 'Lukisan Klasik Indonesia',
        subtitle: 'Masterpiece Seni Rupa Tradisional',
        ...
        category: 'seni-rupa',
        categoryLabel: 'Seni Rupa',
        image: 'https://picsum.photos/800/600?random=1',
        year: '1800-1950',
        artist: 'Berbagai Seniman',
        location: 'Jawa Tengah',
        material: 'Kanvas & Cat Minyak',
        dimensions: '100 x 150 cm',
        status: 'Dipamerkan',
        views: 2540,
        likes: 189,
        rating: 4.9,
        tags: ['Klasik', 'Masterpiece', 'Tradisional'],
        featured: true,
        createdAt: '2024-01-15'
    },
    {
        id: 2,
        title: 'Artefak Kerajaan Majapahit',
        ...
        category: 'arkeologi',
        categoryLabel: 'Arkeologi',
        image: 'https://picsum.photos/800/600?random=2',
        year: '1293-1527',
        artist: 'Pembuat Tidak Diketahui',
        location: 'Jawa Timur',
        material: 'Batu & Logam',
        dimensions: 'Varies',
        status: 'Konservasi',
        ...
        likes: 156,
        rating: 4.8,
        tags: ['Kerajaan', 'Langka', 'Sejarah'],
        featured: true,
        createdAt: '2024-01-10'
    },
    {
        id: 3,
        title: 'Batik Parang Kraton',
        subtitle: 'Warisan Tekstil Keraton',
        ...
        year: '1700-1900',
        artist: 'Pengrajin Keraton',
        location: 'Yogyakarta',
        material: 'Sutra & Malam',
        dimensions: '250 x 110 cm',
        status: 'Dipamerkan',
        views: 3200,
        likes: 245,
        rating: 4.9,
        tags: ['Keraton', 'UNESCO', 'Handmade'],
        featured: true,
    ...
    },
    {
        ...
        category: 'wayang',
        categoryLabel: 'Wayang',
        image: 'https://picsum.photos/800/600?random=4',
        year: '1600-1900',
        artist: 'Dalang & Pengrajin',
        location: 'Jawa Tengah',
        material: 'Kulit Kerbau & Kayu',
        dimensions: '50 x 25 cm',
        status: 'Dipamerkan',
        views: 2100,
        likes: 178,
        rating: 4.7,
        tags: ['Pertunjukan', 'Epos', 'Tradisional'],
        featured: false,
