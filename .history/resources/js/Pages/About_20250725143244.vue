    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Debug info -->
                <div class="col-span-full bg-red-100 p-4 mb-4 rounded">
                    <p class="text-red-800">Debug: Team Members Count: {{ props.teamMembers?.length || 0 }}</p>
                    <p class="text-red-800">Debug: First Member: {{ JSON.stringify(props.teamMembers?.[0]) }}</p>
                </div>
