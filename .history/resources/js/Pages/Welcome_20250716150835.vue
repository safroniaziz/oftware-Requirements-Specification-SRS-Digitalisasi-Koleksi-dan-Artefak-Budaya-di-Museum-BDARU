...
// Sample museum images - you can replace with actual images
const heroImages = [
    {
        id: 1,
    ...
    {
        id: 4,
        src: 'https://images.unsplash.com/photo-1518998053901-5348d3961a04?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
                ...
                <div class="min-h-screen flex items-center">
                    ...
                    <div class="w-full lg:w-1/2 pl-0 lg:pl-12 mt-12 lg:mt-0">
                        <div class="relative h-96 lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                >
                                    ...
                                    <div class="absolute bottom-6 left-6 right-6">
                                        <div class="bg-white/20 backdrop-blur-md rounded-2xl p-4 border border-white/30">
                                            ...
                                            <p class="text-white/90 text-sm">Koleksi Unggulan Museum BDARU</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button
                                @click="prevSlide"
                                class="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300 group"
                            >
                            ...
                            <button
                                @click="nextSlide"
                                class="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300 group"
                            >
                                <svg class="w-6 h-6 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                                <button
                                    ...
                                    :class="index === currentSlide ? 'bg-yellow-400 scale-125' : 'bg-white/50 hover:bg-white/70'"
                                ></button>
                            </div>
                        </div>
                    </div>
