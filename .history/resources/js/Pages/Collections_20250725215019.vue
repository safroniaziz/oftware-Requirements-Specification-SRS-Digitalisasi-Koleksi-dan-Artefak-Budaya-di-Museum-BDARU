    ...
    <div class="fixed top-0 left-0 right-0 bg-white/98 backdrop-blur-xl border-b border-gray-200/50 shadow-lg z-50">
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <!-- Mobile Hamburger Menu Button - DEBUG VERSION -->
                <div style="
                ...
                ">
                    <button
                        ...
                        "
                    >
                        <span style="color: white !important; font-size: 12px !important;">MENU</span>
                        <svg
                            class="h-6 w-6 ml-2"
                            ...
                            fill="none"
                            viewBox="0 0 24 24"
                            style="color: white !important; display: block !important;"
                        >
