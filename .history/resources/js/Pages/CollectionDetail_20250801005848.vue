...
di
                        ...
                        <div class="bg-yellow-100 p-4 rounded-lg mb-6">
                            <p class="text-sm text-gray-700">
                                ...
                                Gallery Images Count: {{ collection.gallery_images ? collection.gallery_images.length : 0 }}<br>
                                Gallery Images: {{ JSON.stringify(collection.gallery_images) }}<br>
                                Collection Keys: {{ Object.keys(collection) }}
                            </p>
                        </div>
