...
<template>
        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center group">
                    <!-- Logo code tetap di sini -->
                    <img src="/logo.png" alt="Logo" class="h-10 w-auto mr-2" />
                    <span class="font-bold text-lg text-emerald-700">Museum</span>
                </div>

                <!-- Desktop Auth Buttons -->
                <div class="hidden lg:flex items-center space-x-4">
                    <Link v-if="canLogin" href="/login" class="px-4 py-2 rounded-lg font-semibold text-emerald-700 hover:bg-emerald-50 transition">Login</Link>
                    <Link v-if="canRegister" href="/register" class="px-4 py-2 rounded-lg font-semibold text-white bg-emerald-600 hover:bg-emerald-700 transition">Register</Link>
                </div>
    ...
    <div v-if="mobileMenuOpen" class="fixed inset-0 z-[60] flex lg:hidden">
        ...
        <!-- Slide-in Menu -->
        <div class="relative bg-white w-4/5 max-w-xs h-full shadow-xl p-6 overflow-y-auto">
            <div class="flex flex-col space-y-4">
                <!-- Navigation Links -->
                <Link href="/" class="group flex items-center px-4 py-3 text-gray-700 font-bold rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-300" @click="mobileMenuOpen = false">
                ...
                <Link href="/collections" class="group flex items-center px-4 py-3 text-emerald-600 font-bold rounded-lg bg-emerald-50 transition-all duration-300" @click="mobileMenuOpen = false">
                    <span class="relative z-10 flex items-center space-x-3">
                        <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <Link href="/news" class="group flex items-center px-4 py-3 text-gray-700 font-bold rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-300" @click="mobileMenuOpen = false">
                    <span class="relative z-10 flex items-center space-x-3">
                        <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <Link href="/events" class="group flex items-center px-4 py-3 text-gray-700 font-bold rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-300" @click="mobileMenuOpen = false">
                    <span class="relative z-10 flex items-center space-x-3">
                        <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <Link href="/contact" class="group flex items-center px-4 py-3 text-gray-700 font-bold rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-300" @click="mobileMenuOpen = false">
                    <span class="relative z-10 flex items-center space-x-3">
                        <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <Link href="/about" class="group flex items-center px-4 py-3 text-gray-700 font-bold rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-300" @click="mobileMenuOpen = false">
                    <span class="relative z-10 flex items-center space-x-3">
                        <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <Link href="/testimonials" class="group flex items-center px-4 py-3 text-gray-700 font-bold rounded-lg hover:bg-emerald-50 hover:text-emerald-600 transition-all duration-300" @click="mobileMenuOpen = false">
                    <span class="relative z-10 flex items-center space-x-3">
                        <svg class="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                ...
                <div class="flex flex-col space-y-2 mt-4">
                    <Link v-if="canLogin" href="/login" class="w-full px-4 py-2 rounded-lg font-semibold text-emerald-700 border border-emerald-600 hover:bg-emerald-50 transition">Login</Link>
                    <Link v-if="canRegister" href="/register" class="w-full px-4 py-2 rounded-lg font-semibold text-white bg-emerald-600 hover:bg-emerald-700 transition">Register</Link>
                </div>
            </div>
        </div>
    </div>
