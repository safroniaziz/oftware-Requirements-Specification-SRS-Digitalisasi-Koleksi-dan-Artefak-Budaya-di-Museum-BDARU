...
const updateFormData = () => {
    ...
    console.log('Form data updated:', form.data());
};

// Computed property for button disabled state
const isButtonDisabled = computed(() => {
    const disabled = !form.content || form.content.length < 10 || form.rating === 0;
    console.log('Button disabled:', disabled, 'content:', form.content, 'length:', form.content?.length, 'rating:', form.rating);
    return disabled;
});
