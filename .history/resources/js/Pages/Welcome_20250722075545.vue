                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-300 text-sm">+15 koleksi baru ditambahkan</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>
                                <span class="text-gray-300 text-sm">1,250 pengunjung hari ini</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-purple-400 rounded-full animate-pulse"></div>
                                <span class="text-gray-300 text-sm">3 koleksi unggulan diperbarui</span>
                            </div>
                        </div>
                    </div>
