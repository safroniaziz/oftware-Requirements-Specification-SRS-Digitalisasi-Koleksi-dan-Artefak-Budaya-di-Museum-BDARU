                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 mb-1">Jl. Museum Nasional No. 1</p>
                                    <p class="text-gray-600 mb-1">Jakarta Pusat, 10110</p>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        <div>
                                            ...
                                            <a href="mailto:info@bdaru-museum.id" class="text-teal-600 hover:text-teal-700 font-semibold transition-colors">info@bdaru-museum.id</a>
                                        </div>
                                        <div>
                                            <p class="text-sm text-gray-500 mb-1">Dukungan Teknis</p>
                                            <a href="mailto:support@bdaru-museum.id" class="text-teal-600 hover:text-teal-700 font-semibold transition-colors">support@bdaru-museum.id</a>
                                        </div>
                                        <div>
                                            <p class="text-sm text-gray-500 mb-1">Kerjasama</p>
                                            <a href="mailto:partnership@bdaru-museum.id" class="text-teal-600 hover:text-teal-700 font-semibold transition-colors">partnership@bdaru-museum.id</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gradient-to-br from-emerald-500 to-teal-500 rounded-2xl p-6 text-white" data-aos="fade-up" data-aos-delay="300">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold">{{ collections?.total || 0 }}+</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl p-6 text-white" data-aos="fade-up" data-aos-delay="400">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold">{{ news?.total || 0 }}+</p>
                                </div>
                                <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
                        ...
                        <div class="bg-gradient-to-br from-cyan-500 to-blue-500 rounded-2xl p-6 text-white" data-aos="fade-up" data-aos-delay="500">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold">{{ events?.total || 0 }}+</p>
                                </div>
                                <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        ...
                        <div class="bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl p-6 text-white" data-aos="fade-up" data-aos-delay="600">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold">{{ testimonials?.total || 0 }}+</p>
                                </div>
                                <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
...
const formProgress = computed(() => {
    let progress = 0;
    if (form.value.name.trim()) progress += 25;
    if (form.value.email.trim()) progress += 25;
    if (form.value.subject.trim()) progress += 25;
    if (form.value.message.trim()) progress += 25;
    return progress;
});
...
const submitForm = async () => {
    if (formProgress.value < 100) return;
...
watch(form, (newForm) => {
    ...
    if (emailInput && newForm.email) {
        const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (emailRegex.test(newForm.email)) {
