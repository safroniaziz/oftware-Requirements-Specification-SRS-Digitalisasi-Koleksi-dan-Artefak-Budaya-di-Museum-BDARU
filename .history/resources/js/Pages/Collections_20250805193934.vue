...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full border-2 border-emerald-200 mb-6 group hover:bg-gradient-to-r hover:from-emerald-200 hover:to-teal-200 transition-all duration-300 shadow-lg">
                            ...
                            <span class="text-sm font-bold">🏛️ Koleksi Budaya</span>
                        </div>
                        ...
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0">
                            Jelajahi koleksi budaya Indonesia yang kaya dan beragam. Dari artefak kuno hingga karya seni modern, setiap koleksi memiliki cerita unik yang menunggu untuk ditemukan.
                        </p>

                        <!-- Enhanced CTA Buttons -->
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#collections" class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
                    ...
                    <div class="w-full lg:w-1/2 flex justify-center lg:justify-end">
                        <div class="relative w-full max-w-lg">
                            ...
                            <div class="relative w-full h-96 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-transform duration-500">
                                <!-- Enhanced Museum Display Design -->
                                <div class="absolute inset-4 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <div class="p-4 space-y-3">
                                        <div class="flex items-center space-x-3 p-2 bg-emerald-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Artefak Kuno</p>
                                                <p class="text-xs text-gray-600">Zaman Kerajaan</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3 p-2 bg-teal-50 rounded-lg">
                                            <div class="w-3 h-3 bg-teal-500 rounded-full"></div>
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Seni Tradisional</p>
                                                <p class="text-xs text-gray-600">Karya Budaya</p>
                                            </div>
                                        </div>
            ...
            <div class="w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between mb-6 lg:mb-8 gap-2">
                    <div class="text-gray-600 text-sm lg:text-base">
                        Menampilkan <span class="font-semibold text-emerald-600">{{ filteredCollections.length }}</span> dari <span class="font-semibold">{{ collectionsData.length }}</span> koleksi
                    </div>
                ...
                <div v-if="viewMode === 'grid'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    >
                        ...
                        <div class="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                            ...
                            <div v-if="collection.image_url && imageLoadingStates[collection.id] !== false" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse rounded-t-2xl">
                            ...
                            <div class="flex-1 p-6">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4 text-sm text-gray-500">
                                        ...
                                        <!-- QR Code Button -->
                                        <div v-if="collection.latest_qr_code" class="flex items-center space-x-1">
                                            <button
                                                @click="showQrCode(collection)"
                                                class="inline-flex items-center px-3 py-1 bg-blue-50 text-blue-600 text-xs font-medium rounded-lg hover:bg-blue-100 transition-colors duration-200"
                                            >
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V6a1 1 0 00-1-1H5a1 1 0 00-1 1v1a1 1 0 001 1zm12 0h2a1 1 0 001-1V6a1 1 0 00-1-1h-2a1 1 0 00-1 1v1a1 1 0 001 1zM5 20h2a1 1 0 001-1v-1a1 1 0 00-1-1H5a1 1 0 00-1 1v1a1 1 0 001 1z"></path>
                                                </svg>
                ...
                <!-- Pagination -->
                <div v-if="props.collections && props.collections.data && props.collections.data.length > 0" class="mt-8">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-500">
                            Menampilkan {{ props.collections.from || 1 }} - {{ props.collections.to || props.collections.data.length }} dari {{ props.collections.total || props.collections.data.length }} koleksi
                        </div>
                        <div class="flex items-center space-x-2">
                            <Link
                                v-if="props.collections.prev_page_url"
                                :href="props.collections.prev_page_url"
                            ...
                            <Link
                                v-if="props.collections.next_page_url"
                                :href="props.collections.next_page_url"
        ...
        <section class="py-20 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
            <div class="w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
