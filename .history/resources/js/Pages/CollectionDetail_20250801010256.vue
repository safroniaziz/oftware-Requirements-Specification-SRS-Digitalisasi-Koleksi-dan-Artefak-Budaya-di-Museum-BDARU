    ...
    <section class="py-16 bg-white">
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center border-b border-gray-200 mb-12">
                ...
                <button
                    @click="() => { activeTab = 'gallery'; console.log('Gallery tab clicked, activeTab:', activeTab); }"
                    :class="[
                        'px-6 py-3 font-semibold text-sm border-b-2 transition-all duration-300',
                        activeTab === 'gallery'
                            ? 'border-emerald-500 text-emerald-600'
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        ...
                        <div class="bg-red-100 p-4 rounded-lg mb-6">
                            <p class="text-sm text-gray-700">
                                <strong>Debug Gallery Tab:</strong><br>
                                Active Tab: {{ activeTab }}<br>
                                Has image_url: {{ !!collection.image_url }}<br>
                                Gallery Images Count: {{ collection.gallery_images ? collection.gallery_images.length : 'NULL' }}<br>
                                Gallery Images Type: {{ typeof collection.gallery_images }}<br>
                                Gallery Images: {{ JSON.stringify(collection.gallery_images) }}
                            </p>
                        </div>
