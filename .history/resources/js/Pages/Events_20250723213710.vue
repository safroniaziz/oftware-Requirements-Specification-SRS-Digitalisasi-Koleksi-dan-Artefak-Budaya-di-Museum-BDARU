                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center gap-8 text-center">
                        <div class="group hover:scale-110 transition-transform duration-300">
                            ...
                            <div class="text-sm text-emerald-200 font-semibold">Total Events</div>
                        </div>
                        <div class="group hover:scale-110 transition-transform duration-300">
                            <div class="text-3xl font-black text-teal-300">{{ Object.keys(eventTypes).length }}</div>
                            <div class="text-sm text-teal-200 font-semibold">Event Types</div>
                        </div>
                        <div class="group hover:scale-110 transition-transform duration-300">
                            <div class="text-3xl font-black text-cyan-300">1K+</div>
                            <div class="text-sm text-cyan-200 font-semibold">Participants</div>
                        </div>
                    </div>
                </div>
            </div>
