<template>
    ...
    <div class="fixed top-0 left-0 right-0 bg-white/98 backdrop-blur-xl border-b border-gray-200/50 shadow-lg z-50 overflow-hidden">
                        ...
                        <div class="flex-shrink-0 relative">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex flex-col min-w-0">
                                    <h1 class="text-2xl font-black text-emerald-700 group-hover:scale-105 transition-transform duration-300 overflow-hidden">
                                        BDARU
                                    </h1>
