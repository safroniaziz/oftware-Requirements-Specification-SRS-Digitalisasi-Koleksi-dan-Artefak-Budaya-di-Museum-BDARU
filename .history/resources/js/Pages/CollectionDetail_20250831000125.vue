...
const imageLoaded = ref(props.collection.image_url ? false : true); // If no image, set to true immediately
...
const handleImageError = (event) => {
        ...
        placeholder.className = 'w-full h-96 lg:h-[500px] bg-gradient-to-br from-emerald-100 to-teal-100 flex items-center justify-center';
...
const submitRating = async () => {
    ...
    try {
        ...
        const response = await fetch(`/collections/${props.collection.slug}/ratings`, {
            method: 'POST',
            headers,
            body: JSON.stringify({
        ...
        if (response.ok) {
            // Update collection data with new rating info
            props.collection.average_rating = data.average_rating;
            props.collection.rating_count = data.rating_count;

            // Add the new rating to the beginning of the ratings array
            if (data.rating) {
                props.collection.ratings.unshift(data.rating);
            }
            ...
            Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
                text: 'Rating berhasil dikirim! Terima kasih atas ulasan Anda.',
                confirmButtonText: 'OK',
        ...
        Swal.fire({
            icon: 'error',
            title: 'Gagal',
            text: error.message || 'Gagal mengirim rating. Silakan coba lagi.',
            confirmButtonText: 'OK',
                ...
                <div class="flex items-center group">
                    <div class="flex-shrink-0 relative">
                        <div class="flex items-center space-x-3">
                            <!-- Static BDARU Logo -->
                            <div class="relative">
                                <div class="w-16 h-16 rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 transition-all duration-500 relative overflow-hidden">
                                    <img
                                    ...
                                    <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 transition-all duration-500 relative overflow-hidden" style="display: none;">
                                        <!-- Premium Museum Icon -->
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-200">
                        ...
                        <div
                            v-else
                            class="w-full h-96 lg:h-[500px] bg-gradient-to-br from-emerald-100 to-teal-100 flex items-center justify-center"
                        >
                            <div class="text-center">
                                <svg class="w-24 h-24 text-emerald-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-16">
                ...
                <div class="space-y-8" data-aos="fade-up">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span class="text-gray-600 font-medium text-sm">Material</span>
                                    </div>
                                    <p class="text-gray-900 font-semibold text-base leading-relaxed">{{ collection.material || '-' }}</p>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span class="text-gray-600 font-medium text-sm">Dimensi</span>
                                    </div>
                                    <p class="text-gray-900 font-semibold text-base leading-relaxed">{{ collection.dimensions || '-' }}</p>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span class="text-gray-600 font-medium text-sm">Tahun Pembuatan</span>
                                    </div>
                                    <p class="text-gray-900 font-semibold text-base leading-relaxed">{{ collection.year_period || '-' }}</p>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span class="text-gray-600 font-medium text-sm">Status Konservasi</span>
                                    </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    ...
                                    <p class="text-gray-900 font-semibold text-base leading-relaxed">{{ collection.category?.name || 'Uncategorized' }}</p>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span class="text-gray-600 font-medium text-sm">Rating</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <div class="flex items-center">
                                            <span class="text-yellow-500 text-lg">★</span>
                                            <span class="text-gray-900 font-semibold ml-1">{{ collection.average_rating ? (typeof collection.average_rating === 'number' ? collection.average_rating.toFixed(1) : parseFloat(collection.average_rating).toFixed(1)) : '0.0' }}</span>
                                        </div>
                                        <span class="text-gray-500 text-sm">({{ collection.rating_count || 0 }} ulasan)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-if="collection.conservation_overview" class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Status Konservasi</h3>
                        <div class="prose prose-lg max-w-none">
                            <div class="bg-gray-50 rounded-xl p-6 border-l-4 border-green-500">
                                <p class="text-gray-700 leading-relaxed text-base whitespace-pre-line">{{ collection.conservation_overview }}</p>
                            </div>
                        </div>
                    </div>

                    <!-- Nilai Budaya dan Historis (Merged) -->
                    <div v-if="collection.nilai_budaya_historis || collection.nilai_budaya || collection.nilai_historis" class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100" data-aos="fade-up">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-900 mb-3">Nilai Budaya dan Historis</h3>
                                <div class="prose prose-gray max-w-none">
                                    <p class="text-gray-700 leading-relaxed whitespace-pre-line">
                                        {{ collection.nilai_budaya_historis || (collection.nilai_budaya + (collection.nilai_budaya && collection.nilai_historis ? "\n\n" : "") + collection.nilai_historis) }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                            <h4 class="text-lg font-semibold text-red-800 mb-2">Debug Gallery Data</h4>
                            <div class="text-sm text-red-700 space-y-1">
                                <p><strong>Gallery Images:</strong> {{ JSON.stringify(collection.galleryImages) }}</p>
                                <p><strong>Gallery Images Count:</strong> {{ collection.galleryImages ? collection.galleryImages.length : 'undefined' }}</p>
                                <p><strong>Gallery Images Type:</strong> {{ typeof collection.galleryImages }}</p>
                                <p><strong>Collection Keys:</strong> {{ Object.keys(collection).join(', ') }}</p>
                                <p><strong>Has Gallery Images:</strong> {{ collection.galleryImages ? 'Yes' : 'No' }}</p>
                                <p><strong>Is Array:</strong> {{ Array.isArray(collection.galleryImages) ? 'Yes' : 'No' }}</p>
                            </div>
                        </div>

                        <!-- Gallery Images -->
                        <div v-if="collection.galleryImages && Array.isArray(collection.galleryImages) && collection.galleryImages.length > 0">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                >
                                    ...
                                    <div v-if="galleryImage.caption" class="absolute bottom-0 left-0 right-0 bg-black/70 text-white p-2 text-sm">
                        ...
                        <div v-else class="text-center py-12">
                            ...
                            <h4 class="text-lg font-semibold text-gray-900 mb-2">Belum Ada Galeri</h4>
                            <p class="text-gray-600 mb-4">Koleksi ini belum memiliki gambar galeri tambahan.</p>
                ...
                <!-- QR Code Section -->
                <div v-if="qrCode" class="space-y-8" data-aos="fade-up">
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">QR Code Koleksi</h3>
                        <div class="text-center">
                            <div class="inline-block p-4 bg-gray-50 rounded-xl">
                                <img
                                    :src="qrCode.qr_image_url"
                                    :alt="`QR Code ${collection.name}`"
                                    class="w-48 h-48 mx-auto border-2 border-gray-200 rounded-lg"
                                />
                            </div>
                            <div class="mt-4 space-y-2">
                                <p class="text-sm text-gray-600">
                                    <strong>Kode QR:</strong> <code class="bg-gray-100 px-2 py-1 rounded">{{ qrCode.qr_code }}</code>
                                </p>
                                <p class="text-sm text-gray-600">
                                    <strong>Total Scan:</strong> {{ qrCode.scan_count || 0 }} kali
                                </p>
                                <p v-if="qrCode.last_scanned_at" class="text-sm text-gray-600">
                                    <strong>Terakhir di-scan:</strong> {{ new Date(qrCode.last_scanned_at).toLocaleDateString('id-ID') }}
                                </p>
                                <p class="text-xs text-gray-500 mt-4">
                                    Scan QR code ini untuk mengakses halaman koleksi ini dengan cepat
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-8" data-aos="fade-up">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <!-- Rating Form Card - Only show for authenticated users -->
                        <div v-if="isAuthenticated" class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            <h3 class="text-2xl font-bold text-gray-900 mb-6">Berikan Rating & Ulasan</h3>
                            <form @submit.prevent="submitRating" class="space-y-6">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <div class="flex items-center space-x-1">
                                            <button
                                                ...
                                                :class="{
                                                    'text-yellow-400': star <= (hoverRating || userRating),
                                                    'text-gray-300': star > (hoverRating || userRating)
                                                }"
                                            >
                                                ★
                                            </button>
                                        </div>
                                        <span class="text-sm text-gray-500 ml-2">{{ userRating || 0 }}/5</span>
                                    </div>
                                </div>

                                <!-- Comment -->
                                <div>
                                    <label for="comment" class="block text-sm font-medium text-gray-700 mb-2">Ulasan (Opsional)</label>
                                    <textarea
                                        id="comment"
                                        v-model="userComment"
                                        rows="4"
                                        ...
                                        placeholder="Bagikan pengalaman Anda dengan koleksi ini..."
                                    ></textarea>
                                </div>
                                ...
                                <button
                                    ...
                                    class="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold py-3 px-6 rounded-xl hover:from-emerald-700 hover:to-teal-700 transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                >
                        ...
                        <div v-else class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 text-center">
                            <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                </svg>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-3">Login Diperlukan</h3>
                            <p class="text-gray-600 mb-6">
                                Anda harus login terlebih dahulu untuk dapat memberikan rating dan ulasan.
                            </p>
                            <div class="space-y-3">
                                <Link
                                    :href="route('login')"
                                    class="inline-flex items-center px-6 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-lg hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
                                >
                        ...
                        <!-- Recent Ratings Card -->
                        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            <h3 class="text-2xl font-bold text-gray-900 mb-6">Ulasan Terbaru</h3>
                            <div v-if="collection.ratings && collection.ratings.length > 0" class="space-y-4">
                                <div
                                    v-for="rating in collection.ratings.slice(0, 5)"
                                    :key="rating.id"
                                ...
                                >
                                    ...
                                    <p v-if="rating.comment" class="text-gray-700 text-sm">{{ rating.comment }}</p>
                                    <p v-else class="text-gray-500 text-sm italic">Tidak ada ulasan</p>
                                </div>
                            </div>
                            <div v-else class="text-center py-12">
                                <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <h4 class="text-lg font-semibold text-gray-900 mb-2">Belum Ada Rating</h4>
                                <p class="text-gray-600 mb-4">Koleksi ini belum memiliki rating dan ulasan dari pengunjung.</p>
                                <p class="text-sm text-gray-500">Jadilah yang pertama memberikan rating dan ulasan untuk koleksi ini!</p>
                            </div>
                        </div>
                    </div>
                </div>
