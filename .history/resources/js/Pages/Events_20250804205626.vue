<template>
    <Head :title="`Agenda Kegiatan - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Balai Adat Rajo Penghulu'}`" />
                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center gap-8 text-center" data-aos="fade-up" data-aos-delay="1000">
                        ...
                        <div class="group hover:scale-110 transition-transform duration-300" data-aos="zoom-in" data-aos-delay="1600">
                            <div class="text-3xl font-black text-cyan-300">{{ formatNumber(events.total_participants || 0) }}+</div>
                            <div class="text-sm text-cyan-200 font-semibold">Total Peserta</div>
                        </div>
                    </div>
                </div>
            </div>
...
// Debug museumSettings
console.log('Events.vue museumSettings:', props.museumSettings);
console.log('Events.vue logo_url:', props.museumSettings?.logo_url);
