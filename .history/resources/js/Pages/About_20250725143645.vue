            ...
            <div class="text-center mb-12">
                ...
                >
                    <div class="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 shadow-lg">
                        <img
                            :src="`https://ui-avatars.com/api/?name=${member.name.replace(/\s+/g, '+')}&background=random&color=fff&size=128&bold=true&font-size=0.4&length=2`"
                            :alt="member.name"
                            class="w-full h-full object-cover"
                            @error="$event.target.src = `https://ui-avatars.com/api/?name=${member.name.substring(0, 2).toUpperCase()}&background=random&color=fff&size=128&bold=true&font-size=0.4&length=2`"
                        />
                    </div>
