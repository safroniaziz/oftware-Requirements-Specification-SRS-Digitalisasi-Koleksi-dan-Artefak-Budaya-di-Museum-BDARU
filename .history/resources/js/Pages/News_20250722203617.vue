                        ...
                        >
                            <div class="flex">
                                ...
                                <div class="w-32 h-32 md:w-40 md:h-32 flex-shrink-0">
                                    <img
                                        :src="article.image_path || 'https://via.placeholder.com/160/128/4F46E5/FFFFFF?text=News'"
                                        :alt="article.title"
                            ...
                            <article v-for="article in featuredNews" :key="article.id" class="group">
                                <Link :href="`/news/${article.id}`" class="block">
                                    <div class="flex items-start space-x-3">
                                        <img
                                            :src="article.image_path || 'https://via.placeholder.com/60/60/4F46E5/FFFFFF?text=News'"
                                            :alt="article.title"
...
function handleImageError(event) {
    event.target.src = 'https://via.placeholder.com/160/128/4F46E5/FFFFFF?text=BDARU+News';
}
