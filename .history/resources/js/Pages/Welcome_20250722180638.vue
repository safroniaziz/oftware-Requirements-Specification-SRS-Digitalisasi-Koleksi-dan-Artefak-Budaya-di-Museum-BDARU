...
const pageLoaded = ref(true); // Set true by default
...
onMounted(() => {
    ...
    // Quick page load - show content immediately
    setTimeout(() => {
...
<template>
    ...
    <!-- Main Content -->
    <div v-show="pageLoaded" class="min-h-screen bg-gray-50 animate-fade-in">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 animate-fade-in-up delay-1000">
                        <div class="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl bg-gray-200 group animate-float-subtle">
                            ...
                            <div v-if="!heroLoaded" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse">
                                <div class="w-full h-full flex items-center justify-center">
                                    <div class="text-center">
                                        <div class="w-16 h-16 bg-gray-400 rounded-full animate-spin mx-auto mb-4"></div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="relative h-64 overflow-hidden">
                            <!-- Skeleton Loading -->
                            <div class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse">
                                <div class="w-full h-full flex items-center justify-center">
                                    <div class="w-12 h-12 bg-gray-400 rounded-full animate-spin"></div>
                                </div>
                            </div>
                            ...
                            <img src="https://picsum.photos/800/600?random=1"
                                 ...
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 opacity-0 hover:opacity-100"
                                 loading="lazy"
