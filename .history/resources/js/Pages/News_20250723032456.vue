...
const filteredNews = computed(() => {
    ...
    // Debug: Log the data
    console.log('Props news data:', props.news?.data);
    console.log('Props featured news:', props.featuredNews);
    console.log('Props recent news:', props.recentNews);
