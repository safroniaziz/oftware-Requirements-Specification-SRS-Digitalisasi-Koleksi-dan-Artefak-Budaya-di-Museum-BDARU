            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-8">
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div class="flex flex-wrap items-center gap-4">
                                ...
                                <div class="relative">
                                    <select
                                        ...
                                        @change="handleFilter"
                                        class="appearance-none px-6 py-3 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl text-sm font-semibold text-gray-700 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition-all duration-300 cursor-pointer hover:from-emerald-100 hover:to-teal-100"
                                    >
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-semibold text-gray-700">{{ news.total }} berita ditemukan</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="news.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <div class="relative h-56 overflow-hidden">
                                <!-- Loading State -->
                                <div v-if="imageLoadingStates[article.id] !== false" class="absolute inset-0 bg-gradient-to-br from-emerald-100 to-teal-100 animate-pulse">
                                    <div class="w-full h-full flex items-center justify-center">
                                        <div class="text-center">
                                            <div class="w-12 h-12 bg-emerald-400 rounded-full animate-spin mx-auto mb-3"></div>
                                            <p class="text-emerald-600 text-sm font-medium">Loading...</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div v-if="article.is_featured" class="absolute top-4 left-4">
                                    <div class="flex items-center space-x-1 px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-full text-sm font-bold shadow-lg">
                                ...
                                <div class="absolute top-4 right-4">
                                    <span class="inline-flex items-center px-3 py-1 bg-white/95 backdrop-blur-md text-emerald-700 text-sm font-semibold rounded-full border border-white/50 shadow-lg">
                                ...
                                <div class="absolute bottom-4 left-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div class="flex items-center space-x-2 px-3 py-2 bg-black/70 backdrop-blur-md text-white rounded-full text-sm">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                        </svg>
                                        <span class="font-medium">{{ formatNumber(article.view_count || 0) }} views</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center space-x-3">
                                        <div class="flex items-center space-x-1 text-emerald-600">
                                            ...
                                            <span class="text-sm font-medium">{{ formatDate(article.published_at) }}</span>
                                        </div>
                                    </div>
                                </div>

                                <!-- Enhanced Title -->
                                <h3 class="text-xl font-black text-gray-900 mb-4 leading-tight group-hover:text-emerald-600 transition-colors duration-300 line-clamp-2">
                                    {{ article.title }}
                                </h3>

                                <!-- Enhanced Description -->
                                <p class="text-gray-600 text-base leading-relaxed mb-6 line-clamp-3">{{ article.excerpt || article.content.substring(0, 150) + '...' }}</p>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex items-center space-x-2 text-gray-500">
                                            ...
                                            <span class="text-sm font-medium">{{ formatNumber(article.view_count || 0) }} views</span>
                                        </div>
                                    </div>

                                    <Link
                                        :href="`/news/${article.id}`"
                                        class="group/btn relative px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-lg hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden"
                                    >
                                        <span class="relative z-10 flex items-center space-x-2">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                                    </Link>
                                </div>
                            </div>
                        </article>
                    ...
                    <div v-else class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">Tidak Ada Berita Ditemukan</h3>
                        <p class="text-gray-600 mb-4">Coba ubah filter pencarian Anda atau lihat berita lainnya.</p>
                        <button @click="clearFilters" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors duration-200">
                            Reset Filter
                        </button>
                    </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-8">
                        <h3 class="text-xl font-black text-gray-900 mb-6 flex items-center">
                            <div class="w-8 h-8 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                        ...
                        <div class="space-y-6">
                            <article v-for="article in featuredNews" :key="article.id" class="group">
                                <Link :href="`/news/${article.id}`" class="block">
                                    <div class="flex items-start space-x-4">
                                        <div class="relative w-16 h-16 flex-shrink-0 overflow-hidden rounded-xl">
                                            <img
                                                :src="article.image_path || placeholderImage"
                                                :alt="article.title"
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
                        <h3 class="text-xl font-black text-gray-900 mb-6 flex items-center">
                            <div class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
