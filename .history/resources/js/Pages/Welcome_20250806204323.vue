...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="py-20 lg:py-32 bg-gradient-to-br from-violet-900 via-purple-900 to-indigo-900 relative overflow-hidden">
            <!-- Animated Background Elements -->
            <div class="absolute inset-0">
                <!-- Floating Geometric Shapes -->
                <div class="absolute top-10 left-10 w-32 h-32 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full blur-2xl animate-float-slow opacity-20"></div>
                <div class="absolute top-40 right-20 w-40 h-40 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full blur-3xl animate-float-medium opacity-30"></div>
                <div class="absolute bottom-20 left-1/4 w-36 h-36 bg-gradient-to-r from-purple-500 to-violet-500 rounded-full blur-2xl animate-float-fast opacity-25"></div>
                <div class="absolute top-1/2 right-1/3 w-28 h-28 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full blur-2xl animate-float-subtle opacity-20"></div>
                ...
                <!-- Glowing Orbs -->
                <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-pink-400 rounded-full animate-ping"></div>
                <div class="absolute top-3/4 right-1/4 w-1.5 h-1.5 bg-blue-400 rounded-full animate-ping delay-1000"></div>
                <div class="absolute bottom-1/4 left-3/4 w-2 h-2 bg-purple-400 rounded-full animate-ping delay-2000"></div>
            </div>
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16 lg:mb-20">
                    <!-- Animated Badge -->
                    <div class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-pink-500/20 to-purple-500/20 backdrop-blur-xl text-white rounded-full border border-pink-400/30 mb-8 group hover:from-pink-500/30 hover:to-purple-500/30 transition-all duration-500 shadow-2xl shadow-pink-500/25">
                        <div class="w-3 h-3 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full mr-3 animate-pulse"></div>
                        <span class="text-sm font-bold tracking-wider">🚀 PROGRAM PENGABDIAN MASYARAKAT 2025</span>
                    </div>

                    <!-- Main Title with Glow Effect -->
                    <h2 class="text-4xl md:text-6xl lg:text-7xl font-black mb-8 leading-tight">
                        <span class="bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent animate-gradient">
                            TIM PENGEMBANG
                        </span>
                        <div class="absolute inset-0 bg-gradient-to-r from-pink-400 to-purple-400 blur-3xl opacity-30 animate-pulse"></div>
                    </h2>

                    <!-- Subtitle with enhanced styling -->
                    <p class="text-xl md:text-2xl text-gray-200 max-w-5xl mx-auto leading-relaxed font-medium mb-10">
                        <span class="bg-gradient-to-r from-pink-300 to-purple-300 bg-clip-text text-transparent">
                            Pendampingan Digitalisasi Aset Seni dan Budaya Bengkulu di Museum BDARU
                        </span>
                        <br>
                        <span class="text-lg text-gray-300 mt-2 block">
                            Sebagai Upaya Transformasi Digital dan Pelestarian Budaya Lokal
                        </span>
                    </p>

                    <!-- Institution Info Card -->
                    <div class="mt-10 p-6 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl max-w-4xl mx-auto">
                        <div class="text-white space-y-4">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <span class="font-bold text-lg">Universitas Bengkulu</span>
                            </div>
                            <div class="flex items-center justify-center gap-3">
                                <div class="w-8 h-8 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                </div>
                                <span class="text-lg">Program Pemberdayaan Kemitraan Masyarakat 2025</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div class="group relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-pink-500 to-rose-500 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
                        <div class="relative bg-gradient-to-br from-pink-500/10 to-rose-500/10 backdrop-blur-xl rounded-3xl p-8 border border-pink-400/30 shadow-2xl hover:shadow-pink-500/25 transform hover:-translate-y-3 hover:scale-105 transition-all duration-700">
                            <!-- Glowing Border -->
                            <div class="absolute inset-0 bg-gradient-to-r from-pink-500 to-rose-500 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-700"></div>

                            <div class="relative text-center">
                                <!-- Enhanced Avatar -->
                                <div class="relative w-32 h-32 mx-auto mb-8">
                                    <div class="absolute inset-0 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full blur-xl animate-pulse"></div>
                                    <div class="relative w-32 h-32 bg-gradient-to-br from-pink-500 to-rose-500 rounded-full flex items-center justify-center text-white text-3xl font-black shadow-2xl border-4 border-white/20">
                                        TP
                                    </div>
                                    <!-- Floating Elements -->
                                    <div class="absolute -top-2 -right-2 w-6 h-6 bg-pink-300 rounded-full animate-ping"></div>
                                    <div class="absolute -bottom-2 -left-2 w-4 h-4 bg-rose-300 rounded-full animate-ping delay-500"></div>
                                </div>

                                <!-- Info -->
                                <h3 class="text-2xl font-black text-white mb-3">Ir. Tiara Eka Putri, S.T.,M.Kom.</h3>
                                <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-pink-500/20 to-rose-500/20 rounded-full border border-pink-400/30 mb-4">
                                    <span class="text-pink-200 font-bold">💻 Tim Pengembang</span>
                                </div>
                                <p class="text-gray-300 text-sm mb-6">NIDN: 0419089303</p>

                                <!-- Specialization -->
                                <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                                    <p class="text-white">
                                        <span class="font-bold text-pink-300">🎯 Spesialisasi:</span><br>
                                        <span class="text-gray-200">Sistem Informasi & Komputer</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Tim Member 2 - Kurnia -->
                    <div class="group relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-purple-500 to-violet-500 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
                        <div class="relative bg-gradient-to-br from-purple-500/10 to-violet-500/10 backdrop-blur-xl rounded-3xl p-8 border border-purple-400/30 shadow-2xl hover:shadow-purple-500/25 transform hover:-translate-y-3 hover:scale-105 transition-all duration-700">
                            <!-- Glowing Border -->
                            <div class="absolute inset-0 bg-gradient-to-r from-purple-500 to-violet-500 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-700"></div>

                            <div class="relative text-center">
                                <!-- Enhanced Avatar -->
                                <div class="relative w-32 h-32 mx-auto mb-8">
                                    <div class="absolute inset-0 bg-gradient-to-r from-purple-500 to-violet-500 rounded-full blur-xl animate-pulse"></div>
                                    <div class="relative w-32 h-32 bg-gradient-to-br from-purple-500 to-violet-500 rounded-full flex items-center justify-center text-white text-3xl font-black shadow-2xl border-4 border-white/20">
                                        KA
                                    </div>
                                    <!-- Floating Elements -->
                                    <div class="absolute -top-2 -right-2 w-6 h-6 bg-purple-300 rounded-full animate-ping"></div>
                                    <div class="absolute -bottom-2 -left-2 w-4 h-4 bg-violet-300 rounded-full animate-ping delay-500"></div>
                                </div>

                                <!-- Info -->
                                <h3 class="text-2xl font-black text-white mb-3">Ir. Kurnia Anggriani,S.T.,M.T.,Ph.D.</h3>
                                <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500/20 to-violet-500/20 rounded-full border border-purple-400/30 mb-4">
                                    <span class="text-purple-200 font-bold">⚡ Tim Pengembang</span>
                                </div>
                                <p class="text-gray-300 text-sm mb-6">NIDN: 0018018902</p>

                                <!-- Specialization -->
                                <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                                    <p class="text-white">
                                        <span class="font-bold text-purple-300">🎯 Spesialisasi:</span><br>
                                        <span class="text-gray-200">Teknologi & Manajemen</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="group relative md:col-span-2 lg:col-span-1">
                        <div class="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
                        <div class="relative bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-xl rounded-3xl p-8 border border-cyan-400/30 shadow-2xl hover:shadow-cyan-500/25 transform hover:-translate-y-3 hover:scale-105 transition-all duration-700">
                            <!-- Glowing Border -->
                            <div class="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-700"></div>

                            <div class="relative text-center">
                                <!-- Enhanced Avatar -->
                                <div class="relative w-32 h-32 mx-auto mb-8">
                                    <div class="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full blur-xl animate-pulse"></div>
                                    <div class="relative w-32 h-32 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center text-white text-3xl font-black shadow-2xl border-4 border-white/20">
                                        GS
                                    </div>
                                    <!-- Floating Elements -->
                                    <div class="absolute -top-2 -right-2 w-6 h-6 bg-cyan-300 rounded-full animate-ping"></div>
                                    <div class="absolute -bottom-2 -left-2 w-4 h-4 bg-blue-300 rounded-full animate-ping delay-500"></div>
                                </div>

                                <!-- Info -->
                                <h3 class="text-2xl font-black text-white mb-3">Dr. Gushevinalti, S.Sos., M.Si.</h3>
                                <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full border border-cyan-400/30 mb-4">
                                    <span class="text-cyan-200 font-bold">🌟 Tim Pengembang</span>
                                </div>
                                <p class="text-gray-300 text-sm mb-6">NIDN: 0016087804</p>

                                <!-- Specialization -->
                                <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                                    <p class="text-white">
                                        <span class="font-bold text-cyan-300">🎯 Spesialisasi:</span><br>
                                        <span class="text-gray-200">Sosial & Masyarakat</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-20 lg:mt-24 relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-3xl blur-2xl"></div>
                    <div class="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-10 border border-white/20 shadow-2xl">
                        <div class="text-center mb-8">
                            <h3 class="text-3xl font-black text-white mb-4">📋 Deskripsi Project</h3>
                            <div class="w-24 h-1 bg-gradient-to-r from-pink-500 to-purple-500 mx-auto rounded-full"></div>
                        </div>

                        <div class="text-gray-200 leading-relaxed text-center max-w-5xl mx-auto space-y-6">
