...
const categoriesWithCounts = computed(() => {
    const allCategories = [
        ...
        { id: 'seni-rupa', label: 'Seni Rupa', icon: '🎨' },
        { id: 'arkeologi', label: 'Arkeologi', icon: '🏺' },
        { id: 'tekstil', label: 'Tekstil', icon: '🧵' },
        { id: 'wayang', label: 'Wayang', icon: '🎭' },
        { id: 'keris', label: 'Keris', icon: '⚔️' },
    ...
    return allCategories.map(category => ({
        ...
        count: category.id === 'all'
            ? collectionsData.value.length
            : collectionsData.value.filter(c => c.category?.slug === category.id).length
    }));
});

// Computed properties
const filteredCollections = computed(() => {
    let filtered = collectionsData.value;
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-center space-x-3 mb-6">
                        <div class="w-12 h-12 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-xl">
                            <div class="w-8 h-6 bg-white/95 rounded-lg relative">
                                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-emerald-600 to-teal-600"></div>
                                <div class="absolute top-2 left-1 right-1 h-0.5 bg-gray-800"></div>
                                <div class="absolute top-4 left-1 right-1 h-0.5 bg-gray-800"></div>
                        ...
                        <div>
                            <h3 class="text-2xl font-black bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
                                BDARU
                            </h3>
                    ...
                    <p class="text-gray-300 leading-relaxed mb-6 max-w-md">
                        Museum digital yang menghadirkan kekayaan budaya Indonesia dalam format yang modern dan interaktif.
                        Melestarikan warisan budaya melalui teknologi terkini.
                    </p>
                ...
                <!-- Quick Links -->
                <div>
                    <h4 class="text-lg font-bold mb-6 text-emerald-400">Quick Links</h4>
                    <ul class="space-y-3">
                        <li><Link href="/" class="text-gray-300 hover:text-emerald-400 transition-colors duration-300">Beranda</Link></li>
                        <li><Link href="/collections" class="text-gray-300 hover:text-emerald-400 transition-colors duration-300">Koleksi Budaya</Link></li>
                        <li><Link href="/news" class="text-gray-300 hover:text-emerald-400 transition-colors duration-300">Berita Terbaru</Link></li>
                        <li><Link href="/agenda" class="text-gray-300 hover:text-emerald-400 transition-colors duration-300">Agenda Kegiatan</Link></li>
                        <li><Link href="/about" class="text-gray-300 hover:text-emerald-400 transition-colors duration-300">Tentang Kami</Link></li>
                    </ul>
                </div>

                <!-- Contact Info -->
                <div>
                    <h4 class="text-lg font-bold mb-6 text-emerald-400">Kontak</h4>
                    <div class="space-y-4">
                        <div class="flex items-center space-x-3">
            ...
            <div class="border-t border-gray-800 mt-12 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-6 mt-4 md:mt-0">
                        <Link href="/privacy" class="text-gray-400 hover:text-emerald-400 text-sm transition-colors duration-300">Privacy Policy</Link>
                        <Link href="/terms" class="text-gray-400 hover:text-emerald-400 text-sm transition-colors duration-300">Terms of Service</Link>
                        <Link href="/sitemap" class="text-gray-400 hover:text-emerald-400 text-sm transition-colors duration-300">Sitemap</Link>
                    </div>
                </div>
            </div>
        </div>
