        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden lg:flex items-center space-x-4">
                    <Link v-if="canLogin" :href="route('login')" class="px-4 py-2 rounded-lg font-semibold text-emerald-600 hover:bg-emerald-50 transition">Login</Link>
    ...
    <div v-if="mobileMenuOpen" class="fixed inset-0 z-[60] flex">
        ...
        <div class="relative bg-white w-4/5 max-w-xs h-full shadow-xl p-6 flex flex-col">
            <nav class="flex-1 space-y-2 mt-8">
                <Link href="/" class="block px-4 py-3 rounded-lg font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Beranda</Link>
                <Link href="/collections" class="block px-4 py-3 rounded-lg font-bold text-emerald-600 bg-emerald-50">Koleksi Budaya</Link>
                <Link href="/news" class="block px-4 py-3 rounded-lg font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Berita Terbaru</Link>
                <Link href="/events" class="block px-4 py-3 rounded-lg font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Agenda</Link>
                <Link href="/contact" class="block px-4 py-3 rounded-lg font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Kontak</Link>
                <Link href="/about" class="block px-4 py-3 rounded-lg font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Profil</Link>
                <Link href="/testimonials" class="block px-4 py-3 rounded-lg font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Testimoni</Link>
            </nav>
            <div class="mt-8 space-y-2">
                <Link v-if="canLogin" :href="route('login')" class="block w-full px-4 py-2 rounded-lg font-semibold text-emerald-600 hover:bg-emerald-50 transition">Login</Link>
                <Link v-if="canRegister" :href="route('register')" class="block w-full px-4 py-2 rounded-lg font-semibold text-white bg-emerald-600 hover:bg-emerald-700 transition">Register</Link>
            </div>
        </div>
    </div>
