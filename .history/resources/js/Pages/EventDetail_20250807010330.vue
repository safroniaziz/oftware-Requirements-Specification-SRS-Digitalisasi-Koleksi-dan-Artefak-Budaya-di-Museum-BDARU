                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">balaiadatrajopenghulu@gmail.com</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">0823-7355-5447</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">Jl. Pariwisata, Malabero, Kec. Tlk. Segara, Kota Bengkulu, Bengkulu, Indonesia, {{ props.museumSettings?.city || 'Belum tersedia' }}</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
