                        ...
                        <div class="px-4 py-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <Link
                                    v-if="canLogin"
                                    :href="route('login')"
                                    class="flex items-center justify-center px-4 py-3 text-gray-700 font-medium rounded-lg border border-gray-300 hover:border-emerald-400 hover:text-emerald-600 hover:bg-emerald-50 transition-colors duration-200"
                                    @click="mobileMenuOpen = false"
                                >
                                ...
                                <Link
                                    v-if="canRegister"
                                    :href="route('register')"
                                    class="flex items-center justify-center px-4 py-3 bg-emerald-600 text-white font-medium rounded-lg hover:bg-emerald-700 transition-colors duration-200"
                                    @click="mobileMenuOpen = false"
                                >
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
