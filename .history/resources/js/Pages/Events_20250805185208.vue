                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#events" class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
                                ...
                                <div class="absolute inset-4 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <div class="p-4 space-y-3">
                                        <div class="flex items-center space-x-3 p-2 bg-emerald-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Pameran Seni</p>
                                        ...
                                        <div class="flex items-center space-x-3 p-2 bg-teal-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Workshop Budaya</p>
                                        ...
                                        <div class="flex items-center space-x-3 p-2 bg-cyan-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Seminar Digital</p>
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                    ...
                    <div class="w-full lg:flex-1 lg:min-w-0">
                        <div class="flex items-center gap-2 overflow-x-auto pb-2 lg:pb-0 scrollbar-hide max-w-full">
                            <button
                                v-for="type in eventTypesWithCounts"
                                :key="type.id"
                            ...
                            >
                                ...
                                <span class="sm:hidden">{{ type.label.split(' ')[0] }}</span>
                                <span class="bg-white/20 px-2 py-0.5 rounded-full text-xs">{{ type.count }}</span>
                            </button>
                        </div>
                    </div>
        ...
        <section class="py-16 bg-gray-50">
            ...
            <div v-if="viewMode === 'grid'" class="space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <!-- Pagination -->
                    <div v-if="events.data.length > 0" class="mt-8">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-500">
                                Menampilkan {{ events.from }} - {{ events.to }} dari {{ events.total }} kegiatan
                            </div>
                            <div class="flex items-center space-x-2">
                                <Link
...
const placeholderImage = 'data:image/svg+xml;base64,';
...
const fallbackImages = [
    '/storage/events/type-museum.jpg',
    '/storage/events/type-exhibition.jpg',
    '/storage/events/type-workshop.jpg',
    '/storage/events/type-seminar.jpg',
    '/storage/events/type-performance.jpg',
    '/storage/events/type-cultural.jpg',
    '/storage/events/type-artshow.jpg',
    '/storage/events/type-festival.jpg'
];
...
// Event types with dynamic counts
const eventTypesWithCounts = computed(() => {
    const allEvents = props.events?.data || [];
    ...
    // Create types with counts
    const typesWithCounts = Object.entries(props.eventTypes).map(([type, label]) => {
        const count = allEvents.filter(event => event.type === type).length;
        return {
            id: type,
            label: label,
    ...
    return [allType, ...typesWithCounts];
});
...
function handleImageError(event) {
    ...
    imageLoadingStates.value[eventId] = false;
}

function handleImageLoad(event) {
    imageLoadingStates.value[event.target.dataset.eventId] = false;
}

function startImageLoading(eventId) {
    imageLoadingStates.value[eventId] = true;
}
...
/* Hide scrollbar for type filter */
.scrollbar-hide {
