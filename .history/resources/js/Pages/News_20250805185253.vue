<template>
    ...
    <div class="hidden md:block w-full mt-20 bg-white/95 backdrop-blur-lg border-b border-gray-200/50 shadow-sm overflow-hidden">
        <div class="w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-center items-center py-6">
                                    <!-- Desktop Menu -->
                <div class="flex items-center space-x-2 lg:space-x-4 overflow-x-auto scrollbar-hide max-w-full">
                        <!-- Beranda -->
                        <Link
                            href="/"
        ...
        <section class="relative py-16 lg:py-24 bg-gradient-to-br from-emerald-900 via-teal-800 to-cyan-900 overflow-hidden min-h-[80vh]" :class="{ 'mt-16 lg:mt-0': !mobileMenuOpen, 'mt-0': mobileMenuOpen }">
            ...
            <div class="relative z-10 w-full lg:w-4/5 lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-black text-white mb-8 leading-tight" data-aos="fade-up" data-aos-delay="400">
                        Berita <span class="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">Terbaru</span>
                    </h1>
                    ...
                    <div class="flex justify-center gap-8 text-center" data-aos="fade-up" data-aos-delay="1000">
                        <div class="group hover:scale-110 transition-transform duration-300" data-aos="zoom-in" data-aos-delay="1200">
                            <div class="text-3xl font-black text-emerald-300">{{ news.total }}+</div>
                            <div class="text-sm text-emerald-200 font-semibold">Total Berita</div>
                        </div>
                        <div class="group hover:scale-110 transition-transform duration-300" data-aos="zoom-in" data-aos-delay="1400">
                            <div class="text-3xl font-black text-teal-300">{{ newsCategories?.length || 0 }}</div>
                        ...
                        <div class="group hover:scale-110 transition-transform duration-300" data-aos="zoom-in" data-aos-delay="1600">
                            <div class="text-3xl font-black text-cyan-300">{{ formatNumber(news.total_views || 0) }}+</div>
                            <div class="text-sm text-cyan-200 font-semibold">Total Dilihat</div>
                        </div>
                    </div>
                </div>
            </div>
