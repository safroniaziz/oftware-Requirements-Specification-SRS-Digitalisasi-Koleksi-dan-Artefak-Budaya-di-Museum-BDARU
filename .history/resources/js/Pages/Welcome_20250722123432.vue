                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="relative h-64 overflow-hidden">
                                                                                                                                            <!-- Background Image -->
                            <img src="https://via.placeholder.com/800x600/10b981/ffffff?text=Lukisan+Klasik"
                                 ...
                                 loading="lazy"
                                 @load="console.log('Image 1 loaded successfully')"
                                 @error="console.error('Image 1 failed to load:', $event.target.src); $event.target.style.display='none'">

                            <!-- Fallback Gradient -->
                            <div class="absolute inset-0 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 z-0 opacity-50"></div>
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="relative h-64 overflow-hidden">
                                                                                                                                                                                                    <!-- Background Image -->
                            <img src="https://via.placeholder.com/800x600/f59e0b/ffffff?text=Artefak+Kuno"
                                 alt="Artefak Kuno Nusantara"
                                 class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 z-0"
                                 loading="lazy"
                                 @load="console.log('Image 2 loaded successfully')"
                                 @error="console.error('Image 2 failed to load:', $event.target.src); $event.target.style.display='none'">

                            <!-- Fallback Gradient -->
                            <div class="absolute inset-0 bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 z-0 opacity-50"></div>
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="relative h-64 overflow-hidden">
                                                                                                                                                                                                    <!-- Background Image -->
                            <img src="https://via.placeholder.com/800x600/8b5cf6/ffffff?text=Batik+Tradisional"
                                 alt="Batik Tradisional"
                                 class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 z-0"
                                 loading="lazy"
                                 @load="console.log('Image 3 loaded successfully')"
                                 @error="console.error('Image 3 failed to load:', $event.target.src); $event.target.style.display='none'">

                            <!-- Fallback Gradient -->
                            <div class="absolute inset-0 bg-gradient-to-br from-purple-500 via-pink-500 to-rose-500 z-0 opacity-50"></div>
