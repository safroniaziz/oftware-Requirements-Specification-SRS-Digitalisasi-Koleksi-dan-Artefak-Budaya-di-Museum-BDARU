    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                >
                    <div class="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 shadow-lg">
                        <img
                            :src="member.photo"
                            :alt="member.name"
                            class="w-full h-full object-cover"
                            @error="$event.target.src = `https://ui-avatars.com/api/?name=${member.name.substring(0, 2).toUpperCase()}&background=10b981&color=fff&size=128&bold=true`"
                        />
                    </div>
