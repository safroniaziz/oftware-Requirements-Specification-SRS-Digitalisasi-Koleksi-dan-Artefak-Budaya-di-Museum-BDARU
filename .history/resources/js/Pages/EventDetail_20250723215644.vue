            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                        <h3 class="text-lg font-bold text-gray-900 mb-4">Back to Events</h3>
                        <p class="text-gray-600 text-sm mb-4">Explore other events from the digital museum Indonesia.</p>
                        <Link
                            href="/events"
