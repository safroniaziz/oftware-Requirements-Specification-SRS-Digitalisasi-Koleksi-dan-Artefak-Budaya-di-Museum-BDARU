...
const submitRating = async () => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            alert('Rating berhasil dikirim! Terima kasih atas ulasan Anda.');
        } else {
            throw new Error(data.message || 'Gagal mengirim rating');
        }
    } catch (error) {
        console.error('Error submitting rating:', error);
        alert(error.message || 'Gagal mengirim rating. Silakan coba lagi.');
    } finally {
...
<template>
        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="min-h-[400px]">
                ...
                <div v-if="activeTab === 'ratings'" class="space-y-8" data-aos="fade-up">
                    <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Rating & Ulasan</h3>
                        <div class="space-y-6">
                            <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-200">
                                <h4 class="font-semibold text-emerald-800 mb-2">Rating & Ulasan</h4>
                                <p class="text-emerald-700 text-sm">Berikan rating dan ulasan Anda untuk koleksi ini.</p>
                            </div>
                            <div class="bg-blue-50 rounded-xl p-4 border border-blue-200">
                                <h4 class="font-semibold text-blue-800 mb-2">Rating</h4>
                                <div class="flex items-center space-x-2">
                                    <div class="flex items-center">
                                        <span class="text-yellow-500 text-lg">★</span>
                                        <span class="text-gray-900 font-semibold ml-1">{{ userRating || 0 }}/5</span>
                                    </div>
                                    <span class="text-gray-500 text-sm">({{ collection.rating_count || 0 }} ulasan)</span>
                                </div>
                            </div>
                            <div class="bg-purple-50 rounded-xl p-4 border border-purple-200">
                                <h4 class="font-semibold text-purple-800 mb-2">Ulasan</h4>
                                <textarea
                                    v-model="userComment"
                                    rows="4"
                            ...
                            <div class="bg-green-50 rounded-xl p-4 border border-green-200">
                                <h4 class="font-semibold text-green-800 mb-2">Kirim Rating</h4>
                                <button
                                    @click="submitRating"
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Berikan Rating & Ulasan</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">Bagikan pengalaman Anda dengan koleksi ini. Rating dan ulasan Anda akan membantu pengunjung lain.</p>
            </div>
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="mt-8 bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                    <h3 class="text-xl font-bold text-gray-900 mb-6">Ulasan Terbaru</h3>
