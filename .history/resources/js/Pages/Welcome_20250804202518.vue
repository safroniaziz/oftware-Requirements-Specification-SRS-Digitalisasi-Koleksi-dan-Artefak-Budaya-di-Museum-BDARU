...
onMounted(() => {
    ...
    console.log('=== MUSEUM SETTINGS DEBUG ===');
    console.log('Full museumSettings:', props.museumSettings);
    console.log('Logo URL:', props.museumSettings?.logo_url);
    console.log('Logo Path:', props.museumSettings?.logo_path);
    console.log('Museum Name:', props.museumSettings?.museum_name);
    console.log('Has logo_url property:', 'logo_url' in (props.museumSettings || {}));
    console.log('Type of museumSettings:', typeof props.museumSettings);
    console.log('Is museumSettings null?', props.museumSettings === null);
    console.log('Is museumSettings undefined?', props.museumSettings === undefined);
    console.log('================================');
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="text-xs text-red-500 mb-1">
                                        Logo URL: {{ props.museumSettings?.logo_url || 'NOT FOUND' }}
                                    </div>
