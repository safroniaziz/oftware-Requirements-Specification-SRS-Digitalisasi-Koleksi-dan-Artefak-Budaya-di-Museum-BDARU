    ...
    <section class="py-12 lg:py-20 bg-gradient-to-br from-gray-50 to-emerald-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="space-y-6 lg:space-y-8">
                    <div>
                        <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 lg:mb-6" data-aos="fade-up">Kirim Pesan</h3>
                        <p class="text-gray-600 mb-6 lg:mb-8 text-sm lg:text-base" data-aos="fade-up" data-aos-delay="200">
                            Kirim pesan kepada kami dan tim kami akan merespons dalam waktu 24 jam.
                        </p>
                    </div>
