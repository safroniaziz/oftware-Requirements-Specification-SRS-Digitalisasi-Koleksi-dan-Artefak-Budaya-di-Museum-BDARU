                ...
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    >
                        ...
                        <div class="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                ...
                                <!-- Mobile Hamburger Menu Button - FORCE SHOW -->
                <div class="block border-4 border-red-500 bg-yellow-300 p-2" style="display: block !important; background: yellow !important;">
                    <button
                        @click="mobileMenuOpen = !mobileMenuOpen"
                        class="inline-flex items-center justify-center p-3 rounded-md text-gray-700 hover:text-emerald-600 hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-emerald-500 transition-all duration-300 border-4 border-blue-500 bg-green-300"
                        style="display: inline-flex !important; background: green !important;"
                    >
                        <!-- Debug Text -->
                        <span class="text-sm text-red-600 font-bold mr-2" style="color: red !important;">MENU BUTTON</span>

                        <svg
                            class="h-8 w-8 text-black border-2 border-purple-500"
                        ...
                        <svg
                            ...
                            fill="none"
                            viewBox="0 0 24 24"
                            style="display: none !important; color: black !important;"
                        >
