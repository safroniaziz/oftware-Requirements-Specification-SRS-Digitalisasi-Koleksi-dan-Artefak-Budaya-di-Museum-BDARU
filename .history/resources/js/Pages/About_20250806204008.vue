<template>
    <Head :title="`Profil - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Indonesia'}`" />
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0">
                            Kenali lebih dekat Museum Digital Indonesia BDARU. Temukan visi, misi, dan tim yang berdedikasi untuk melestarikan dan memperkenalkan budaya Indonesia melalui teknologi digital.
                        </p>
