<template>
    <Head :title="`Profil - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Balai Adat Rajo Penghulu'}`" />
    ...
    <div class="min-h-screen bg-gray-50">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full border-2 border-emerald-200 mb-6 group hover:bg-gradient-to-r hover:from-emerald-200 hover:to-teal-200 transition-all duration-300 shadow-lg">
                            ...
                            <span class="text-sm font-bold">🏛️ Profil Museum</span>
                        </div>
                        ...
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0">
                            Kenali lebih dekat Museum Digital Balai Adat Rajo Penghulu BDARU. Temukan visi, misi, dan tim yang berdedikasi untuk melestarikan dan memperkenalkan budaya Indonesia melalui teknologi digital.
                        </p>

                        <!-- Enhanced CTA Buttons -->
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#about" class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
                    ...
                    <div class="w-full lg:w-1/2 flex justify-center lg:justify-end">
                        <div class="relative w-full max-w-lg">
                            ...
                            <div class="relative w-full h-96 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-transform duration-500">
                                <!-- Enhanced Museum Profile Design -->
                                <div class="absolute inset-4 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <div class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white p-4 rounded-t-2xl">
                                        <div class="text-center">
                                            <h3 class="text-xl font-bold">BDARU Museum</h3>
                                            <p class="text-sm opacity-90">Digital Indonesia</p>
                                        </div>
                                    </div>

                                    <!-- Museum Profile Content -->
                                    <div class="p-4 space-y-3">
                                        <div class="flex items-center space-x-3 p-2 bg-emerald-50 rounded-lg">
                                            <div class="w-3 h-3 bg-emerald-500 rounded-full"></div>
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Visi & Misi</p>
                                                <p class="text-xs text-gray-600">Pelestarian Budaya</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3 p-2 bg-teal-50 rounded-lg">
                                            <div class="w-3 h-3 bg-teal-500 rounded-full"></div>
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Tim Profesional</p>
                                        ...
                                        <div class="flex items-center space-x-3 p-2 bg-cyan-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Teknologi Digital</p>
                                                <p class="text-xs text-gray-600">Inovasi Modern</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="space-y-6 lg:space-y-8">
                        <div>
                            <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 lg:mb-6" data-aos="fade-up">
                        ...
                        <!-- Mission & Vision -->
                        <div class="space-y-6 lg:space-y-8">
                            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 lg:p-8" data-aos="fade-up" data-aos-delay="300">
                                <h3 class="text-xl lg:text-2xl font-bold text-gray-900 mb-4">Misi Kami</h3>
                                <p class="text-gray-700 leading-relaxed text-sm lg:text-base">
                                    Melestarikan dan mendigitalisasi warisan budaya Indonesia melalui teknologi modern, membuat akses ke pengetahuan budaya lebih mudah dan terjangkau bagi semua kalangan.
                                </p>
                            </div>

                            <div class="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 lg:p-8" data-aos="fade-up" data-aos-delay="400">
                                <h3 class="text-xl lg:text-2xl font-bold text-gray-900 mb-4">Visi Kami</h3>
                                <p class="text-gray-700 leading-relaxed text-sm lg:text-base">
                                    Menjadi platform digital terdepan dalam pelestarian dan promosi budaya Indonesia, menghubungkan generasi masa lalu, sekarang, dan masa depan melalui teknologi inovatif.
                                </p>
                            </div>
                        </div>
                        ...
                        <div data-aos="fade-up" data-aos-delay="500">
                            <h3 class="text-xl lg:text-2xl font-bold text-gray-900 mb-4 lg:mb-6">Nilai-Nilai Kami</h3>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                <div class="flex items-start space-x-3">
                                    <div class="w-8 h-8 lg:w-10 lg:h-10 bg-emerald-500 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-900 text-sm lg:text-base">Integritas</h4>
                                        <p class="text-gray-600 text-sm">Menjaga keaslian dan akurasi informasi budaya</p>
                                    </div>
                                </div>

                                <div class="flex items-start space-x-3">
                                    <div class="w-8 h-8 lg:w-10 lg:h-10 bg-teal-500 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-900 text-sm lg:text-base">Inovasi</h4>
                                        <p class="text-gray-600 text-sm">Terus berinovasi dalam teknologi digital</p>
                                    </div>
                                </div>

                                <div class="flex items-start space-x-3">
                                    <div class="w-8 h-8 lg:w-10 lg:h-10 bg-cyan-500 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-900 text-sm lg:text-base">Kolaborasi</h4>
                                        <p class="text-gray-600 text-sm">Berkolaborasi dengan berbagai pihak</p>
                                    </div>
                                </div>

                                <div class="flex items-start space-x-3">
                                    <div class="w-8 h-8 lg:w-10 lg:h-10 bg-blue-500 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-900 text-sm lg:text-base">Aksesibilitas</h4>
                                        <p class="text-gray-600 text-sm">Membuat budaya mudah diakses semua orang</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="py-12 lg:py-24 bg-gray-50">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12 lg:mb-16">
                    <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-4" data-aos="fade-up">Perjalanan Kami</h2>
                    <p class="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4" data-aos="fade-up" data-aos-delay="200">
                        Dari awal berdiri hingga menjadi platform digital terdepan dalam pelestarian budaya Indonesia
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div class="space-y-6 lg:space-y-8">
                        <div class="flex items-start space-x-4">
                            <div class="w-12 h-12 bg-emerald-600 rounded-full flex items-center justify-center flex-shrink-0">
                                <span class="text-white font-bold text-sm lg:text-base">2020</span>
                            </div>
                            <div>
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-2">Pendirian</h3>
                                <p class="text-gray-600 text-sm lg:text-base">
                                    BDARU didirikan dengan visi melestarikan warisan budaya Indonesia melalui teknologi digital.
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div class="w-12 h-12 bg-teal-600 rounded-full flex items-center justify-center flex-shrink-0">
                                <span class="text-white font-bold text-sm lg:text-base">2021</span>
                            </div>
                            <div>
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-2">Digitalisasi Pertama</h3>
                                <p class="text-gray-600 text-sm lg:text-base">
                                    Meluncurkan platform digital pertama dengan 100 koleksi budaya yang telah didigitalisasi.
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div class="w-12 h-12 bg-cyan-600 rounded-full flex items-center justify-center flex-shrink-0">
                                <span class="text-white font-bold text-sm lg:text-base">2023</span>
                            </div>
                            <div>
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-2">Ekspansi</h3>
                                <p class="text-gray-600 text-sm lg:text-base">
                                    Mengembangkan fitur interaktif dan menambahkan 500+ koleksi baru dari berbagai daerah.
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-4">
                            <div class="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center flex-shrink-0">
                                <span class="text-white font-bold text-sm lg:text-base">2024</span>
                            </div>
                            <div>
                                <h3 class="text-lg lg:text-xl font-bold text-gray-900 mb-2">Masa Depan</h3>
                                <p class="text-gray-600 text-sm lg:text-base">
                                    Berkomitmen untuk terus berkembang dan menjadi platform terdepan dalam pelestarian budaya digital.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Stats -->
                    <div class="bg-white rounded-3xl p-6 lg:p-8 shadow-xl">
                        <h3 class="text-xl lg:text-2xl font-bold text-gray-900 mb-6 text-center">Pencapaian Kami</h3>
                        <div class="grid grid-cols-2 gap-6">
                            <div class="text-center">
                                <div class="text-2xl lg:text-3xl font-black text-emerald-600 mb-2">1000+</div>
                                <div class="text-gray-600 text-sm lg:text-base">Koleksi Digital</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl lg:text-3xl font-black text-teal-600 mb-2">50K+</div>
                                <div class="text-gray-600 text-sm lg:text-base">Pengunjung</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl lg:text-3xl font-black text-cyan-600 mb-2">25+</div>
                                <div class="text-gray-600 text-sm lg:text-base">Provinsi</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl lg:text-3xl font-black text-purple-600 mb-2">{{ props.categories?.total || 0 }}+</div>
                                <div class="text-gray-600 text-sm lg:text-base">Kategori</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                                <h3 class="text-xl font-bold text-emerald-800 mb-3">🏛️ Visi</h3>
                                <p class="text-gray-700 leading-relaxed">
                                    Menjadi platform digital terdepan dalam pelestarian, dokumentasi, dan penyebarluasan warisan budaya Indonesia kepada masyarakat global melalui teknologi yang inovatif dan aksesibel.
                                </p>
                            </div>
                            <div class="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-6 border border-teal-100">
                                <h3 class="text-xl font-bold text-teal-800 mb-3">🎯 Misi</h3>
                                <p class="text-gray-700 leading-relaxed">
                                    Mengembangkan sistem digitalisasi yang komprehensif untuk melestarikan koleksi budaya Indonesia, memfasilitasi pembelajaran interaktif, dan membangun kesadaran masyarakat akan pentingnya warisan budaya.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Image -->
                    <div class="relative">
                        <div class="bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl p-8 shadow-xl">
                            <div class="text-center">
                                <div class="w-32 h-32 bg-gradient-to-br from-emerald-600 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    <div class="bg-white rounded-xl p-3">
                                        ...
                                        <div class="text-gray-600">Koleksi Digital</div>
                                    </div>
                                    <div class="bg-white rounded-xl p-3">
                                        <div class="font-bold text-teal-600">{{ props.testimonials?.total || 0 }}+</div>
                                        <div class="text-gray-600">Testimoni</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">
                        Berdasarkan prinsip-prinsip yang menjadi fondasi dalam setiap langkah kami melestarikan budaya Indonesia.
                    </p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                        ...
                        <p class="text-gray-600 text-sm">
                            Menggunakan teknologi terkini untuk melestarikan dan menyajikan warisan budaya dengan cara yang menarik dan interaktif.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">Pelestarian</h3>
                        <p class="text-gray-600 text-sm">
                            Berkomitmen untuk melindungi dan melestarikan warisan budaya Indonesia untuk generasi mendatang.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">Pendidikan</h3>
                        <p class="text-gray-600 text-sm">
                            Menyediakan platform pembelajaran yang informatif dan mudah diakses untuk semua kalangan masyarakat.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">Komunitas</h3>
                        <p class="text-gray-600 text-sm">
                            Membangun komunitas yang peduli terhadap pelestarian budaya dan saling mendukung dalam misi kami.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="py-16 lg:py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden">
            <!-- Background Elements -->
            <div class="absolute inset-0">
                <div class="absolute top-0 left-0 w-64 h-64 bg-blue-200/30 rounded-full blur-3xl animate-float-slow"></div>
                <div class="absolute bottom-0 right-0 w-80 h-80 bg-indigo-200/30 rounded-full blur-3xl animate-float-medium"></div>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-slate-200/30 rounded-full blur-3xl animate-float-fast"></div>
            </div>

            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Section Header -->
                <div class="text-center mb-12 lg:mb-16">
                    <div class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 rounded-full border-2 border-blue-200 mb-6 group hover:bg-gradient-to-r hover:from-blue-200 hover:to-indigo-200 transition-all duration-300 shadow-lg">
                        <div class="w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse"></div>
                        <span class="text-sm font-bold">🎓 Program Pengabdian Masyarakat</span>
                    </div>

                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-black mb-6 leading-tight">
                        <span class="bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 bg-clip-text text-transparent">
                            Tim Pengembang
                        </span>
                    </h2>
                    ...
                    <div class="mt-6 p-4 bg-white/80 backdrop-blur-md rounded-2xl border border-blue-200 shadow-lg max-w-3xl mx-auto">
                        <div class="text-sm text-gray-600 space-y-2">
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                </svg>
                                <span class="font-semibold">Universitas Bengkulu</span>
                            </div>
                            <div class="flex items-center justify-center gap-2">
                                <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span>Program Pemberdayaan Kemitraan Masyarakat 2025</span>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Tim Pengembang Cards -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                    <!-- Tim Member 1 -->
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-blue-200 shadow-xl hover:shadow-2xl hover:border-blue-300 transform hover:-translate-y-2 transition-all duration-500">
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-t-2xl"></div>

                        <div class="text-center">
                            <!-- Avatar -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                TP
                            </div>

                            <!-- Info -->
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Ir. Tiara Eka Putri, S.T.,M.Kom.</h3>
                            <p class="text-blue-600 font-semibold mb-3">Tim Pengembang</p>
                            <p class="text-gray-600 text-sm mb-4">NIDN: 0419089303</p>

                            <!-- Specialization -->
                            <div class="bg-blue-50 rounded-xl p-4 border border-blue-200">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold text-blue-700">Spesialisasi:</span><br>
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-blue-200 shadow-xl hover:shadow-2xl hover:border-blue-300 transform hover:-translate-y-2 transition-all duration-500">
                        ...
                        <div class="text-center">
                            <!-- Avatar -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                KA
                            </div>

                            <!-- Info -->
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Ir. Kurnia Anggriani,S.T.,M.T.,Ph.D.</h3>
                            <p class="text-indigo-600 font-semibold mb-3">Tim Pengembang</p>
                            <p class="text-gray-600 text-sm mb-4">NIDN: 0018018902</p>

                            <!-- Specialization -->
                            <div class="bg-indigo-50 rounded-xl p-4 border border-indigo-200">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold text-indigo-700">Spesialisasi:</span><br>
                                    Teknologi & Manajemen
                                </p>
                            </div>
                        </div>
                    ...
                    <!-- Tim Member 3 -->
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-blue-200 shadow-xl hover:shadow-2xl hover:border-blue-300 transform hover:-translate-y-2 transition-all duration-500 md:col-span-2 lg:col-span-1">
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-t-2xl"></div>

                        <div class="text-center">
                            <!-- Avatar -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                G
                            </div>

                            <!-- Info -->
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Dr. Gushevinalti, S.Sos., M.Si.</h3>
                            <p class="text-purple-600 font-semibold mb-3">Tim Pengembang</p>
                            <p class="text-gray-600 text-sm mb-4">NIDN: 0016087804</p>

                            <!-- Specialization -->
                            <div class="bg-purple-50 rounded-xl p-4 border border-purple-200">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold text-purple-700">Spesialisasi:</span><br>
                                    Sosial & Masyarakat
                                </p>
                            </div>
                        </div>
                ...
                <!-- Deskripsi Project -->
                <div class="mt-12 lg:mt-16 bg-white/80 backdrop-blur-md rounded-2xl p-8 border-2 border-blue-200 shadow-xl">
                    <div class="text-center mb-6">
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">Deskripsi Project</h3>
                        <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-indigo-500 mx-auto rounded-full"></div>
                    </div>

                    <div class="text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
                        <p class="text-lg mb-6">
                            Sistem ini dirancang sebagai platform digital yang mendukung proses digitalisasi dan pelestarian aset seni dan budaya lokal Bengkulu yang tersimpan di Museum BDARU.
                        </p>

                        <p class="text-base">
                            Sistem ini berfungsi sebagai wadah pendokumentasian, katalogisasi, dan penyebaran informasi secara daring terkait koleksi budaya yang dimiliki oleh museum, sehingga dapat diakses oleh masyarakat luas, peneliti, dan generasi muda secara mudah dan berkelanjutan.
                        </p>
                    </div>
                </div>
            </div>
...
const initTimeline = () => {
    const timelineItems = document.querySelectorAll('.flex.items-start.space-x-4');
...
const initTeamEffects = () => {
    const teamCards = document.querySelectorAll('.bg-gradient-to-br');
...
onMounted(() => {
    ...
    setTimeout(initTeamEffects, 1500);
    setTimeout(initValuesInteraction, 2000);
