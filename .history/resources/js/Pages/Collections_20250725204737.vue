...
<template>
    ...
    <!-- Mobile Menu Overlay -->
    <div v-if="mobileMenuOpen" class="fixed inset-0 z-[60] flex">
        <!-- Backdrop -->
        <div class="fixed inset-0 bg-black/30 backdrop-blur-sm transition-opacity" @click="mobileMenuOpen = false"></div>
        <!-- Slide-in Menu -->
        <div class="relative bg-white w-4/5 max-w-xs h-full shadow-xl p-6 flex flex-col space-y-6 animate-slide-in-left">
            <!-- Navigation Links -->
