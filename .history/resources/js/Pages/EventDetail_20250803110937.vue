            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-200">
                        ...
                        <div v-if="event.image_url && !imageLoaded" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse rounded-2xl">
...
const imageLoaded = ref(props.event.image_url ? false : true); // If no image, set to true immediately

// Debug: Log event data
console.log('Event data received:', props.event);
console.log('Event image_url:', props.event.image_url);

function handleImageError(event) {
            // Try to use a fallback image based on event ID
        const eventId = event.value?.id;
        const fallbackIndex = eventId ? (eventId % 6) + 1 : 1;
        event.target.src = `/storage/events/event-${fallbackIndex}.jpg`;
}
