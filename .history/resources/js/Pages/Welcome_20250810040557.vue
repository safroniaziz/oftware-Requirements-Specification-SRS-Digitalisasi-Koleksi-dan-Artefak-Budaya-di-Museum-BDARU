...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="py-16 bg-gradient-to-br from-blue-50 via-white to-emerald-50 relative overflow-hidden">
            <div class="absolute inset-0">
                <!-- Background Elements -->
                <div class="absolute top-0 left-0 w-72 h-72 bg-blue-200/20 rounded-full blur-3xl animate-float-slow"></div>
                <div class="absolute bottom-0 right-0 w-56 h-56 bg-emerald-200/20 rounded-full blur-3xl animate-float-medium"></div>
            </div>

            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="text-center mb-12">
                    <div class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-emerald-100 text-blue-800 rounded-full border-2 border-blue-200 mb-6 group hover:bg-gradient-to-r hover:from-blue-200 hover:to-emerald-200 transition-all duration-300 shadow-lg">
                        <div class="w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse"></div>
                        <span class="text-sm font-bold">🤝 Didukung Oleh</span>
                    </div>

                    <h2 class="text-3xl md:text-5xl font-black mb-6 leading-tight">
                        <span class="bg-gradient-to-r from-blue-700 via-emerald-700 to-teal-700 bg-clip-text text-transparent animate-gradient">
                            Mitra & Pendukung
                        </span>
                    </h2>

                    <p class="text-lg md:text-xl text-gray-700 font-medium max-w-3xl mx-auto leading-relaxed">
                        Museum digital ini didukung oleh berbagai institusi terkemuka untuk 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 border-blue-200/50 hover:bg-white hover:border-blue-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl text-center">
                        <div class="w-20 h-20 mx-auto mb-4 rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <img
                                ...
                                @error="$event.target.style.display='none'; $event.target.nextElementSibling.style.display='flex'"
                            />
                            <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-emerald-500 rounded-xl flex items-center justify-center text-white font-bold text-lg" style="display: none;">
                                K
                            </div>
                        </div>
                        <h3 class="text-sm font-bold text-gray-800 mb-2 leading-tight">Kementerian Pendidikan Tinggi, Sains, dan Teknologi Republik Indonesia</h3>
                        <p class="text-xs text-gray-600">Kemendikbud Ristek</p>
                    </div>

                    <!-- DPPM Kemdiktisaintek -->
                    <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 border-emerald-200/50 hover:bg-white hover:border-emerald-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl text-center">
                        <div class="w-20 h-20 mx-auto mb-4 rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <img
                                ...
                                @error="$event.target.style.display='none'; $event.target.nextElementSibling.style.display='flex'"
                            />
                            <div class="w-20 h-20 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center text-white font-bold text-lg" style="display: none;">
                                D
                            </div>
                        </div>
                        <h3 class="text-sm font-bold text-gray-800 mb-2 leading-tight">Direktorat Penelitian dan Pengabdian kepada Masyarakat (DPPM)</h3>
                        <p class="text-xs text-gray-600">Kemdiktisaintek</p>
                    </div>

                    <!-- BIMA -->
                    <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 border-teal-200/50 hover:bg-white hover:border-teal-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl text-center">
                        <div class="w-20 h-20 mx-auto mb-4 rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <img
                                ...
                                @error="$event.target.style.display='none'; $event.target.nextElementSibling.style.display='flex'"
                            />
                            <div class="w-20 h-20 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center text-white font-bold text-lg" style="display: none;">
                                B
                            </div>
                        </div>
                        <h3 class="text-sm font-bold text-gray-800 mb-2 leading-tight">Basis Informasi Penelitian dan Pengabdian kepada Masyarakat</h3>
                        <p class="text-xs text-gray-600">BIMA</p>
                    </div>

                    <!-- Universitas Bengkulu -->
                    <div class="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 border-cyan-200/50 hover:bg-white hover:border-cyan-300 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 shadow-lg hover:shadow-xl text-center">
                        <div class="w-20 h-20 mx-auto mb-4 rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <img
                                ...
                                @error="$event.target.style.display='none'; $event.target.nextElementSibling.style.display='flex'"
                            />
                            <div class="w-20 h-20 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center text-white font-bold text-lg" style="display: none;">
                                U
                            </div>
                        </div>
                        <h3 class="text-sm font-bold text-gray-800 mb-2 leading-tight">Universitas Bengkulu</h3>
                        <p class="text-xs text-gray-600">UNIB</p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600 max-w-2xl mx-auto">
                        Kerjasama strategis dengan berbagai institusi pendidikan dan penelitian untuk mewujudkan pelestarian budaya Indonesia melalui teknologi digital yang inovatif dan berkelanjutan.
                    </p>
                </div>
            </div>
        </section>
        ...
        <footer class="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div class="border-t border-gray-800 mt-12 pt-8 mb-8">
                    <div class="text-center mb-6">
                        <h4 class="text-gray-300 text-sm font-semibold mb-4">Didukung Oleh:</h4>
                        <div class="flex justify-center items-center space-x-6 md:space-x-8 flex-wrap gap-y-4">
                            <!-- Kemdiktisaintek Logo -->
                            <div class="flex items-center space-x-2 opacity-70 hover:opacity-100 transition-opacity duration-300">
                                <img
                                    src="/assets/assets/media/kemdiktisaintek.jpeg"
                                    alt="Kemdiktisaintek"
                                ...
                                />
                                <span class="text-gray-400 text-xs hidden sm:inline">Kemendikbud Ristek</span>
                            </div>
                            ...
                            <div class="flex items-center space-x-2 opacity-70 hover:opacity-100 transition-opacity duration-300">
                                <img
                                    ...
                                    @error="$event.target.style.display='none'"
                                />
                                <span class="text-gray-400 text-xs hidden sm:inline">DPPM</span>
                            </div>
                            ...
                            <div class="flex items-center space-x-2 opacity-70 hover:opacity-100 transition-opacity duration-300">
                                <img
                                    ...
                                    @error="$event.target.style.display='none'"
                                />
                                <span class="text-gray-400 text-xs hidden sm:inline">BIMA</span>
                            </div>
                            ...
                            <div class="flex items-center space-x-2 opacity-70 hover:opacity-100 transition-opacity duration-300">
                                <img
                                    ...
                                    @error="$event.target.style.display='none'"
                                />
                                <span class="text-gray-400 text-xs hidden sm:inline">UNIB</span>
                            </div>
                        </div>
                    </div>
                </div>
