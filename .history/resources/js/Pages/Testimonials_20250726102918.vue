        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div v-if="props.testimonials && props.testimonials.data && props.testimonials.data.length > 0" class="mt-8">
                ...
                <div class="mb-2 text-xs text-gray-400">
                    Debug: Total {{ props.testimonials.total }}, Current {{ props.testimonials.current_page }}, Next URL: {{ props.testimonials.next_page_url ? 'ADA' : 'TIDAK ADA' }}, Prev URL: {{ props.testimonials.prev_page_url ? 'ADA' : 'TIDAK ADA' }}
                </div>
                <div class="mb-2 text-xs text-gray-400">
                    Debug URLs: Prev = "{{ props.testimonials.prev_page_url }}", Next = "{{ props.testimonials.next_page_url }}"
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <button
                            ...
                            class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 cursor-pointer"
                        >
                            ← Sebelumnya
                        </button>
                        ...
                        <button
                            ...
                            class="px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 hover:shadow-lg transform hover:scale-105 transition-all duration-200 cursor-pointer"
                        >
                            Selanjutnya →
                        </button>
