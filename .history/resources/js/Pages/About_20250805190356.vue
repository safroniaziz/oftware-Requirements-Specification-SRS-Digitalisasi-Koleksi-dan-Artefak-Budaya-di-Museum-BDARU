        ...
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">
                        Dibalik BDARU ada tim yang berdedikasi tinggi dalam melestarikan warisan budaya Indonesia melalui teknologi digital.
                    </p>
                </div>
                    ...
                    <div
                        ...
                        :key="member.id"
                        class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
                    >
                        <div class="w-24 h-24 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 mx-auto mb-4 shadow-lg flex items-center justify-center">
                            <span class="text-white font-bold text-2xl">{{ member.name.substring(0, 2).toUpperCase() }}</span>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">{{ member.name }}</h3>
                        <p class="text-emerald-600 font-semibold mb-3">{{ member.position }}</p>
                        <p class="text-gray-600 text-sm">
                            {{ member.description }}
                        </p>
                        <div class="flex justify-center space-x-3 mt-4">
                            <a v-if="member.email" :href="`mailto:${member.email}`" class="text-emerald-600 hover:text-emerald-800 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                                </svg>
                            </a>
                            <a v-if="member.linkedin" :href="member.linkedin" target="_blank" class="text-emerald-600 hover:text-emerald-800 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                            <a v-if="member.twitter" :href="member.twitter" target="_blank" class="text-emerald-600 hover:text-emerald-800 transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
