...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
                                        <!-- Fixed Logo Bar -->
        <div class="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md shadow-lg border-b border-gray-100 z-50">
        ...
        <nav class="sticky top-20 bg-white/95 backdrop-blur-md shadow-lg border-b border-gray-100 z-40">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
