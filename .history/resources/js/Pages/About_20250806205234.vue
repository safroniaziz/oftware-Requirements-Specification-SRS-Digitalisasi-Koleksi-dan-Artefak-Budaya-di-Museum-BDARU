<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="py-16 lg:py-24 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
            <!-- Subtle Background Elements -->
            <div class="absolute inset-0">
                <div class="absolute top-0 left-0 w-64 h-64 bg-emerald-200/30 rounded-full blur-3xl animate-float-slow"></div>
                <div class="absolute bottom-0 right-0 w-80 h-80 bg-teal-200/30 rounded-full blur-3xl animate-float-medium"></div>
                <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-cyan-200/30 rounded-full blur-3xl animate-float-fast"></div>
            </div>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-12 lg:mb-16">
                    ...
                    <div class="mt-6 p-4 bg-white/80 backdrop-blur-md rounded-2xl border border-emerald-200 shadow-lg max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                    <!-- Tim Member 1 - Tiara -->
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-emerald-200 shadow-xl hover:shadow-2xl hover:border-emerald-300 transform hover:-translate-y-2 transition-all duration-500">
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-t-2xl"></div>

                        <div class="text-center">
                            <!-- Avatar -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                TP
                            </div>

                            <!-- Info -->
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Ir. Tiara Eka Putri, S.T.,M.Kom.</h3>
                            <p class="text-emerald-600 font-semibold mb-3">Tim Pengembang</p>
                            <p class="text-gray-600 text-sm mb-4">NIDN: 0419089303</p>

                            <!-- Specialization -->
                            <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-200">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold text-emerald-700">Spesialisasi:</span><br>
                    ...
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-emerald-200 shadow-xl hover:shadow-2xl hover:border-emerald-300 transform hover:-translate-y-2 transition-all duration-500">
                        ...
                        <div class="text-center">
                            <!-- Avatar -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                KA
                            </div>

                            <!-- Info -->
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Ir. Kurnia Anggriani,S.T.,M.T.,Ph.D.</h3>
                            <p class="text-teal-600 font-semibold mb-3">Tim Pengembang</p>
                            <p class="text-gray-600 text-sm mb-4">NIDN: 0018018902</p>

                            <!-- Specialization -->
                            <div class="bg-teal-50 rounded-xl p-4 border border-teal-200">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold text-teal-700">Spesialisasi:</span><br>
                                    Teknologi & Manajemen
                                </p>
                            </div>
                        </div>
                    ...
                    <!-- Tim Member 3 - Gushevinalti -->
                    <div class="group relative bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-emerald-200 shadow-xl hover:shadow-2xl hover:border-emerald-300 transform hover:-translate-y-2 transition-all duration-500 md:col-span-2 lg:col-span-1">
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-2xl"></div>

                        <div class="text-center">
                            <!-- Avatar -->
                            <div class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                                GS
                            </div>

                            <!-- Info -->
                            <h3 class="text-xl font-bold text-gray-900 mb-2">Dr. Gushevinalti, S.Sos., M.Si.</h3>
                            <p class="text-cyan-600 font-semibold mb-3">Tim Pengembang</p>
                            <p class="text-gray-600 text-sm mb-4">NIDN: 0016087804</p>

                            <!-- Specialization -->
                            <div class="bg-cyan-50 rounded-xl p-4 border border-cyan-200">
                                <p class="text-sm text-gray-700">
                                    <span class="font-semibold text-cyan-700">Spesialisasi:</span><br>
                                    Sosial & Masyarakat
                                </p>
                            </div>
                        </div>
                ...
                <!-- Project Description -->
                <div class="mt-12 lg:mt-16 bg-white/80 backdrop-blur-md rounded-2xl p-8 border-2 border-emerald-200 shadow-xl">
