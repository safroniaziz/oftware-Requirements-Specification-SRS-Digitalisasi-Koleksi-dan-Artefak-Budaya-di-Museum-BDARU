                ...
                >
                    <div class="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 shadow-lg">
                        <img
                            ...
                            @load="console.log('Image loaded:', member.name, member.photo)"
                            @error="console.log('Image error:', member.name, member.photo); $event.target.src = `https://ui-avatars.com/api/?name=${member.name.substring(0, 2).toUpperCase()}&background=10b981&color=fff&size=128&bold=true`"
                        />
                    </div>
