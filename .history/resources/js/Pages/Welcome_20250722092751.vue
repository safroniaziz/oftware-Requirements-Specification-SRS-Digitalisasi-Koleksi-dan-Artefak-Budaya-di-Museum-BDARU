        ...
        <section class="py-16 bg-gradient-to-br from-white via-emerald-50 to-teal-100 relative overflow-hidden">
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    <!-- Koleksi Digital -->
                    <div class="group relative bg-white/95 backdrop-blur-md rounded-2xl p-6 border border-emerald-200/50 hover:border-emerald-300 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <!-- Kategori Budaya -->
                    <div class="group relative bg-white/95 backdrop-blur-md rounded-2xl p-6 border border-teal-200/50 hover:border-teal-300 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <!-- Kunjungan -->
                    <div class="group relative bg-white/95 backdrop-blur-md rounded-2xl p-6 border border-cyan-200/50 hover:border-cyan-300 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
