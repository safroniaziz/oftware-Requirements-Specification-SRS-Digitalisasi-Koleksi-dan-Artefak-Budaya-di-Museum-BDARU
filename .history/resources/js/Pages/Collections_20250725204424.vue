...
<template>
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center group">
                    ...
                    <Link href="/" class="flex items-center space-x-2">
                        <img src="/images/hero/logo.png" alt="Logo" class="h-10 w-auto" />
                        <span class="font-bold text-lg text-emerald-700">Museum</span>
                    </Link>
                </div>
                <!-- Desktop Auth Buttons -->
                <div class="hidden lg:flex items-center space-x-4">
                    <Link v-if="canLogin" :href="route('login')" class="px-4 py-2 rounded-lg font-semibold text-emerald-700 hover:bg-emerald-50 transition">Login</Link>
                    <Link v-if="canRegister" :href="route('register')" class="px-4 py-2 rounded-lg font-semibold text-white bg-emerald-600 hover:bg-emerald-700 transition">Register</Link>
                </div>
                <!-- Mobile Hamburger Menu Button -->
                <div class="lg:hidden">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-emerald-600 hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-emerald-500 transition-all duration-300">
    ...
    <!-- Mobile Menu Overlay -->
    <div v-if="mobileMenuOpen" class="fixed inset-0 z-[60] flex lg:hidden">
        <div class="fixed inset-0 bg-black/40 backdrop-blur-sm" @click="mobileMenuOpen = false"></div>
        <div class="relative bg-white w-4/5 max-w-xs h-full shadow-xl p-6 flex flex-col">
            <nav class="flex-1 space-y-2 mt-8">
                <Link href="/" class="block px-4 py-3 rounded-lg font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Beranda</Link>
                <Link href="/collections" class="block px-4 py-3 rounded-lg font-semibold text-emerald-600 bg-emerald-50 transition" @click="mobileMenuOpen = false">Koleksi Budaya</Link>
                <Link href="/news" class="block px-4 py-3 rounded-lg font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Berita Terbaru</Link>
                <Link href="/events" class="block px-4 py-3 rounded-lg font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Agenda</Link>
                <Link href="/contact" class="block px-4 py-3 rounded-lg font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Kontak</Link>
                <Link href="/about" class="block px-4 py-3 rounded-lg font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Profil</Link>
                <Link href="/testimonials" class="block px-4 py-3 rounded-lg font-semibold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition" @click="mobileMenuOpen = false">Testimoni</Link>
            </nav>
            <div class="mt-8 flex flex-col space-y-2">
                <Link v-if="canLogin" :href="route('login')" class="block w-full px-4 py-2 rounded-lg font-semibold text-emerald-700 border border-emerald-600 text-center hover:bg-emerald-50 transition">Login</Link>
                <Link v-if="canRegister" :href="route('register')" class="block w-full px-4 py-2 rounded-lg font-semibold text-white bg-emerald-600 text-center hover:bg-emerald-700 transition">Register</Link>
            </div>
        </div>
    </div>
    ...
    <!-- Hero Section (atur margin top agar tidak ketutup navbar) -->
    <div :class="{ 'mt-20': !mobileMenuOpen, 'mt-0': mobileMenuOpen }">
