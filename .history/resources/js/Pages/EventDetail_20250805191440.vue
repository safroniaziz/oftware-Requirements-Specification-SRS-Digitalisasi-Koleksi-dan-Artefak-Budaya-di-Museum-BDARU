                ...
                <div class="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div class="w-full lg:w-1/2">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl bg-gray-200">
                            ...
                            <!-- Featured Badge -->
                            <div v-if="event.is_featured" class="absolute top-4 left-4">
                            ...
                            <div class="absolute bottom-4 left-4">
                                <div class="flex items-center space-x-2 bg-black/50 backdrop-blur-sm rounded-full px-3 py-1">
                                    ...
                                    <span class="text-white text-sm font-medium">{{ formatPrice(event.price) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <nav class="flex items-center justify-center lg:justify-start space-x-2 mb-6">
                            ...
                            <Link href="/events" class="text-emerald-300 hover:text-white transition-colors">Agenda</Link>
                            <span class="text-emerald-300">/</span>
                        ...
                        <!-- Description -->
                        <p class="text-xl text-emerald-100 mb-6">{{ event.description }}</p>

                        <!-- Price -->
                        <div class="flex items-center justify-center lg:justify-start space-x-2 mb-6">
                            <span class="text-emerald-200">({{ formatPrice(event.price) }})</span>
                        </div>

                        <!-- Quick Info -->
                        <div class="grid grid-cols-2 gap-4 mb-8">
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Tanggal Event</div>
                                <div class="text-white font-bold">{{ formatDate(event.event_date) }}</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Jenis</div>
                                <div class="text-white font-bold">{{ getEventTypeLabel(event.type) }}</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Waktu</div>
                                <div class="text-white font-bold">{{ formatTime(event.start_time) }} - {{ formatTime(event.end_time) }}</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Lokasi</div>
                                <div class="text-white font-bold">{{ event.location }}</div>
                            </div>
                        </div>
