    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <nav class="bg-white/95 backdrop-blur-md shadow-xl border-b border-gray-100 sticky top-0 z-50">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="w-full bg-gradient-to-r from-gray-50 to-blue-50/50 border-t border-gray-100">
                    <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                                                                        <div class="flex justify-between items-center py-4">
                            <div class="flex items-center space-x-6">
                                <Link
                                    href="/"
                                    class="relative px-3 py-2 text-blue-600 font-semibold rounded-lg bg-blue-50 border border-blue-200 transition-all duration-300 group"
                                >
                                    <span class="relative z-10 flex items-center space-x-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="absolute inset-0 bg-blue-100 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                </Link>
                                <Link
                                    href="/collections"
