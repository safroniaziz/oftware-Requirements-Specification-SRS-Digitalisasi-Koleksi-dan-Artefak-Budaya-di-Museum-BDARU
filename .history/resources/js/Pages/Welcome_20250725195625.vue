...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div
            :class="{ 'block': mobileMenuOpen, 'hidden': !mobileMenuOpen }"
            class="lg:hidden fixed top-20 left-0 right-0 bg-white/98 backdrop-blur-xl border-b border-gray-200/50 shadow-lg z-40"
        >
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="py-4">
                    <div class="space-y-2">
                        ...
                        <div class="space-y-3 px-4">
                            <Link
                                v-if="canLogin"
                                :href="route('login')"
                                class="group flex items-center justify-center px-6 py-3 text-gray-700 font-bold rounded-xl border-2 border-gray-200 hover:border-emerald-400 hover:text-emerald-600 transition-all duration-300"
                                @click="mobileMenuOpen = false"
                            >
                            ...
                            <Link
                                v-if="canRegister"
                                :href="route('register')"
                                class="group flex items-center justify-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-lg hover:shadow-emerald-500/25 transform hover:scale-105 transition-all duration-300"
                                @click="mobileMenuOpen = false"
                            >
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
