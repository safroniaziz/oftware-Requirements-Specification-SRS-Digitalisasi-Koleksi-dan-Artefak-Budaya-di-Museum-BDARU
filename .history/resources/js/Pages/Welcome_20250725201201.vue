        ...
        <div class="fixed top-0 left-0 right-0 bg-white/98 backdrop-blur-xl border-b border-gray-200/50 shadow-lg z-50">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    ...
                    <!-- Enhanced Auth Buttons - Hidden on mobile, shown on desktop -->
        ...
        <div class="w-full mt-20 bg-white/95 backdrop-blur-lg border-b border-gray-200/50 shadow-sm">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-center items-center py-6 relative">
                    ...
                    <div
                        :class="{ 'block': mobileMenuOpen, 'hidden': !mobileMenuOpen }"
                        class="lg:hidden border-t border-gray-200 bg-white/95 backdrop-blur-lg"
                    >
                        <div class="px-6 py-8">
                            <!-- Navigation Links -->
                            <div class="space-y-1 mb-8">
                                ...
                                <Link
                                    href="/"
                                    class="flex items-center px-4 py-4 text-emerald-700 font-semibold rounded-xl bg-emerald-50 border border-emerald-100 transition-all duration-300 group"
                                    @click="mobileMenuOpen = false"
                                >
                                    <div class="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center mr-4 group-hover:bg-emerald-200 transition-colors duration-300">
                                    ...
                                    <div>
                                        <div class="text-base font-semibold text-emerald-700">Beranda</div>
                                        <div class="text-xs text-emerald-500">Halaman Utama</div>
                                    </div>
                                    <svg class="w-4 h-4 text-emerald-400 ml-auto group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <Link
                                    href="/collections"
                                    class="flex items-center px-4 py-4 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all duration-300 group"
                                    @click="mobileMenuOpen = false"
                                >
                                    <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center mr-4 group-hover:bg-emerald-100 transition-colors duration-300">
                                        <svg class="w-5 h-5 text-gray-600 group-hover:text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <div class="text-base font-semibold">Koleksi</div>
                                        <div class="text-xs text-gray-500">Galeri Digital</div>
                                    </div>
                                    <svg class="w-4 h-4 text-gray-400 ml-auto group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                </Link>
                                ...
                                >
                                    ...
                                    <div>
                                        <div class="text-base font-semibold">Berita</div>
                                        <div class="text-xs text-gray-500">Informasi Terkini</div>
                                    </div>
                                    <svg class="w-4 h-4 text-gray-400 ml-auto group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                ...
                                >
                                    ...
                                    <div>
                                        <div class="text-base font-semibold">Agenda</div>
                                        <div class="text-xs text-gray-500">Kegiatan & Event</div>
                                    </div>
                                    <svg class="w-4 h-4 text-gray-400 ml-auto group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                ...
                                >
                                    ...
                                    <div>
                                        <div class="text-base font-semibold">Kontak</div>
                                ...
                                >
                                    ...
                                    <div>
                                        <div class="text-base font-semibold">Profil</div>
                                        <div class="text-xs text-gray-500">Tentang Kami</div>
                                    </div>
                                    <svg class="w-4 h-4 text-gray-400 ml-auto group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                ...
                                >
                                    ...
                                    <div>
                                        <div class="text-base font-semibold">Testimoni</div>
                                        <div class="text-xs text-gray-500">Ulasan Pengunjung</div>
                                    </div>
                                    <svg class="w-4 h-4 text-gray-400 ml-auto group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                            ...
                            <!-- Auth Section -->
                            <div class="space-y-4">
                                <div class="text-sm font-semibold text-gray-900 mb-4">Akun</div>

                                <!-- Login Button -->
                                <Link
                                    v-if="canLogin"
                                    :href="route('login')"
                                    class="flex items-center justify-center px-6 py-4 text-gray-700 font-semibold rounded-xl border-2 border-gray-200 hover:border-emerald-400 hover:text-emerald-600 hover:bg-emerald-50 transition-all duration-300 group"
                                    @click="mobileMenuOpen = false"
                                >
                                ...
                                <Link
                                    v-if="canRegister"
                                    :href="route('register')"
                                    class="flex items-center justify-center px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-emerald-500/25 transform hover:scale-105 transition-all duration-300 group"
                                    @click="mobileMenuOpen = false"
                                >
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
