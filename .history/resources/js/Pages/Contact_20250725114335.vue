                                ...
                                <div>
                                    ...
                                    <div class="space-y-1">
                                        <p class="text-gray-600" v-if="props.museumSettings?.opening_hours">
                                            <span v-for="(hours, day) in JSON.parse(props.museumSettings.opening_hours)" :key="day" class="block">
                                                {{ day.charAt(0).toUpperCase() + day.slice(1) }}:
                                                <span :class="hours === 'Tutup' ? 'font-semibold text-red-500' : 'font-semibold text-blue-600'">
                                                    {{ hours }}
                                                </span>
                                            </span>
                                        </p>
...
const initMap = () => {
    ...
    nextTick(() => {
        ...
        const museumIcon = L.divIcon({
            ...
            html: `
                <div class="museum-marker-simple">
                    <div class="marker-pin" style="background: #ff0000 !important; border: none !important; box-shadow: 0 6px 20px rgba(255, 0, 0, 0.4) !important;">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: white !important;">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        </svg>
                    </div>
                    <div class="marker-dot" style="background: #ff0000 !important; border: none !important;"></div>
                </div>
            `,
            iconSize: [48, 48],
            iconAnchor: [24, 48],
            ...
            <div class="museum-popup">
                ...
                <div class="popup-content">
                    ...
                    <div class="popup-actions">
                        <button onclick="window.open('tel:${props.museumSettings?.phone_1 || '+62213868172'}', '_self')" class="popup-btn phone-btn">
        ...
        // Add click event to marker for enhanced interaction
...
.marker-dot {
    ...
    border-radius: 50%;
    border: none !important;
    box-shadow: 0 3px 10px rgba(255, 0, 0, 0.5) !important;
