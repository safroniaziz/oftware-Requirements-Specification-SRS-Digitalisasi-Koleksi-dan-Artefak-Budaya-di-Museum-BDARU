<template>
    <Head :title="`${props.event?.title || 'Event'} - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Balai Adat Rajo Penghulu'}`" />
    ...
    <div class="min-h-screen bg-gray-50">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full border-2 border-emerald-200 mb-6 group hover:bg-gradient-to-r hover:from-emerald-200 hover:to-teal-200 transition-all duration-300 shadow-lg">
                            ...
                            <span class="text-sm font-bold">📅 Detail Agenda</span>
                        </div>
                        ...
                        <h1 class="text-3xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
                            <span class="bg-gradient-to-r from-emerald-700 via-teal-700 to-cyan-700 bg-clip-text text-transparent animate-gradient">
                                {{ props.event?.title || 'Detail Agenda' }}
                            </span>
                        </h1>

                        <!-- Enhanced Subtitle -->
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0">
                            {{ props.event?.description || 'Temukan detail lengkap tentang agenda kegiatan ini. Dapatkan informasi waktu, lokasi, dan deskripsi kegiatan yang akan diselenggarakan.' }}
                        </p>

                        <!-- Enhanced CTA Buttons -->
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#event-detail" class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
                                ...
                                <div class="absolute inset-4 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <div class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white p-4 rounded-t-2xl">
                                        <div class="text-center">
                                            <h3 class="text-xl font-bold">Detail Agenda</h3>
                                    ...
                                    <div class="p-4 space-y-3">
                                        <div class="flex items-center space-x-3 p-2 bg-emerald-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">Tanggal & Waktu</p>
                                                <p class="text-xs text-gray-600">{{ props.event?.start_date || 'TBA' }}</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3 p-2 bg-teal-50 rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600">{{ props.event?.location || 'TBA' }}</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3 p-2 bg-cyan-50 rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600">{{ props.event?.status || 'TBA' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- Main Content -->
        <section class="py-16 bg-gradient-to-br from-gray-50 via-white to-emerald-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    <!-- Article Content -->
                    <div class="lg:col-span-3">
                        <!-- Event Body -->
                        <article v-if="event.content" class="prose prose-lg max-w-none">
                            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8 mb-8">
                                <div v-html="event.content" class="text-gray-700 leading-relaxed"></div>
                            </div>
                        </article>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-4">
                                    <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                        ...
                                        <div>
                                            <span class="text-sm text-gray-600">Jenis Event</span>
                                            <div class="text-sm font-semibold text-gray-900">{{ getEventTypeLabel(event.type) }}</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">{{ formatDate(event.event_date) }}</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">{{ formatTime(event.start_time) }} - {{ formatTime(event.end_time) }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="space-y-4">
                                    <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">{{ event.location }}</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">{{ event.organizer }}</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">{{ formatPrice(event.price) }}</div>
                                        </div>
                                    </div>
                                    <div v-if="event.is_featured" class="flex items-center space-x-3 p-4 bg-yellow-50 rounded-xl border border-yellow-100">
                                        <svg class="w-5 h-5 text-yellow-600" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                        </svg>
                                        <div>
                                            <span class="text-sm text-gray-600">Status</span>
                                            <div class="text-sm font-semibold text-yellow-700">Event Unggulan</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">{{ props.museumSettings?.email_info || 'Belum tersedia' }}</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">{{ props.museumSettings?.phone_1 || 'Belum tersedia' }}</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">{{ props.museumSettings?.address || 'Belum tersedia' }}, {{ props.museumSettings?.city || 'Belum tersedia' }}</div>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm font-semibold text-gray-900">09:00 - 17:00 WIB</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8 mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <Link href="/collections" class="group p-4 bg-emerald-50 rounded-xl border border-emerald-100 hover:bg-emerald-100 transition-all duration-300">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                        </svg>
                                        <span class="text-sm font-semibold text-gray-900 group-hover:text-emerald-600">Koleksi Budaya</span>
                                    </div>
                                </Link>
                                <Link href="/news" class="group p-4 bg-emerald-50 rounded-xl border border-emerald-100 hover:bg-emerald-100 transition-all duration-300">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
                                        </svg>
                                        <span class="text-sm font-semibold text-gray-900 group-hover:text-emerald-600">Latest News</span>
                                    </div>
                                </Link>
                                <Link href="/about" class="group p-4 bg-emerald-50 rounded-xl border border-emerald-100 hover:bg-emerald-100 transition-all duration-300">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-sm font-semibold text-gray-900 group-hover:text-emerald-600">Tentang Museum</span>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        ...
                        <!-- Related Events -->
                        <div v-if="relatedEvents.length > 0" class="mt-12">
                            <h3 class="text-2xl font-bold text-gray-900 mb-6">Event Terkait</h3>
                    ...
                    <div class="lg:col-span-1">
                        <!-- Recent Events -->
                        <div v-if="recentEvents && recentEvents.length > 0" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
                            ...
                            <div class="space-y-4">
                                <article v-for="event in recentEvents" :key="event.id" class="group">
                                    <Link :href="`/events/${event.id}`" class="block">
                                        <div class="flex items-start space-x-3">
                                            <div class="relative w-16 h-12 rounded-lg flex-shrink-0 bg-gray-200 overflow-hidden">
                                                <!-- Loading State for Small Images -->
                                                <div class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse"></div>
                                                <img
                                                    v-if="event.image_url"
                                                    :src="event.image_url"
                                                    :alt="event.title"
                                                ...
                                                <div
                                                    v-else
                                                    class="w-full h-full bg-gradient-to-br from-emerald-100 to-teal-100 flex items-center justify-center relative z-10"
                                                >
                                                    <div class="text-center">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-gray-500 mt-1">{{ formatDate(event.event_date) }}</p>
                                            </div>
                                        </div>
                                    </Link>
                                </article>
                        ...
                        <div v-else class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
                            <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center">
                                <svg class="w-5 h-5 text-emerald-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                </svg>
                        ...
                        <div class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-100">
                            <h3 class="text-lg font-bold text-gray-900 mb-4">Kembali ke Agenda</h3>
                            <p class="text-gray-600 text-sm mb-4">Jelajahi kegiatan lainnya dari Museum Digital Balai Adat Rajo Penghulu.</p>
                            <Link
                                href="/events"
...
function getEventStatusLabel(status) {
    ...
    return labels[status] || 'Akan Datang';
}
