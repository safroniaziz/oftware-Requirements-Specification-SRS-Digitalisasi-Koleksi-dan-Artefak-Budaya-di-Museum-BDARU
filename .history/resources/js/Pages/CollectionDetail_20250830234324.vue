...
console.log('Gallery Images:', props.collection.galleryImages);
console.log('Gallery Images count:', props.collection.galleryImages?.length);
console.log('Gallery Images type:', typeof props.collection.galleryImages);
