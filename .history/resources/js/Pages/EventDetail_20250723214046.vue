            ...
            <div class="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-8">
                                ...
                                <div class="text-emerald-300 text-sm font-medium">Event Date</div>
                                <div class="text-white font-bold">{{ formatDate(event.event_date) }}</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Type</div>
                                <div class="text-white font-bold">{{ getEventTypeLabel(event.type) }}</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Time</div>
                                <div class="text-white font-bold">{{ formatTime(event.start_time) }} - {{ formatTime(event.end_time) }}</div>
                            </div>
                            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                                <div class="text-emerald-300 text-sm font-medium">Location</div>
