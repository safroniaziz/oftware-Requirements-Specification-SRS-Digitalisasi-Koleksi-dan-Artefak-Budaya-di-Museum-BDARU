...
const showQrCode = (collection) => {
    console.log('Show QR Code for collection:', collection.name);
    console.log('QR Code data:', collection.latest_qr_code);
...
onMounted(() => {
    // Debug QR code data
    console.log('Collections data:', collectionsData.value);
    collectionsData.value.forEach((collection, index) => {
        console.log(`Collection ${index}:`, {
            name: collection.name,
            latest_qr_code: collection.latest_qr_code,
            qr_image_url: collection.latest_qr_code?.qr_image_url
        });
    });
