                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center gap-8 text-center" data-aos="fade-up" data-aos-delay="1000">
                        ...
                        <div class="group hover:scale-110 transition-transform duration-300" data-aos="zoom-in" data-aos-delay="1600">
                            <div class="text-3xl font-black text-cyan-300">5K+</div>
                            <div class="text-sm text-cyan-200 font-semibold">Pembaca</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div v-if="viewMode === 'grid'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    >
                        ...
                        <div class="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                            <!-- Loading State -->
                            <div v-if="imageLoadingStates[news.id] !== false" class="absolute inset-0 bg-gradient-to-r from-gray-200 to-gray-300 animate-pulse rounded-t-2xl">
                            ...
                            <img
                                ...
                                @loadstart="startImageLoading(news.id)"
                            >
