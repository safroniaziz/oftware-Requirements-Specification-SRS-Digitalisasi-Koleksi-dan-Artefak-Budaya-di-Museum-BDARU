<template>
        ...
        <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <div class="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-md text-white rounded-full border border-white/20 mb-8 group hover:bg-white/20 transition-all duration-300">
                    ...
                    <span class="text-sm font-bold">📰 Berita Terbaru Museum Digital Balai Adat Rajo Penghulu</span>
                </div>
                ...
                <div class="max-w-2xl mx-auto">
                    <div class="relative group">
                        <input
                            ...
                            class="w-full px-6 py-4 pl-14 bg-white/10 backdrop-blur-md text-white placeholder-white/70 border border-white/20 rounded-2xl shadow-2xl focus:border-emerald-400 focus:ring-4 focus:ring-emerald-400/20 transition-all duration-300 group-hover:bg-white/20"
                        >
        ...
        <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <!-- Enhanced News Grid -->
                    <div v-if="news.data.length > 0" class="grid grid-cols-1 gap-8">
                        <article
                            v-for="article in news.data"
                            :key="article.id"
                            class="group relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 transform hover:-translate-y-2"
                        >
                            <div class="flex flex-col lg:flex-row">
                                ...
                                <div class="lg:w-1/3 relative overflow-hidden">
                                    ...
                                    <div v-if="article.is_featured" class="absolute top-4 left-4">
                                        <div class="flex items-center space-x-1 px-3 py-1 bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-full text-xs font-bold shadow-lg">
                                ...
                                <div class="lg:w-2/3 p-6 lg:p-8">
                                    ...
                                    <div class="flex items-center justify-between mb-4">
                                        <div class="flex items-center space-x-3">
                                            <span class="inline-flex items-center px-3 py-1 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-700 rounded-full text-xs font-bold border border-emerald-200">
                                                {{ article.category?.name || 'Berita' }}
                                            </span>
                                            <span class="text-sm text-gray-500 font-medium">{{ formatDate(article.published_at) }}</span>
                                        </div>
                                    </div>

                                    <!-- Enhanced Title -->
                                    <h3 class="text-xl lg:text-2xl font-black text-gray-900 mb-4 leading-tight group-hover:text-emerald-600 transition-colors duration-300">
                                        {{ article.title }}
                                    </h3>
    ...
    <button
        @click="scrollToTop"
        class="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-110 transition-all duration-300 z-50 group"
