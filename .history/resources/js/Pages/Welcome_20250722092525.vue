    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="w-full mt-24 bg-white/95 backdrop-blur-lg border-b border-gray-200/50 shadow-sm">
            <div class="w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Hero Section -->
        <section class="relative py-12 lg:py-16 bg-gradient-to-br from-white via-emerald-50 to-teal-100 overflow-hidden">
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        <!-- Enhanced Badge -->
                        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full border-2 border-emerald-200 mb-6 group hover:bg-gradient-to-r hover:from-emerald-200 hover:to-teal-200 transition-all duration-300 animate-fade-in-up shadow-lg">
                            <div class="w-2 h-2 bg-emerald-500 rounded-full mr-2 animate-pulse"></div>
                            <span class="text-sm font-bold">🏛️ Museum Digital Balai Adat Rajo Penghulu</span>
                        </div>

                        <!-- Enhanced Main Heading -->
                        <h1 class="text-3xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight animate-fade-in-up delay-200">
                        ...
                        <!-- Enhanced Subtitle -->
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0 animate-fade-in-up delay-400">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up delay-600">
                            <Link
                                href="/collections"
                                class="group relative px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden animate-bounce-subtle"
                            >
                    ...
                    <div class="w-full lg:w-1/2 animate-fade-in-up delay-1000">
                        <div class="relative h-64 lg:h-80 rounded-2xl overflow-hidden shadow-2xl bg-gray-200 group animate-float-subtle">
                            <!-- Enhanced Glow Effect -->
        ...
        <section class="py-16 bg-gradient-to-br from-white via-emerald-50 to-teal-100 relative overflow-hidden">
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    <!-- Koleksi Digital -->
                    <div class="group relative bg-gradient-to-br from-white via-emerald-50 to-teal-50 backdrop-blur-xl rounded-3xl p-8 border-2 border-emerald-200/50 hover:border-emerald-400 transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 hover:rotate-1 shadow-2xl hover:shadow-emerald-500/25 overflow-hidden">
                        <!-- Animated Background Elements -->
                        <div class="absolute inset-0 bg-gradient-to-br from-emerald-400/10 to-teal-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                        <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full opacity-20 group-hover:opacity-60 transition-all duration-700 transform group-hover:scale-150 group-hover:rotate-180"></div>
                        <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-full opacity-10 group-hover:opacity-30 transition-all duration-700 transform group-hover:scale-125"></div>

                        <div class="relative z-10">
                            <!-- Enhanced Icon Container -->
                            <div class="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-xl hover:shadow-2xl">
                            ...
                            <div class="text-center">
                                <div class="text-5xl font-black mb-3 text-emerald-700 animate-count-up group-hover:text-emerald-800 transition-colors duration-300" data-target="150">0</div>
                                <div class="text-gray-800 font-bold text-xl mb-2 group-hover:text-emerald-800 transition-colors duration-300">Koleksi Digital</div>
                                <div class="text-gray-600 text-sm font-medium">Artefak & Seni Budaya</div>

                                <!-- Animated Progress Indicator -->
                                <div class="mt-4 w-full bg-gray-200 rounded-full h-1 overflow-hidden">
                                    <div class="h-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 delay-300"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Kategori Budaya -->
                    <div class="group relative bg-gradient-to-br from-white via-teal-50 to-cyan-50 backdrop-blur-xl rounded-3xl p-8 border-2 border-teal-200/50 hover:border-teal-400 transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 hover:-rotate-1 shadow-2xl hover:shadow-teal-500/25 overflow-hidden">
                        <!-- Animated Background Elements -->
                        <div class="absolute inset-0 bg-gradient-to-br from-teal-400/10 to-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                        <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-full opacity-20 group-hover:opacity-60 transition-all duration-700 transform group-hover:scale-150 group-hover:-rotate-180"></div>
                        <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full opacity-10 group-hover:opacity-30 transition-all duration-700 transform group-hover:scale-125"></div>

                        <div class="relative z-10">
                            <!-- Enhanced Icon Container -->
                            <div class="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-3xl mb-6 group-hover:scale-110 group-hover:-rotate-12 transition-all duration-500 shadow-xl hover:shadow-2xl">
                                <svg class="w-10 h-10 text-white transform group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-center">
                                <div class="text-5xl font-black mb-3 text-teal-700 animate-count-up group-hover:text-teal-800 transition-colors duration-300" data-target="25">0</div>
                                <div class="text-gray-800 font-bold text-xl mb-2 group-hover:text-teal-800 transition-colors duration-300">Kategori Budaya</div>
                                <div class="text-gray-600 text-sm font-medium">Seni, Arkeologi, Tekstil</div>

                                <!-- Animated Progress Indicator -->
                                <div class="mt-4 w-full bg-gray-200 rounded-full h-1 overflow-hidden">
                                    <div class="h-1 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 delay-300"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Kunjungan -->
                    <div class="group relative bg-gradient-to-br from-white via-cyan-50 to-blue-50 backdrop-blur-xl rounded-3xl p-8 border-2 border-cyan-200/50 hover:border-cyan-400 transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 hover:rotate-1 shadow-2xl hover:shadow-cyan-500/25 overflow-hidden">
                        <!-- Animated Background Elements -->
                        <div class="absolute inset-0 bg-gradient-to-br from-cyan-400/10 to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                        <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full opacity-20 group-hover:opacity-60 transition-all duration-700 transform group-hover:scale-150 group-hover:rotate-180"></div>
                        <div class="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full opacity-10 group-hover:opacity-30 transition-all duration-700 transform group-hover:scale-125"></div>

                        <div class="relative z-10">
                            <!-- Enhanced Icon Container -->
                            <div class="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-3xl mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-xl hover:shadow-2xl">
                                <svg class="w-10 h-10 text-white transform group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-center">
                                <div class="text-5xl font-black mb-3 text-cyan-700 animate-count-up group-hover:text-cyan-800 transition-colors duration-300" data-target="10">0</div>
                                <div class="text-gray-800 font-bold text-xl mb-2 group-hover:text-cyan-800 transition-colors duration-300">K Kunjungan</div>
                                <div class="text-gray-600 text-sm font-medium">Pengunjung Digital</div>

                                <!-- Animated Progress Indicator -->
                                <div class="mt-4 w-full bg-gray-200 rounded-full h-1 overflow-hidden">
                                    <div class="h-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-1000 delay-300"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group relative bg-gradient-to-br from-white via-emerald-50 to-teal-50 backdrop-blur-xl rounded-3xl p-8 border-2 border-emerald-200/50 hover:border-emerald-400 transition-all duration-700 transform hover:-translate-y-4 hover:scale-105 hover:-rotate-1 shadow-2xl hover:shadow-emerald-500/25 overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="text-center">
                                <div class="text-5xl font-black mb-3 text-emerald-700 animate-count-up group-hover:text-emerald-800 transition-colors duration-300" data-target="50">0</div>
                                <div class="text-gray-800 font-bold text-xl mb-2 group-hover:text-emerald-800 transition-colors duration-300">Koleksi Unggulan</div>
                                <div class="text-gray-600 text-sm font-medium">Masterpiece Digital</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Progress Bar -->
                    <div class="data-card stats-card bg-white/90 backdrop-blur-md rounded-2xl p-8 border-2 border-emerald-200/50 shadow-xl">
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="/register"
                            class="group relative px-10 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden animate-bounce-subtle"
                        >
                            <span class="relative z-10 flex items-center justify-center gap-4 text-xl">
                                <svg class="w-7 h-7 animate-wiggle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                                </svg>
                                Daftar Gratis
                            </span>
