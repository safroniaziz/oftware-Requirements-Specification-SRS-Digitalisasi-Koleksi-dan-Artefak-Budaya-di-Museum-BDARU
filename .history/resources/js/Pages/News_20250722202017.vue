                ...
                <div class="max-w-2xl mx-auto">
                    <div class="relative">
                        <input
                            ...
                            class="w-full px-6 py-4 pl-12 bg-white border-2 border-gray-200 rounded-2xl shadow-lg focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 transition-all duration-300 text-lg"
                        >
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-3">
                    <!-- Filters -->
                    <div class="flex flex-wrap items-center justify-between mb-8 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        <div class="flex flex-wrap items-center gap-4">
                            <!-- Category Filter -->
                            <div class="flex items-center space-x-2">
                                <label class="text-sm font-medium text-gray-700">Kategori:</label>
                                <select v-model="selectedCategory" @change="handleFilter" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <select v-model="sortBy" @change="handleFilter" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <!-- News Grid -->
                    <div v-if="news.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                        <article
                        ...
                        >
                            ...
                            <div class="relative h-48 overflow-hidden">
                                <img
                                    :src="article.image_path || 'https://via.placeholder.com/600/400/4F46E5/FFFFFF?text=BDARU+News'"
                                    :alt="article.title"
                                ...
                                <div v-if="article.is_featured" class="absolute top-4 right-4">
                                    <span class="inline-flex items-center px-3 py-1 bg-yellow-500 text-white text-xs font-semibold rounded-full">
                                        ⭐ Featured
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                <!-- Title -->
                                <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-emerald-600 transition-colors duration-200">
                                    {{ article.title }}
                                </h3>
                                ...
                                <Link
                                    ...
                                    class="inline-flex items-center text-emerald-600 font-semibold text-sm hover:text-emerald-700 transition-colors duration-200 group-hover:translate-x-1"
                                >
                                    Baca Selengkapnya
                    ...
                    <div v-else class="text-center py-16">
                        ...
                        <p class="text-gray-600 mb-6">Coba ubah filter pencarian Anda atau lihat berita lainnya.</p>
                    ...
                    <!-- Pagination -->
                    <div v-if="news.data.length > 0" class="mt-12">
...
function handleImageError(event) {
    event.target.src = 'https://via.placeholder.com/600/400/4F46E5/FFFFFF?text=BDARU+News';
}
