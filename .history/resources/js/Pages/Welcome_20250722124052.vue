...
<template>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <!-- News & Events Section -->
        <section class="py-24 bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden">
            <div class="absolute inset-0">
                <!-- Background Elements -->
                <div class="absolute top-0 left-0 w-80 h-80 bg-blue-200/20 rounded-full blur-3xl animate-float-slow"></div>
                <div class="absolute bottom-0 right-0 w-64 h-64 bg-indigo-200/20 rounded-full blur-3xl animate-float-medium"></div>
            </div>
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-20">
                    <div class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 rounded-full border-2 border-blue-200 mb-6 group hover:bg-gradient-to-r hover:from-blue-200 hover:to-indigo-200 transition-all duration-300 shadow-lg">
                        ...
                        <span class="text-sm font-bold">📰 Berita & Agenda</span>
                    </div>
                    ...
                    <h2 class="text-4xl md:text-6xl font-black mb-6 leading-tight">
                        <span class="bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 bg-clip-text text-transparent animate-gradient">
                            Berita Terbaru & Agenda Kegiatan
                        </span>
                    </h2>

                    <p class="text-xl md:text-2xl text-gray-700 font-medium max-w-4xl mx-auto leading-relaxed">
                        Dapatkan informasi terbaru tentang koleksi, pameran, dan agenda kegiatan menarik
                        <span class="font-bold text-blue-700">di Museum BDARU</span>
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div class="space-y-8">
                        <div class="text-center lg:text-left">
                            <h3 class="text-3xl font-black text-gray-900 mb-4">
                                📰 <span class="text-blue-600">Berita Terbaru</span>
                            </h3>
                            <p class="text-gray-600 mb-8">Informasi terkini seputar museum dan budaya Indonesia</p>
                        </div>

                        <!-- News Cards -->
                        <div class="space-y-6">
                            <!-- News Card 1 -->
                            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-right" data-aos-delay="100">
                                <div class="flex flex-col md:flex-row">
                                    ...
                                    <div class="md:w-2/3 p-6">
                                        ...
                                        <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                            Museum BDARU berhasil menambahkan 50 koleksi digital baru yang mencakup berbagai aspek budaya Indonesia...
                                        </p>
                                        <Link href="/news" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold text-sm group-hover:translate-x-1 transition-transform">
                                            Baca Selengkapnya
                            ...
                            <!-- News Card 2 -->
                            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-right" data-aos-delay="200">
                                <div class="flex flex-col md:flex-row">
                                    <div class="md:w-1/3 h-48 md:h-auto">
                                    ...
                                    <div class="md:w-2/3 p-6">
                                        ...
                                        <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                            Museum BDARU mengimplementasikan teknologi AI untuk meningkatkan kualitas digitalisasi koleksi...
                                        </p>
                                        <Link href="/news" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-semibold text-sm group-hover:translate-x-1 transition-transform">
                                            Baca Selengkapnya
                                            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-center lg:text-left">
                            <Link href="/news" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors duration-200 group">
                                Lihat Semua Berita
                    ...
                    <div class="space-y-8">
                        <div class="text-center lg:text-left">
                            <h3 class="text-3xl font-black text-gray-900 mb-4">
                                📅 <span class="text-indigo-600">Agenda Kegiatan</span>
                            </h3>
                            <p class="text-gray-600 mb-8">Jadwal kegiatan dan acara menarik di museum</p>
                        </div>

                        <!-- Events Cards -->
                        <div class="space-y-6">
                            <!-- Event Card 1 -->
                            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-left" data-aos-delay="100">
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Exhibition</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <Link href="/events" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white text-sm font-semibold rounded-lg hover:bg-emerald-700 transition-colors duration-200">
                                            Detail
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <!-- Event Card 2 -->
                            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-left" data-aos-delay="200">
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 class="text-lg font-bold text-gray-900 group-hover:text-amber-600 transition-colors">
                                                    Workshop Membuat Batik Tulis
                                                </h4>
                                                <p class="text-sm text-gray-600">Workshop</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4 text-sm text-gray-500">
                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                <span>Ruang Workshop</span>
                                            </div>
                                        </div>
                                        <Link href="/events" class="inline-flex items-center px-4 py-2 bg-amber-600 text-white text-sm font-semibold rounded-lg hover:bg-amber-700 transition-colors duration-200">
                                            Detail
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <!-- Event Card 3 -->
                            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100" data-aos="fade-left" data-aos-delay="300">
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4 text-sm text-gray-500">
                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                <span>Panggung Terbuka</span>
                                            </div>
                                        </div>
                                        <Link href="/events" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white text-sm font-semibold rounded-lg hover:bg-purple-700 transition-colors duration-200">
                                            Detail
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div class="text-center lg:text-left">
                            <Link href="/events" class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors duration-200 group">
                                Lihat Semua Agenda
                                <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
