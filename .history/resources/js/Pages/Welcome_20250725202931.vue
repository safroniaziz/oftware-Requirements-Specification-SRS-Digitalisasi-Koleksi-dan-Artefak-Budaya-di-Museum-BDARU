    ...
    <div class="min-h-screen bg-gray-50">
        ...
        >
            ...
            <div class="absolute top-0 right-0 w-80 h-full bg-white shadow-2xl transform transition-transform duration-300">
                ...
                <!-- Hero Section -->
        <section class="relative py-16 lg:py-24 bg-gradient-to-br from-white via-emerald-50 to-teal-100 overflow-hidden min-h-[80vh]" :class="{ 'mt-20': !mobileMenuOpen, 'mt-0': mobileMenuOpen }">
