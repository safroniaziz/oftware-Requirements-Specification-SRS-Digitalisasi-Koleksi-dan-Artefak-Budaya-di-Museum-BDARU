                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <h1 class="text-2xl font-bold text-indigo-600">BDARU</h1>
                        </div>
                        <div class="hidden md:block ml-10">
                            <div class="flex items-baseline space-x-4">
                                ...
                                <Link
                                    href="/collections"
                                    class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium"
                                    :class="{ 'text-indigo-600': $page.url.startsWith('/collections') }"
                                >
                                    Koleksi Budaya
                                </Link>
                                <Link
                                    href="/news"
                                    class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium"
                                    :class="{ 'text-indigo-600': $page.url.startsWith('/news') }"
                                >
                                    Berita & Kegiatan
                                </Link>
                                <Link
                                    href="/about"
                                    class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium"
                                    :class="{ 'text-indigo-600': $page.url === '/about' }"
                                >
                                    Profil Komunitas
                                </Link>
                                <Link
                                    href="/contact"
                                    class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium"
                                    :class="{ 'text-indigo-600': $page.url === '/contact' }"
                                >
                                    Kontak
                                </Link>
                            </div>
