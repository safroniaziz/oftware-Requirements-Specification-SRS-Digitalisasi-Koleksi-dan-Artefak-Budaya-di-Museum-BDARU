    ...
    public function run(): void
    {
        $collections = [
            [
                ...
                'rating' => 4.8,
                'cultural_significance' => 'Keris ini merupakan simbol kekuatan dan kearifan budaya Jawa, menggambarkan keahlian pandai besi tradisional yang telah diwariskan turun-temurun.',
                ...
                'conservation_overview' => 'Koleksi ini telah melalui proses konservasi yang ketat untuk mempertahankan keaslian dan kualitasnya.'
            ],
            [
                ...
                'rating' => 4.9,
                'cultural_significance' => 'Batik ini merepresentasikan keagungan budaya Jawa dan keahlian seni batik yang telah diakui UNESCO sebagai warisan budaya dunia.',
                ...
                'conservation_overview' => 'Disimpan dalam kondisi khusus dengan pengaturan suhu dan kelembaban yang optimal untuk menjaga kualitas kain dan warna.'
            ],
            [
                ...
                'conservation_status' => 'Baik',
                'rating' => 4.7,
                'cultural_significance' => 'Gamelan Sekaten merupakan instrumen sakral yang hanya dimainkan dalam upacara-upacara penting keraton, melambangkan harmoni dan keseimbangan alam.',
                ...
                'conservation_overview' => 'Dilakukan pemeliharaan rutin untuk menjaga kualitas suara dan kondisi fisik instrumen.'
            ],
            [
                ...
                'conservation_status' => 'Sangat Baik',
                'rating' => 4.9,
                'cultural_significance' => 'Mahkota ini melambangkan kekuasaan dan kewibawaan raja, serta keahlian pandai emas tradisional Bali yang luar biasa.',
                ...
                'conservation_overview' => 'Disimpan dalam kotak khusus dengan pengaturan kelembaban yang tepat untuk menjaga kilau emas dan kondisi permata.'
            ],
            [
                ...
                'conservation_status' => 'Baik',
                'rating' => 4.6,
                'cultural_significance' => 'Wayang kulit merupakan media dakwah dan pendidikan moral yang efektif, menggabungkan seni pertunjukan dengan nilai-nilai spiritual.',
                ...
                'conservation_overview' => 'Dilakukan perawatan khusus untuk mencegah kerusakan akibat kelembaban dan serangga.'
            ],
            [
                'name' => 'Tombak Trisula',
                'category_id' => 1,
                ...
                'conservation_status' => 'Baik',
                'rating' => 4.5,
                'cultural_significance' => 'Trisula melambangkan tiga kekuatan utama dalam kosmologi Hindu: Brahma, Wisnu, dan Siwa, serta digunakan dalam ritual keagamaan.',
                ...
                'conservation_overview' => 'Dilakukan pembersihan dan pelumasan rutin untuk mencegah karat dan menjaga keindahan logam.'
            ],
            [
                ...
                'conservation_status' => 'Sangat Baik',
                'rating' => 4.8,
                'cultural_significance' => 'Songket Minangkabau melambangkan kekayaan budaya dan keahlian tenun tradisional yang telah diwariskan turun-temurun.',
                ...
                'conservation_overview' => 'Disimpan dalam kondisi khusus dengan pengaturan suhu dan kelembaban yang optimal.'
            ],
            [
                'name' => 'Angklung Bambu',
                'category_id' => 4,
                ...
                'conservation_status' => 'Baik',
                'rating' => 4.4,
                'cultural_significance' => 'Angklung merupakan alat musik tradisional yang melambangkan kerjasama dan harmoni, karena memerlukan koordinasi yang baik untuk memainkannya.',
                ...
                'conservation_overview' => 'Dilakukan perawatan rutin untuk menjaga kualitas suara dan mencegah kerusakan akibat kelembaban.'
            ],
            [
                ...
                'conservation_status' => 'Sangat Baik',
                'rating' => 4.9,
                'cultural_significance' => 'Kalung mutiara melambangkan kemewahan dan kekuasaan raja, serta keahlian pembuatan perhiasan tradisional yang luar biasa.',
                'technical_overview' => 'Kalung dengan mutiara asli berkualitas tinggi, menggunakan teknik rangkaian tradisional yang halus.',
                'conservation_overview' => 'Disimpan dalam kotak khusus dengan pengaturan kelembaban yang tepat untuk menjaga kilau mutiara.'
            ],
            [
                ...
                'conservation_status' => 'Baik',
                'rating' => 4.3,
                'cultural_significance' => 'Tepak sirih melambangkan keramahan dan penghormatan dalam budaya Melayu, digunakan dalam berbagai upacara adat.',
                ...
                'conservation_overview' => 'Dilakukan pembersihan dan pemolesan rutin untuk menjaga kilau perak dan keindahan ukiran.'
            ],
            [
                ...
                'conservation_status' => 'Baik',
                'rating' => 4.7,
                'cultural_significance' => 'Pedang ini menggambarkan pengaruh budaya asing yang diadaptasi dengan teknik lokal, menciptakan karya seni yang unik.',
                ...
                'conservation_overview' => 'Dilakukan perawatan khusus untuk mencegah karat dan menjaga keindahan bilah dan gagang.'
            ],
            [
                ...
                'conservation_status' => 'Sangat Baik',
                'rating' => 4.6,
                'cultural_significance' => 'Ulos melambangkan ikatan keluarga dan persaudaraan dalam budaya Batak, digunakan dalam berbagai upacara penting.',
                'technical_overview' => 'Ulos dengan teknik tenun tradisional, menggunakan pewarna alam yang menghasilkan warna yang tahan lama.',
                'conservation_overview' => 'Disimpan dalam kondisi khusus untuk menjaga kualitas kain dan warna yang tetap cerah.'
            ]
        ];
        ...
        foreach ($collections as $collection) {
            ...
            if ($category) {
                Collection::create([
                    ...
                    'cultural_significance' => $collection['cultural_significance'] ?? null,
                    'technical_overview' => $collection['technical_overview'] ?? null,
                    'conservation_overview' => $collection['conservation_overview'] ?? null,
