    ...
    public function run(): void
    {
        $news = [
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/10b981/ffffff?text=Pembukaan+Museum',
                'type' => 'news',
            ...
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=600&fit=crop&auto=format',
                'type' => 'event',
            ...
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&h=600&fit=crop&auto=format',
                'type' => 'activity',
                'category_id' => 2, // Kegiatan
            ...
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1523240794102-9eb5ccb88336?w=800&h=600&fit=crop&auto=format',
                'type' => 'news',
                'category_id' => 1, // Berita
                'is_published' => true,
                'is_featured' => false,
            ...
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&h=600&fit=crop&auto=format',
                'type' => 'activity',
                'category_id' => 2, // Kegiatan
            ...
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800&h=600&fit=crop&auto=format',
                'type' => 'news',
                'category_id' => 1, // Berita
                'is_published' => true,
                'is_featured' => true,
            ...
            [
                ...
                'image_path' => 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800&h=600&fit=crop&auto=format',
                'type' => 'event',
                'category_id' => 3, // Pameran
