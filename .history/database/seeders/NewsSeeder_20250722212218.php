...
{
    /**
     * Generate SVG data URI for placeholder images
     */
    private function generatePlaceholderImage($text, $color = '10b981')
    {
        $svg = '<svg width="800" height="600" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#' . $color . '"/><text x="50%" y="50%" font-family="Arial, sans-serif" font-size="48" fill="white" text-anchor="middle" dy=".3em">' . $text . '</text></svg>';
    ...
    public function run(): void
    {
        $news = [
            [
                ...
                'image_path' => 'data:image/svg+xml;base64,',
                'type' => 'news',
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/0d9488/ffffff?text=Workshop+Batik',
                'type' => 'activity',
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/14b8a6/ffffff?text=Pameran+Senjata',
                'type' => 'event',
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/06b6d4/ffffff?text=Diskusi+Budaya',
                'type' => 'activity',
                'category_id' => 2, // Kegiatan
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/0891b2/ffffff?text=Kunjungan+Siswa',
                'type' => 'news',
                'category_id' => 1, // Berita
                'is_published' => true,
                'is_featured' => false,
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/0e7490/ffffff?text=Pelatihan+Kurator',
                'type' => 'activity',
                'category_id' => 2, // Kegiatan
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/155e75/ffffff?text=Digitalisasi+Koleksi',
                'type' => 'news',
                'category_id' => 1, // Berita
                'is_published' => true,
                'is_featured' => true,
            ...
            [
                ...
                'image_path' => 'https://via.placeholder.com/800x600/164e63/ffffff?text=Festival+Budaya',
                'type' => 'event',
                'category_id' => 3, // Pameran
