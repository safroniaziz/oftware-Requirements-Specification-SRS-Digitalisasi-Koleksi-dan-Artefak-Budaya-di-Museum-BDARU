...
class Collection extends Model
{
    ...
    // Relationship with QR Codes
    public function qrCodes()
    {
        return $this->hasMany(CollectionQrCode::class);
    }

    // Get active QR codes
    public function activeQrCodes()
    {
        return $this->hasMany(CollectionQrCode::class)->where('is_active', true);
    }

    // Get latest QR code
    public function latestQrCode()
    {
        return $this->hasOne(CollectionQrCode::class)->where('is_active', true)->latest();
    }
}
