...
class AdminPengelolaKoleksiController extends Controller
{
    ...
    {
        $collections = Collection::with(['category', 'ratings'])
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('collections-management.index')->with('success', 'Koleksi berhasil dihapus (soft delete)');
    }
    ...
    public function trash()
    {
        ...
        return view('management.collections.trash', compact('collections'));
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('collections-management.trash')->with('success', 'Koleksi berhasil dipulihkan');
    }
    ...
    public function forceDelete($id)
    {
        ...
        foreach ($collection->galleryImages as $galleryImage) {
            Storage::disk('public')->delete($galleryImage->image_path);
        }

        // Force delete related data
        $collection->galleryImages()->forceDelete();
        $collection->histories()->forceDelete();
        $collection->ratings()->forceDelete();
        $collection->technicalSpecs()->forceDelete();
        $collection->conservationRecords()->forceDelete();

        // Force delete the collection
        $collection->forceDelete();

        return redirect()->route('collections-management.trash')->with('success', 'Koleksi berhasil dihapus permanen');
    }
}
