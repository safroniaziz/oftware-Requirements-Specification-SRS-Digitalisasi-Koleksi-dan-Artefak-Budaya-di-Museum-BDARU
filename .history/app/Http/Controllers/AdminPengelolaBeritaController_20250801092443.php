...
class AdminPengelolaBeritaController extends Controller
{
    ...
    {
        $newsCategories = NewsCategory::where('is_active', true)->orderBy('sort_order', 'asc')->get();
        return view('management.news.create', compact('newsCategories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('management.news.edit', compact('news', 'newsCategories'));
    }
