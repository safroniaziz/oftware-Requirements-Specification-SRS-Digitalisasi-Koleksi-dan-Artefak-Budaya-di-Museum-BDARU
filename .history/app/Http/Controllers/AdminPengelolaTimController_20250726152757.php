...
class AdminPengelolaTimController extends Controller
{
    public function index()
    {
        ...
        return view('management.team-members.index', compact('teamMembers'));
    }

    public function create()
    {
        return view('management.team-members.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('management.team-members.edit', compact('teamMember'));
    }
