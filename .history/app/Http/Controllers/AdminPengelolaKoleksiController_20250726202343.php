...
class AdminPengelolaKoleksiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('gallery_images')) {
            foreach ($request->file('gallery_images') as $index => $image) {
                $imagePath = $this->processImage($image, 'collections/gallery');
        ...
        // Create default cultural points
        $this->createDefaultCulturalPoints($collection->id);
    ...
    private function createDefaultCulturalPoints($collectionId)
    {
        $culturalPoints = [
            [
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('gallery_images')) {
            ...
            foreach ($request->file('gallery_images') as $image) {
                $galleryPaths[] = $this->processImage($image, 'collections/gallery');
            }
