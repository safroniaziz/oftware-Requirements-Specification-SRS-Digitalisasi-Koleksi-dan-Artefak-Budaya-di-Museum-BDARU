...
class EventController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Transform events to include image_url
        ...
        // Transform featured events to include image_url
        ...
        // Transform upcoming events to include image_url
    ...
    public function show(Event $event)
    {
        ...
        // Transform related events to include image_url
        $relatedEvents->transform(function ($event) {
            $event->image_url = $event->image ? asset('storage/' . $event->image) : null;
            return $event;
        });
        ...
        // Transform event to include image_url
        $event->image_url = $event->image ? asset('storage/' . $event->image) : null;
