...
class CollectionRatingController extends Controller
{
    ...
    public function update(Request $request, Collection $collection, CollectionRating $rating)
    {
    ...
    public function destroy(Collection $collection, CollectionRating $rating)
    {
        // Check if user owns this rating
        if (Auth::check() && $rating->user_id !== Auth::id()) {
            abort(403, 'Unauthorized');
