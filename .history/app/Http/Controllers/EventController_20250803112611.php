...
class EventController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Debug: Log first event data
        if ($events->count() > 0) {
            $firstEvent = $events->first();
            Log::info('First event data being sent to Events Vue:', [
                'event_id' => $firstEvent->id,
                'event_image' => $firstEvent->image,
                'event_image_url' => $firstEvent->image_url,
            ]);
        }
    ...
    public function show(Event $event)
    {
        ...
        // Debug: Log event data being sent to EventDetail
