...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Backup Management
    Route::get('/backup-management', [App\Http\Controllers\AdminBackupController::class, 'index'])->name('backup-management.index');

    // Logs Management
    Route::get('/logs-management', [App\Http\Controllers\AdminLogController::class, 'index'])->name('logs-management.index');

    // Reports Management
    Route::get('/reports-management', [App\Http\Controllers\AdminReportController::class, 'index'])->name('reports-management.index');

    // QR Code Management
    Route::post('/collections/{id}/generate-qr', [AdminPengelolaKoleksiController::class, 'generateQrCode'])->name('collections-management.generate-qr');
    Route::post('/collections/{id}/reset-qr', [AdminPengelolaKoleksiController::class, 'resetQrCode'])->name('collections-management.reset-qr');
    Route::get('/collections/{id}/qr-codes', [AdminPengelolaKoleksiController::class, 'getQrCodes'])->name('collections-management.qr-codes');
    Route::get('/collections/{id}/qr-code-preview', [AdminPengelolaKoleksiController::class, 'getQrCodePreview'])->name('collections-management.qr-code-preview');
});
