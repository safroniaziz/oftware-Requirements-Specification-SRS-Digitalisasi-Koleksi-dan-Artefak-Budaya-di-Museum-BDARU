...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/testimonials-management/{id}/approve', [AdminPengelolaTestimoniController::class, 'approve'])->name('testimonials-management.approve');
    Route::post('/testimonials-management/{id}/unapprove', [AdminPengelolaTestimoniController::class, 'unapprove'])->name('testimonials-management.unapprove');
