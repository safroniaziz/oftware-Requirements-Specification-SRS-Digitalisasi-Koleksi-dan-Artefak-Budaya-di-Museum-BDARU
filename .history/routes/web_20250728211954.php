...
// Remove Inertia import for dashboard routes
// use Inertia\Inertia;
...
// Frontend routes with Inertia middleware
...
// Collection Rating routes (API-like, no Inertia needed)
...
// Testimonials POST route (no Inertia needed)
Route::post('/testimonials', [App\Http\Controllers\TestimonialController::class, 'store'])->name('testimonials.store');

// Team Members routes (no Inertia needed)
Route::resource('team-members', App\Http\Controllers\TeamMemberController::class)->except(['index']);
