...
use App\Http\Controllers\AdminPengelolaTeamMemberController;
use App\Http\Controllers\AdminPengelolaTestimonialController;
use App\Http\Controllers\AdminPengelolaPengaturanController;
use App\Http\Controllers\AdminPengelolaUserController;
use App\Http\Controllers\AdminPengelolaRoleController;
use App\Http\Controllers\AdminPengelolaPermissionController;
use App\Http\Controllers\AdminAnalitikController;
...
use Inertia\Inertia;
use App\Http\Controllers\AdminPengelolaHeroImageController;

Route::get('/', [App\Http\Controllers\HomeController::class, 'index'])->name('home');

// QR Code route for serving SVG files
Route::get('/qr-code/{filename}', [App\Http\Controllers\QrCodeController::class, 'show'])->name('qr-code.show');
...
Route::get('/dashboard', [DashboardController::class, 'index'])->middleware(['auth', 'verified', 'admin.access'])->name('dashboard');

// Pengelola dashboard route (same as admin for now, using same controller)
Route::get('/pengelola/dashboard', [DashboardController::class, 'index'])->middleware(['auth', 'verified', 'admin.access'])->name('pengelola.dashboard');

// Admin & Pengelola dashboard routes using blade templates
Route::middleware(['auth', 'verified', 'admin.access'])->group(function () {
    // Collections Management (Admin & Pengelola)
    Route::middleware('permission:manage collections')->group(function () {
        ...
        // News Management (Admin & Pengelola)
    ...
    // Events Management (Admin & Pengelola)
    ...
    // Testimonials Management (View Only) (Admin & Pengelola)
    Route::middleware('permission:manage content')->group(function () {
        Route::get('/testimonials-management', [AdminPengelolaTestimonialController::class, 'index'])->name('testimonials-management.index');
    });

    // Team Members Management (Admin & Pengelola)
    Route::middleware('permission:manage content')->group(function () {
        Route::get('/team-members-management', [AdminPengelolaTeamMemberController::class, 'index'])->name('team-members-management.index');
        Route::get('/team-members-management/create', [AdminPengelolaTeamMemberController::class, 'create'])->name('team-members-management.create');
        Route::post('/team-members-management', [AdminPengelolaTeamMemberController::class, 'store'])->name('team-members-management.store');
        Route::get('/team-members-management/{teamMember}/edit', [AdminPengelolaTeamMemberController::class, 'edit'])->name('team-members-management.edit');
        Route::put('/team-members-management/{teamMember}', [AdminPengelolaTeamMemberController::class, 'update'])->name('team-members-management.update');
        Route::delete('/team-members-management/{teamMember}', [AdminPengelolaTeamMemberController::class, 'destroy'])->name('team-members-management.destroy');
    });

    // Categories Management (Admin & Pengelola)
    ...
    // News Categories Management (Admin & Pengelola)
    Route::middleware('permission:manage news')->group(function () {
    ...
    Route::middleware('permission:edit pages')->group(function () {
        ...
        Route::put('/settings-management/update-logo', [AdminPengelolaPengaturanController::class, 'updateLogo'])->name('settings-management.update-logo');
        Route::put('/settings-management/update-email', [AdminPengelolaPengaturanController::class, 'updateEmail'])->name('settings-management.update-email');
        Route::put('/settings-management/update-social', [AdminPengelolaPengaturanController::class, 'updateSocial'])->name('settings-management.update-social');
        Route::post('/settings-management/clear-cache', [AdminPengelolaPengaturanController::class, 'clearCache'])->name('settings-management.clear-cache');
        Route::post('/settings-management/clear-logs', [AdminPengelolaPengaturanController::class, 'clearLogs'])->name('settings-management.clear-logs');
        Route::post('/settings-management/update-system', [AdminPengelolaPengaturanController::class, 'updateSystem'])->name('settings-management.update-system');
    });
    ...
    Route::middleware('permission:manage users')->group(function () {
        ...
        Route::get('/roles-management/{role}/permissions', [AdminPengelolaRoleController::class, 'permissions'])->name('roles-management.permissions');
    ...
    // Hero Images Management (Admin & Pengelola)
    Route::middleware('permission:manage content')->group(function () {
        Route::resource('hero-images', AdminPengelolaHeroImageController::class)->names([
            'index' => 'hero-images-management.index',
            'create' => 'hero-images-management.create',
            'store' => 'hero-images-management.store',
            'edit' => 'hero-images-management.edit',
            'update' => 'hero-images-management.update',
            'destroy' => 'hero-images-management.destroy',
        ]);
    });
});
