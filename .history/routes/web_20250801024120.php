...
Route::post('/collections/{collection}/ratings', [App\Http\Controllers\CollectionRatingController::class, 'store'])->name('collections.ratings.store');
Route::put('/collections/{collection}/ratings/{rating}', [App\Http\Controllers\CollectionRatingController::class, 'update'])->name('collections.ratings.update');
Route::delete('/collections/{collection}/ratings/{rating}', [App\Http\Controllers\CollectionRatingController::class, 'destroy'])->name('collections.ratings.destroy');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Trash routes
    Route::get('/collections-management/trash', [AdminPengelolaKoleksiController::class, 'trash'])->name('collections-management.trash');
    Route::post('/collections-management/{id}/restore', [AdminPengelolaKoleksiController::class, 'restore'])->name('collections-management.restore');
    Route::delete('/collections-management/{id}/force-delete', [AdminPengelolaKoleksiController::class, 'forceDelete'])->name('collections-management.force-delete');
    ...
    Route::get('/testimonials-management/create', [AdminPengelolaTestimoniController::class, 'create'])->name('testimonials-management.create');
    Route::post('/testimonials-management', [AdminPengelolaTestimoniController::class, 'store'])->name('testimonials-management.store');
    Route::get('/testimonials-management/{id}/edit', [AdminPengelolaTestimoniController::class, 'edit'])->name('testimonials-management.edit');
    Route::put('/testimonials-management/{id}', [AdminPengelolaTestimoniController::class, 'update'])->name('testimonials-management.update');
    Route::delete('/testimonials-management/{id}', [AdminPengelolaTestimoniController::class, 'destroy'])->name('testimonials-management.destroy');
