    ...
    qrCodes.forEach((qr, index) => {
        ...
        qrCodesHTML += `
            <div class="text-center mb-4">
                ...
                <div class="mt-3">
                    <a href="/admin/collections/${qr.collection_id}/qr-code-download/${qr.qr_code}"
        ...
        .then(data => {
            if (data.success) {
                Swal.fire({
                    ...
                    html: `
                        <div class="text-center">
                            <img src="${data.qr_image_url}" alt="QR Code" class="img-fluid border rounded mb-3" style="max-width: 300px;">
                            <div class="mb-3">
                                <strong>Kode QR:</strong> <code>${data.qr_code}</code>
                            </div>
                            <div class="mt-3">
                                <a href="/admin/collections/${collectionId}/qr-code-download/${data.qr_code}"
