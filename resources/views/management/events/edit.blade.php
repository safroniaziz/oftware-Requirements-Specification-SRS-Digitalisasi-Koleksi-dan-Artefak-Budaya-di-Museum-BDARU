                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <input type="date" class="form-control @error('event_date') is-invalid @enderror"
                                                       id="event_date" name="event_date" value="{{ old('event_date', $event->event_date ? $event->event_date->format('Y-m-d') : '') }}" required>
                                                @error('event_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if($event->image)
                                            <div class="mt-3" id="currentImageContainer">
                                                ...
                                                <div class="relative overflow-hidden rounded-lg border border-gray-200" style="height: 200px; background-color: #f8f9fa;">
                                        ...
                                        <div id="imagePreview" class="mt-3" style="display: none;">
                                            ...
                                            <div class="mt-2 text-center">
                                                <small class="text-muted">Preview gambar baru dengan ukuran yang dibatasi untuk kemudahan melihat</small>
                                            </div>
                                        </div>
                                    </div>
...
function previewImage(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        // Show current image when no new file is selected
        if (currentImageContainer) {
