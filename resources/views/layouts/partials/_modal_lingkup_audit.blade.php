    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header px-10">
                <h2 class="fw-bold">Tambah Lingkup Audit</h2>
            </div>
            <div class="modal-body d-flex flex-column scroll-y px-10" style="flex-grow: 1;">
                <form id="kt_modal_form" class="form d-flex flex-column" style="flex-grow: 1;">
                    ...
                    <div class="fv-row mb-5">
                        <label class="fs-5 fw-semibold form-label mb-2">Lingkup Audit:</label>
                        <input type="text" name="lingkup_audit" class="form-control" />
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#kt_modal_form').on('submit', function (e) {
                e.preventDefault();
                let form = $(this);
                let url = form.attr('action') || "{{ route('lingkupAudit.store') }}";
