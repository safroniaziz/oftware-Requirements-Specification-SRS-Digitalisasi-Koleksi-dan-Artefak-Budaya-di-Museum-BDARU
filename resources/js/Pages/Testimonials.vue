...
const hasSubmittedTestimonial = computed(() => {
    return props.auth && props.auth.hasSubmittedTestimonial;
});

// Check if user can submit testimonial (authenticated and hasn't submitted yet)
const canSubmitTestimonial = computed(() => {
    return isAuthenticated.value && !hasSubmittedTestimonial.value;
});
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="#testimonials" class="group relative px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-emerald-500/25 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 overflow-hidden">
                                ...
                                <div class="absolute inset-4 bg-white rounded-2xl shadow-lg">
                                    ...
                                    <div class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white p-4 rounded-t-2xl">
                                        <div class="text-center">
                                            <h3 class="text-xl font-bold">Testimoni BDARU</h3>
                                            <p class="text-sm opacity-90">Pengalaman Pengunjung</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-4 space-y-3">
                                        <div class="flex items-center space-x-3 p-2 bg-emerald-50 rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600">"Pengalaman luar biasa!"</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3 p-2 bg-teal-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">⭐⭐⭐⭐⭐</p>
                                                <p class="text-xs text-gray-600">"Teknologi yang mengagumkan"</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3 p-2 bg-cyan-50 rounded-lg">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-800">⭐⭐⭐⭐⭐</p>
                                                <p class="text-xs text-gray-600">"Sangat informatif"</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section ref="testimonialFormRef" class="py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
            ...
            <div class="relative z-10 w-full lg:w-4/5 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div v-if="canSubmitTestimonial" class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100">
                    ...
                    <!-- Already Submitted Card - Show for authenticated users who already submitted -->
                    <div v-else-if="isAuthenticated && hasSubmittedTestimonial" class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100 text-center">
                        <div class="max-w-md mx-auto">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 mb-4">Testimoni Sudah Dikirim</h3>
                            <p class="text-gray-600">
                                Terima kasih! Anda sudah pernah memberikan testimoni untuk platform kami. Testimoni Anda sudah ditampilkan di halaman ini.
                            </p>
                        </div>
                    </div>
