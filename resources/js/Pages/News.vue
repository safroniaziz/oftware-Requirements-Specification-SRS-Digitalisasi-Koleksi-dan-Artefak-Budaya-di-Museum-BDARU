<template>
    <Head :title="`Berita - ${props.museumSettings?.museum_name || 'BDARU Museum Digital Indonesia'}`" />
                ...
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <p class="text-lg md:text-xl mb-8 leading-relaxed text-gray-700 font-medium max-w-2xl mx-auto lg:mx-0">
                            Dapatkan informasi terbaru seputar Museum Digital Indonesia BDARU. Dari pameran, koleksi baru, hingga kegiatan menarik yang memperkaya pengetahuan budaya Anda.
                        </p>
